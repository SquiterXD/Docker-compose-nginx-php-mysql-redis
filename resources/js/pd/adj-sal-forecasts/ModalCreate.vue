            ...
            <div class="modal-dialog modal-lg" style=" padding-top: 1%;">
                <div class="modal-content" v-loading="loading">
                    ...
                    <div class="modal-body text-left">
                        ...
                        <div class="row col-12" v-if="false">
                            ...
                            <!-- <div class="form-group pl-2 pr-2 mb-0 col-lg-3 col-md-2 col-sm-6 col-xs-6 mt-2" v-loading="loadingVerNo">
                                ...
                                <div class="">
                                    <el-input  :value="adjVersionNo" size="large" :readonly="true"> </el-input>
                                </div>
                            </div> -->
                        </div>
                        ...
                        <div class="row col-12">
                            ...
                            <div class="form-group pl-2 pr-2 mb-0 col-lg-4 col-md-2 col-sm-6 col-xs-6 mt-2">
                                ...
                                <div class="input-group ">
                                    <el-select :popper-append-to-body="false" size="large" v-model="budgetYeaVersion" placeholder=""  clearable filterable>
                            ...
                            <div class="form-group pl-2 pr-2 mb-0 col-lg-4 col-md-2 col-sm-6 col-xs-6 mt-2">
                                ...
                                <div class="input-group ">
                                    ...
                                    <el-select v-model="budgetYear" :popper-append-to-body="false" size="large" placeholder=""  clearable filterable>
                                        <el-option
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" :disabled="!budgetYeaVersion"  @click.prevent="submit()" :class="btnTrans.create.class + ' btn-lg tw-w-25'" >
                            <i :class="btnTrans.create.icon"></i>
                            {{ btnTrans.create.text }}
                        </button>
                    </div>
            ...
            submit() {
                ...
                .then(res => {
                    ...
                    if (data.status == 'S') {
                        ...
                        this.$emit("selectRow", data.header);
