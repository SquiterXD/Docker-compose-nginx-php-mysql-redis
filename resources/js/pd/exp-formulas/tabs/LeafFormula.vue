            ...
            <table  class="table" style="margin-bottom: 0px;">
                        ...
                        <td>
                            <template v-if="line.leaf_formula">
                                <a data-toggle="collapse" @click="line.is_collapse = !line.is_collapse"
                                    ...
                                    <i class="fa fa-caret-down" v-if="line.is_collapse"></i>
                ...
                <tfoot v-if="lines.length">
                    <tr style="">
                        ...
                        <th class="text-right">
                            <h4>{{ totalProportion  | number2Digit }}</h4>
                        </th>
                        <th></th>
                    </tr>
                </tfoot>
    ...
    computed: {
        totalProportion: function () {
            let total =  _.sumBy(this.lines, function(o) {
                if (!o.is_deleted) {
                    return parseInt(o.leaf_proportion);
                }
            });
