    ...
    <div class="row">
        ...
        <div class="offset-md-2 col-md-8">
            ...
            <div class="row form-group">
                ...
                <label class="col-md-4 required"> แผนการผลิตที่กระดาษทำการ </label>
                <div class="col-md-8">
                    <qm-el-select name="plan_version_no" id="input_plan_version_no" placeholder="แผนการผลิตที่กระดาษทำการ "
        ...
        <div class="offset-md-2 col-md-8 text-right tw-mt-2 tw-mb-4">
            ...
            <input type="hidden" name="export_type" v-model="exportType">

                <button type="submit" class="btn btn-sm btn-info tw-pr-4"
                    @click="handleExport($event, 'pdf')"
                    :disabled="!periodYear || !versionNo || !planVersionNo || !costCodeFrom"
                >
                    <i class="fa fa fa-file-pdf-o tw-mr-1"></i> พิมพ์รายงาน PDF
                </button>

                <button type="submit" class="btn btn-sm btn-primary"
                    @click="handleExport($event, 'excel')"
                    :disabled="!periodYear || !versionNo || !planVersionNo || !costCodeFrom"
                >
                    <i class="fa fa fa-file-excel-o tw-mr-1"></i> พิมพ์รายงาน Excel
                </button>
