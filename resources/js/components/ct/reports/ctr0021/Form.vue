    ...
    <div class="row">
        ...
        <div class="offset-md-2 col-md-8">
            ...
            <div class="row form-group">
                ...
                <label class="col-md-4 required"> หน่วยงาน </label>
                <div class="col-md-8">
                    <qm-el-select name="allocate_group_code" id="input_allocate_group_code" placeholder="หน่วยงาน "
                        option-key="allocate_group_code_value" option-value="allocate_group_code_value" option-label="allocate_group_code_label"
                        @onSelected="onAllocateGroupCodeChanged($event)"
                        :select-options="allocateGroupCodeOptions" 
                        :clearable="false" 
                        :filterable="true"
                        :value="allocateGroupCode"  />
                </div>
...
export default {
    ...
    mounted() {
        ...
        if(this.periodYearValue) {
            ...
            this.filterAllocateGroupCodeOptions(this.periodYearValue);
    ...
    methods: {
        ...
        onAllocateGroupCodeChanged(allocateGroupCode) {
        ...
        filterAllocateGroupCodeOptions(periodYear) {
            if(periodYear){
                this.allocateGroupCodeOptions = this.allocateGroupCodes.filter(item => item.period_year == periodYear);
            } else {
