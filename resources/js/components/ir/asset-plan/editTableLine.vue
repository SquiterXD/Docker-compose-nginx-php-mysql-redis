    ...
    <div class="margin_top_20" v-loading="dataLoading" >
        <el-form :model="form"
            ...
            <div class="table-responsive margin_top_20 ">
                <div style="font-size: 18px;"> &nbsp; กรมธรรม์ชุดที่ {{poli}} : {{polides}} &nbsp; ปี :
                    {{yearr}} &nbsp; ณ วันที่ : {{startt}}
                </div>
                <br>
                <table class="table table-bordered"
                    ...
                    <tr>
                        ...
                        <th style="min-width: 200px;" class="text-center">Total Asset Cost <br>ราคาทุนทั้งหมด</th>
                        <th style="min-width: 200px;" class="text-center">Total Coverage Amount <br>มูลค่าทุนประกันทั้งหมด
                        </th>
                        <!--                        <th style="min-width: 110px;" class="text-center">Policy No.<br>กรมธรรม์ชุดที่</th>-->
                        <!--                        <th style="min-width: 200px;" class="text-center">Policy Description.<br>รายละเอียดชุดกรมธรรม์-->
                        <!--                        </th>-->
                    ...
                    <tr>
                        ...
                        <td class="text-right">{{formatCurrency(cost2)}}</td>
                    ...
                    <tr>
                        ...
                        <td class="text-right">{{formatCurrency(cost3)}}</td>
                    ...
                    <tr>
                        ...
                        <td class="text-right">{{formatCurrency(cost4)}}</td>
                    ...
                    <tr>
                        <td>Total</td>
                        <td class="text-center">{{test + test2 + test3 + test4}}</td>
                        <td class="text-right">{{formatSum(cost,cost2,cost3,cost4)}}</td>
                        <td class="text-right">{{formatSum(money,money2,money3,money4)}}</td>
                        ...
                        <td class="text-right">
                        <!-- {{prem}}/{{prem2}}/{{prem3}}/{{prem4}}/{{dutt}}/{{dutt2}}/{{dutt3}}/{{dutt4}}/{{vatt}}/{{vatt2}}/{{vatt3}}/{{vatt4}}/xxx -->
                        ...
                        <!-- <td class="text-right">{{formatCurrency(receivableNet+receivableNet2+receivableNet3+receivableNet4)}}</td> -->
                    </tr>
                    </tbody>
                    <tfoot></tfoot>
                </table>
            ...
            <div class="mt-2 mb-2">
                <a :href="`/ir/assets/asset-plan/export?id=${headerRow.header_id}&program_code=IRP0003`" type="button" class="btn btn-sm btn-info" target="_bank"> <i class="fa fa-print"></i> Export </a>
            </div>

            <div class="table-responsive">
                <b-table
                    table-class="table table-bordered"
                    style="display: block; overflow: auto; max-height: 400px; position: sticky;"
                    :busy.sync="isBusy"
                ...
                >
                    ...
                    <template #head(current_cost)="header">
                        <div>
                            Asset Cost <br>ราคาทุน * (บาท)
                        </div>
                    </template>
                    ...
                    <template #head(cal1)="header">
                        <div>
                            Vat <br>ภาษีมูลค่าเพิ่ม
                        </div>
                    </template>
                    <template #head(cal2)="header">
                        <div>
                    ...
                    <template #cell(department_location_code)="row">
                        ...
                        <el-form-item v-else
                                        :prop="'tableLine.' + row.index + '.department_location_code'"
                                        :rules="rules.department_location_code">
                    ...
                    <template #cell(department_cost_code)="row">
                        ...
                        <el-form-item v-else
                                        :prop="'tableLine.' + row.index + '.department_cost_code'"
                                        :rules="rules.department_cost_code">
                    ...
                    <template #cell(account_code)="row">
                        <el-form-item v-if="complete && row.item.flag === 'add'"
                                        :prop="'tableLine.' + row.index + '.account_code'"
                            ...
                            <div style="padding-top: 3px;">
                                <el-input placeholder="รหัสบัญชี"
                                            ...
                                            size="small">
                                    <!-- @blur="blurAccountCode(data.account_code, data.rowId)" -->
                    ...
                    <template #cell(asset_number)="row">
                        ...
                        <el-form-item v-else
                                        :prop="'tableLine.' + row.index + '.asset_number'"
                                        :rules="rules.asset_number">
                    ...
                    <template #cell(department_code)="row">
                        ...
                        <el-form-item v-else
                                        :prop="'tableLine.' + row.index + '.department_code'"
                                        :rules="rules.department_code">
                            <lov-department v-if="complete"
                                            v-model="row.item.department_code"
                    ...
                    <template #cell(location_name)="row">
                        ...
                        <el-form-item v-else
                                        :prop="'tableLine.' + row.index + '.location_name'"
                    ...
                    <template #cell(category_code)="row">
                        ...
                        <el-form-item v-else
                                        :prop="'tableLine.' + row.index + '.category_code'"
                    ...
                    <template #cell(current_cost)="row">
                        <div v-if="row.item.flag === 'edit'"
                                class="padding_top_10">
                            {{isNullOrUndefined(row.item.current_cost) ?
                            formatCurrency(row.item.current_cost) :
                            isNullOrUndefined(row.item.current_cost)}}
                        </div>
                        <el-form-item v-else
                                        :prop="'tableLine.' + row.index + '.current_cost'"
                                        :rules="rules.current_cost">
                            <ceil-thousand-currency-input v-model="row.item.current_cost"
                                                            :isChangeCeli="false"
                                                            :isBlurCeli="true"
                                                            :row="row.item"
                    ...
                    <template #cell(cal1)="row">
                        <div class="padding_top_10">
                            {{row.item.vat_amount ? formatCurrency(row.item.vat_amount) : vat_cal_value(row.item.insurance_amount,row.item.duty_amount)}}
                        </div>
                    </template>
                    <template #cell(cal2)="row">
                        <div class="padding_top_10">
                            {{row.item.net_amount ? formatCurrency(row.item.net_amount) : net_amount(row.item.insurance_amount,row.item.duty_amount,vat_cal_value(row.item.insurance_amount,row.item.duty_amount))}}
                        </div>
                    </template>
                    ...
                    <template #cell(remove)="row">
                        ...
                        <template v-else>
                            <el-form-item v-if="row.item.flag === 'add' && !row.item.line_id">
                                <button type="button" class="btn btn-danger btn-sm" @click="clickRemove(row.item, row.index)" :name="`line_remove${row.index}`">
                                    <i class="fa fa-times m-r-xs"></i>ลบ
                                </button>
                            </el-form-item>
                        </template>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    account_code: [{
                        required: true, message: 'กรุณาระบุรหัสบัญชี', trigger: 'blur'
                    }],
                    asset_number: [{
                    ...
                    adjustment_amount: [{
                        required: true, message: 'กรุณาระบุราคาทุน', trigger: 'blur'
                    }],
                    // adjustment_cost: [{
                ...
                fields: [
                    { key: 'selected', sortable: false, class:'text-center text-nowrap options-column align-middle', thStyle:'position: sticky; z-index: 9999; top:0px;'},
                    { key: 'line_no', sortable: true, class:'text-center text-nowrap options-column align-middle', thStyle:'position: sticky; z-index: 9999; top:0px;'},
                    { key: 'status', sortable: true, class:'text-nowrap options-column align-middle', tdClass:'align-middle', thStyle:'position: sticky; z-index: 9999; top:0px;'},
                    { key: 'line_type', sortable: true, class:'text-nowrap options-column align-middle', tdClass:'align-middle', thStyle:'position: sticky; z-index: 9999; top:0px;'},
                    { key: 'department_location_code', sortable: true, class:'text-center text-nowrap options-column align-middle', tdClass:'align-middle', thStyle:'position: sticky; z-index: 9999; top:0px;'},
                    { key: 'department_location_desc', sortable: true, class:'text-nowrap align-middle', tdClass:'align-middle', thStyle:'position: sticky; z-index: 9999; top:0px;'},
                    { key: 'department_cost_code', sortable: true, class:'text-center text-nowrap align-middle', tdClass:'align-middle', thStyle:'position: sticky; z-index: 9999; top:0px;'},
                    { key: 'department_cost_desc', sortable: true, class:'text-nowrap align-middle', tdClass:'align-middle', thStyle:'position: sticky; z-index: 9999; top:0px;'},
                    { key: 'account_code', sortable: true, class:'text-center text-nowrap align-middle', tdClass:'align-middle', thStyle:'position: sticky; z-index: 9999; top:0px;'},
                    { key: 'account_desc', sortable: true, class:'text-nowrap align-middle', tdClass:'align-middle', thStyle:'position: sticky; z-index: 9999; top:0px;'},
                    { key: 'asset_number', sortable: true, class:'text-center text-nowrap align-middle', tdClass:'align-middle', thStyle:'position: sticky; z-index: 9999; top:0px;'},
                    { key: 'department_code', sortable: true, class:'text-center text-nowrap align-middle', tdClass:'align-middle', thStyle:'position: sticky; z-index: 9999; top:0px;'},
                    { key: 'department_name', sortable: true, class:'text-nowrap align-middle', tdClass:'align-middle', thStyle:'position: sticky; z-index: 9999; top:0px;'},
                    { key: 'location_name', sortable: true, class:'text-nowrap align-middle', tdClass:'align-middle', thStyle:'position: sticky; z-index: 9999; top:0px;'},
                    { key: 'category_code', sortable: true, class:'text-center text-nowrap align-middle', tdClass:'align-middle', thStyle:'position: sticky; z-index: 9999; top:0px;'},
                    { key: 'category_description', sortable: true, class:'text-nowrap align-middle', tdClass:'align-middle', thStyle:'position: sticky; z-index: 9999; top:0px;'},
                    { key: 'quantity', sortable: true, class:'text-right text-nowrap align-middle', tdClass:'align-middle', thStyle:'position: sticky; z-index: 9999; top:0px;'},
                    { key: 'current_cost', sortable: true, class:'text-right text-nowrap align-middle', tdClass:'align-middle', thStyle:'position: sticky; z-index: 9999; top:0px;'},
                    { key: 'adjustment_amount', sortable: true, class:'text-right text-nowrap align-middle', tdClass:'align-middle', thStyle:'position: sticky; z-index: 9999; top:0px;'},
                    { key: 'insurance_amount', sortable: true, class:'text-right text-nowrap align-middle', tdClass:'align-middle', thStyle:'position: sticky; z-index: 9999; top:0px;'},
                    { key: 'duty_amount', sortable: true, class:'text-right text-nowrap align-middle', tdClass:'align-middle', thStyle:'position: sticky; z-index: 9999; top:0px;'},
                    { key: 'cal1', sortable: true, class:'text-right text-nowrap align-middle', tdClass:'align-middle', thStyle:'position: sticky; z-index: 9999; top:0px;'},
                    { key: 'cal2', sortable: true, class:'text-right text-nowrap align-middle', tdClass:'align-middle', thStyle:'position: sticky; z-index: 9999; top:0px;'},
                    { key: 'receivable_name', sortable: true, class:'text-nowrap align-middle', tdClass:'align-middle', thStyle:'position: sticky; z-index: 9999; top:0px;'},
                    { key: 'expense_flag', sortable: true, class:'text-nowrap align-middle', tdClass:'align-middle', thStyle:'position: sticky; z-index: 9999; top:0px;'},
                    { key: 'remove', sortable: false, class:'text-center text-nowrap align-middle', thStyle: 'min-width: 65px; position: sticky; z-index: 9999; top:0px;'},
                ],
            }
        },
        props: [
        ...
        methods: {
            ...
            vat_cal_value(v1, v2) {
                if (v1 !== '') {
                    const result = ((Number(Number(v1).toFixed(2)) + Number(Number(v2).toFixed(2))) * 7 / 100).toLocaleString('en-US', {
            ...
            net_amount(v1, v2, v3) {
                if (v1 !== '' && v2 !== '' && v3 !== '') {
                    const result = (Number(Number(v1).toFixed(2)) + Number(Number(v2).toFixed(2)) + Number(Number(v3.replace(/,/g, '')).toFixed(2))).toLocaleString('en-US', {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2
                    });
                    return result;
            ...
            clickSelectRow(rowId, obj) {
                let vm = this;
                let checked = $(`input[name="asset_plan_select${rowId}"]`).is(':checked')
                if (checked) {
            ...
            blurAccountCode(value, index) {
                if (value) {
                    this.$refs.save_table_line.fields.find((f) => f.prop == 'tableLine.' + index + '.account_code').clearValidate()
                } else {
            ...
            getValueCoverAmountFromAdjAmount(value, index, adjustment_amount, data) {
                ...
                if (adjustment_amount) {
                    ...
                    // this.$refs.save_table_line.fields.find((f) => f.prop == 'tableLine.' + index + '.adjustment_cost').clearValidate()
                } else {
                    this.$refs.save_table_line.validateField('tableLine.' + index + '.adjustment_amount')
                    // this.$refs.save_table_line.validateField('tableLine.' + index + '.adjustment_cost')
                }
            },
            setCalulateColumsFromCoverAmount(value, index, data) {
                let adjustment_amount = value || value === 0 && value !== undefined && value !== null ? value : 0;
                ...
                // this.form.tableLine[index].vat_amount = insurance_amount || insurance_amount === 0 ? insurance_amount * this.vat_amount_master / 100 : 0;//(insurance_amount + duty) * this.vat_amount_master / 100 : 0;
            ...
            clickRemove(dataRow, i) {
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            if (dataRow.line_id) {
                                axios.post(`/ir/ajax/asset/delete`, dataRow)
                                .then(({data}) => {
        ...
        computed: {
            ...
            startt() {
                ...
                let pp = this.headerRow.as_of_date.split("/")
                return pp[0] + '/' + pp[1] + '/' + (Number(pp[2]) + 543);
            },
            endd() {
                let pp = this.headerRow.insurance_end_date.split("/")
                return pp[0] + '/' + pp[1] + '/' + (Number(pp[2]) + 543);
            },
            yearr() {
