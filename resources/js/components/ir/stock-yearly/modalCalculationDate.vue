      ...
      <div class="modal-content">
        ...
        >
                  ...
                  <ct-datepicker
                    ...
                    :enableDate="
                      (d) =>
                        isInRange(
                          d,
                          toJSDate(this.modal.start_date, 'dd/MM/yyyy'),
                          null,
                          true
                        )
                    "
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-primary" @click="clickAgree()">
  ...
  methods: {
    ...
    getValueStartDate(date) {
      ...
      if (date) {
        ...
        // let dateStCE = this.setFullDateIsDateCE(date);
      ...
      this.modal.end_date = this.covertFomatDateMoment(
        this.setBudgetYearFromFieldStCalendar(date),
        "date"
      );
    ...
    getValueEndDate(date) {
      ...
      if (date) {
        ...
        // let dateEnCE = this.setFullDateIsDateCE(date);
        this.momentEnDate = moment(this.modal.end_date, formatDate);
    ...
    validateNotElUi(value, nameProp) {
      if (value) {
        this.$refs.form_calculate_date.fields
          .find((f) => f.prop == nameProp)
          .clearValidate();
      } else {
