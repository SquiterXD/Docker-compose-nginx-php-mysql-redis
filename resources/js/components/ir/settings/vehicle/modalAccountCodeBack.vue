<template>
    <div>
        ...
        <div id="modal_account" class="modal inmodal fade" aria-hidden="true" data-backdrop="static" aria-labelledby="myModalLabel">
...
<script>
    ...
    export default {
        ...
        props: ['coa', 'typeCost', 'defaultValueSetName'],
        data() {
            return {
                loading: false,
                // Segment
        ...
        methods: {
            async clickAgree() {
                ...
                vm.$emit('resCoa',{type_cost_id: vm.type_cost_id, code_combine: vm.account, description: vm.description, desc_disply: vm.description_disply});
