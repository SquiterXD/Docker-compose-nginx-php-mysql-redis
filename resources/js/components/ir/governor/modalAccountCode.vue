    ...
    async clickAgree () {
      ...
      this.$refs.modal_account_mapping.validate( async (valid) => {
        if (valid) {
          ...
          this.expense_account_desc = (this.description.department==undefined?'':this.description.department) + '.'
            ...
            + (this.description.interCompany==undefined?'':this.description.interCompany) + '.'
            + (this.description.allocation==undefined?'':this.description.allocation)
