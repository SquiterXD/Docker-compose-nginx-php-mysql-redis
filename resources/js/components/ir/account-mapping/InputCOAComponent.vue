    ...
    methods: {
        ...
        changeCoa() {
            ...
            if (this.setName == this.defaultValueSetName.segment8) {
                this.$emit("coa", {name: this.setName, segment8: this.value, options: this.options});
            }
            if (this.setName == this.defaultValueSetName.segment9) {
                this.$emit("coa", {name: this.setName, segment9: this.value, options: this.options});
            }
            if (this.setName == this.defaultValueSetName.segment10) {
                this.$emit("coa", {name: this.setName, segment10: this.value, options: this.options});
            }
            if (this.setName == this.defaultValueSetName.segment11) {
                this.$emit("coa", {name: this.setName, segment11: this.value, options: this.options});
            }
            if (this.setName == this.defaultValueSetName.segment12) {
                this.$emit("coa", {name: this.setName, segment12: this.value, options: this.options});
            }
        }
        // changeCoa() {
        //     if (this.setName == this.defaultValueSetName.segment1) {
