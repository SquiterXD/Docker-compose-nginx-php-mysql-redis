        ...
        <table class="table table-bordered table-sticky mb-0" style="min-width: 1900px;">
            ...
            <thead>
                <tr>
                    ...
                    <th rowspan="2" width="6%" class="text-center tw-text-xs md:tw-table-cell tw-hidden">
                        เวลาที่เก็บตัวอย่าง
                    </th>
                    <th rowspan="2" width="6%" class="text-center tw-text-xs md:tw-table-cell tw-hidden" style="min-width: 100px; max-width: 100px;">
                        เวลาที่วัด
                    </th>
                    ...
                    <th rowspan="2" width="10%" style="min-width: 100px;" class="tw-text-xs text-center md:tw-table-cell tw-hidden"> 
                ...
                <tr>
                    <th width="6%" style="top: 3.1rem;" class="tw-text-xs text-center md:tw-table-cell tw-hidden"> Minor </th>
                    <th width="6%" style="top: 3.1rem;" class="tw-text-xs text-center md:tw-table-cell tw-hidden"> Major </th>
                    <th width="6%" style="top: 3.1rem;" class="tw-text-xs text-center md:tw-table-cell tw-hidden"> Critical </th>
                    <th width="6%" style="top: 3.1rem;" class="tw-text-xs text-center md:tw-table-cell tw-hidden"> Minor </th>
                    <th width="6%" style="top: 3.1rem;" class="tw-text-xs text-center md:tw-table-cell tw-hidden"> Major </th>
                    <th width="6%" style="top: 3.1rem;" class="tw-text-xs text-center md:tw-table-cell tw-hidden"> Critical </th>
                </tr>
                ...
                <template v-for="(sampleItem, index) in sampleItems">
                    <tr :key="sampleItem.sample_no">
                        ...
                        <td class="text-center md:tw-table-cell tw-hidden">
                            {{ sampleItem.machine_description }}
                        </td>
                        <td class="text-center md:tw-table-cell tw-hidden">
                        ...
                        <td class="text-center md:tw-table-cell tw-hidden">
                            {{ sampleItem.test_time ? sampleItem.test_time : "" }}
                        </td>
                        <td class="text-center md:tw-table-cell tw-hidden">
                    ...
                    >
                        <td colspan="14" style="border-right: 0;">
                            <qm-table-packet-air-leak-results
                                :auth-user="authUser"
                                :show-type="showType"
                                :sample="sampleItem"
                                ...
                                :list-leak-positions="listLeakPositions"
...
export default {
        ...
        return {
            sampleItems: JSON.parse(this.items).map(item => {
                return {
                    ...
                    machine_description: this.getMachineDesc(this.machines, item.qc_area, item.machine_name),
    ...
    methods: {
        ...
        getMachineDesc(machines, qcArea, machineName) {
            let result = "";
            const foundMachineWithQcArea = machines.find(item => (item.machine_name == machineName && item.qc_area == qcArea));
            if(foundMachineWithQcArea){
                // result = foundMachineWithQcArea.machine_description;
                result = foundMachineWithQcArea.machine_description
            }else{
                const foundMachine = machines.find(item => (item.machine_name == machineName));
                if(foundMachine){
        ...
        getSampleSpecifications(sampleNo, organizationId, inventoryItemId) {
            ...
            return axios
                .get("/qm/ajax/packet-air-leaks/get-sample-specifications", {
                    params
                })
                .then(res => {
                    const resResults = JSON.parse(res.data.data.results).map(item => {
                        return {
                            ...item,
                            position_leak_entered: null,
                            position_leak_required: null,
                            // position_leak_none: null,
                        }
                    });
                    return {
        ...
        onSampleResultSubmitted(data) {
            if(data.status == "success") {
                ...
                const resSampleTestTime = data.test_time;
                this.sampleItems.forEach((element, i) => {
                    ...
                    if(this.sampleItems[i].sample_no == resSampleNo){
                        ...
                        this.sampleItems[i].test_time = resSampleTestTime;
                    }
                });
            }
        },
        ...
        async approveSample(sampleData, approvalRole, approvalProcessLabel) {
            ...
            await axios.post(`/qm/ajax/packet-air-leaks/approval/approve`, reqBody)
            .then((res) => {
        ...
        async approveAllSamples(sampleNos, approvalRole, approvalProcessLabel) {
            ...
            await axios.post(`/qm/ajax/packet-air-leaks/approval/approve-all`, reqBody)
            .then((res) => {
        ...
        async rejectSample(sampleData, approvalRole, approvalProcessLabel) {
            ...
            await axios.post(`/qm/ajax/packet-air-leaks/approval/reject`, reqBody)
            .then((res) => {
        ...
        async returnSample(sampleData, approvalRole, approvalProcessLabel) {
            ...
            await axios.post(`/qm/ajax/packet-air-leaks/approval/return`, reqBody)
            .then((res) => {
        ...
        async unapproveSample(sampleData, approvalRole, approvalProcessLabel) {
            ...
            await axios.post(`/qm/ajax/packet-air-leaks/approval/unapprove`, reqBody)
            .then((res) => {
