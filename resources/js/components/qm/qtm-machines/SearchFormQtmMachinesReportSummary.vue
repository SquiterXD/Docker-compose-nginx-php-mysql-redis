    ...
    <div class="col-md-8">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="row form-group" v-show="false">
            ...
            <div class="col-md-6">
                ...
                <div class="row form-group" v-show="false">
                    ...
                    <div class="col-md-8">
                        <qm-el-select name="quality_status" id="input_quality_status" placeholder="เลือกตามข้อกำหนด "
                            option-key="value" option-value="value" option-label="label"
                            :select-options="qualityStatusOptions" 
                            :clearable="true" 
                            :filterable="true"
                            :value="qualityStatus" />
                    </div>
                ...
                <div class="row form-group" v-show="false">
                    <label class="col-md-4 col-form-label"> ผลการตรวจ </label>
                    <div class="col-md-8">
                        <qm-el-select name="result_status" id="input_result_status" placeholder="เลือกผลการตรวจ "
                            option-key="value" option-value="value" option-label="label"
                            :select-options="resultStatusOptions" 
                            :clearable="true" 
                            :filterable="true"
                            :value="resultStatus" />
                    </div>
