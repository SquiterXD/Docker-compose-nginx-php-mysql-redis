<template>
    ...
    <div class="table-responsive" style="max-height: 800px;">
        ...
        <table class="table table-bordered table-sticky mb-0" style="min-width: 1700px;">
            ...
            <thead>
                ...
                <tr>
                    <th width="6%" style="top: 2.5rem;" class="tw-text-xs text-center md:tw-table-cell tw-hidden"> Minor </th>
                    <th width="6%" style="top: 2.5rem;" class="tw-text-xs text-center md:tw-table-cell tw-hidden"> Major </th>
                    <th width="6%" style="top: 2.5rem;" class="tw-text-xs text-center md:tw-table-cell tw-hidden"> Critical </th>
                    <th width="6%" style="top: 2.5rem;" class="tw-text-xs text-center md:tw-table-cell tw-hidden"> Minor </th>
                    <th width="6%" style="top: 2.5rem;" class="tw-text-xs text-center md:tw-table-cell tw-hidden"> Major </th>
                    <th width="6%" style="top: 2.5rem;" class="tw-text-xs text-center md:tw-table-cell tw-hidden"> Critical </th>
                </tr>
                ...
                <template v-for="(sampleItem, index) in sampleItems">
                    <tr :key="sampleItem.sample_no">
                        <td class="freeze-col" style="min-width: 300px;">
                            <div class="freeze-col-content">
                                ...
                                <div class="tw-inline-block tw-align-top tw-pl-4 tw-py-2" style="min-height: 60px; min-width: 190px; max-width: 190px; border-left: 1px solid #ddd;">
                    ...
                    >
                        <td colspan="14" style="border-right: 0;">
                            <qm-table-moth-outbreak-results
                                :auth-user="authUser"
                                :show-type="showType"
...
export default {
        ...
        return {
            sampleItems: JSON.parse(this.items).map(item => {
                return {
                    ...
                    location_full_desc: this.getLocatorDesc(item),
    ...
    methods: {
            ...
            if(sample.sample_operation_status == 'CP') {
                ...
                if(approvalRole) {
                    ...
                    if(approvalLevelCode == "2") { // Supervisor
                        if(sample.approval_status_code == "10" || sample.approval_status_code == "11") { // Pending : Supervisor Approval (Operator Approved)
                            allowed = true;
                        }
        ...
        getSampleSpecifications(
            ...
            return axios
                .get("/qm/ajax/moth-outbreaks/get-sample-specifications", { params })
                .then(res => {
                    return {
        ...
        async approveSample(sampleData, approvalRole, approvalProcessLabel) {
            ...
            await axios.post(`/qm/ajax/moth-outbreaks/approval/approve`, reqBody)
            .then((res) => {
        ...
        async approveAllSamples(sampleNos, approvalRole, approvalProcessLabel) {
            ...
            await axios.post(`/qm/ajax/moth-outbreaks/approval/approve-all`, reqBody)
            .then((res) => {
        ...
        async rejectSample(sampleData, approvalRole, approvalProcessLabel) {
            ...
            await axios.post(`/qm/ajax/moth-outbreaks/approval/reject`, reqBody)
            .then((res) => {
        ...
        async returnSample(sampleData, approvalRole, approvalProcessLabel) {
            ...
            await axios.post(`/qm/ajax/moth-outbreaks/approval/return`, reqBody)
            .then((res) => {
        ...
        async unapproveSample(sampleData, approvalRole, approvalProcessLabel) {
            ...
            await axios.post(`/qm/ajax/moth-outbreaks/approval/unapprove`, reqBody)
            .then((res) => {
