                        ...
                        <template v-else>
                            <div class="row col-12" style="font-size: 15px;">
                                <div class="form-group pl-2 pr-2 mb-0 col-lg-2 col-md-4 col-sm-6 col-xs-6 mt-2">
                                    ...
                                    <span> {{ saleForecasts? saleForecasts[0].biweekly_no: '' }} </span>
                                </div>
                                ...
                                <div class="form-group pl-2 pr-2 mb-0 col-lg-3 col-md-4 col-sm-6 col-xs-6 mt-2 text-left">
                                    ...
                                    <span>
                                        {{ saleForecasts? saleForecasts[0].om_bi_weekly.day_for_sale: 0 }} วัน
                                    </span>
                                </div>
                                ...
                                <div class="form-group pl-2 pr-2 mb-0 col-lg-3 col-md-4 col-sm-6 col-xs-6 mt-2 text-left">
                                    ...
                                    <span>
                                        {{ saleForecasts? saleForecasts[0].om_sales_forecast.approve_date_format: '' }}
                                    </span>
                                </div>
                            </div>
...
<script>
    ...
    export default {
        props:[
            "omSalesForecast", "pSaleForecasts", 'versionLists', 'url'
        ],
        data() {
            return {
                forecast_qty: 0,
        ...
        methods: {
            ...
            async changeVersion(){
                ...
                await axios
                .post(vm.url.ajax_get_sales_forecast_version, {params})
                .then(res => {
                    vm.loading = false;
