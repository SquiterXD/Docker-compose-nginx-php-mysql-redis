        ...
        <div class="ibox float-e-margins mb-2" >
            <div class="col-12 text-right mt-1">
                <modal-search
                    ...
                    :defaultCurrentYear="modalSearchInput.def_period_year"
                    :canEdit="canEdit"
                    :search="[]" />
                ...
                <a v-if="adjustData"
                    target="_blank"
                    :href="'/ir/reports/get-param?period_year='
                        +adjustData.period_year
                        +'&month='+adjustData.period_num
                        +'&biweekly='+adjustData.biweekly
                        +'&version_no='+adjustData.adjust_no
                                ...
                                <tbody>
                                    <template v-for="(item, itemKey, itemIndex) in adjBiweeklyData[productType][Object.keys(adjBiweeklyData[productType])[0]]">
                                        <tr>
                                            ...
                                            <td class="text-right" >
                                                {{ item.actual_forecase_qty | number3Digit}}
                                            </td>
                                            <td class="text-right" >
                                                {{ item.planning_qty | number3Digit}}
                                                <!-- <input type="number"
