                        ...
                        <div class="row col-12">
                            ...
                            <div class="form-group pl-2 pr-2 mb-0 col-lg-3 col-md-2 col-sm-6 col-xs-6 mt-2">
                                ...
                                <div class="">
                                    ...
                                    <el-select v-if="budget_year != '' && month != ''" v-model="biweekly" clearable size="large" placeholder="ปักษ์" :popper-append-to-body="false">
                                       <el-option
                                    ...
                                    <el-select v-else v-model="biweekly" disabled clearable size="large" placeholder="ปักษ์" filterable >
                            ...
                            <!-- <div class="form-group pl-2 pr-2 mb-0 col-lg-3 col-md-2 col-sm-6 col-xs-6 mt-2">
                                ...
                                <div class="input-group ">
                                    <input type="hidden" name="search[budget_year]" :value="budget_year">
                                    <el-select v-model="budget_year" size="large" placeholder="ปีงบประมาณ" @change="getBiWeekly" clearable filterable>
                                        <el-option
                                           v-for="(year, index) in budgetYears"
                                            :key="index"
                            ...
                            <div class="form-group pl-2 pr-2 mb-0 col-lg-3 col-md-2 col-sm-6 col-xs-6 mt-2">
                                ...
                                <div class="">
                                    ...
                                    <el-select v-else v-model="biweekly" clearable size="large" placeholder="ปักษ์" filterable :v-loading="b_loading" >
                                       <el-option
                                           v-for="(biweekly, index) in biWeeklyLists"
                                            :key="index"
                                            :label="biweekly.biweekly"
    ...
    export default {
        ...
        methods: {
            ...
            async searchForm() {
                ...
                await axios.get(vm.url.ajax_adjusts_search, {
                        params: {
