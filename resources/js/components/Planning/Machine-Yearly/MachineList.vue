...
export default {
    ...
    methods: {
        ...
        async getDateByBiWeekly() {
            ...
            let dt_date_from = vm.machineLine.start_date != ''? moment(vm.machineLine.start_date).format('YYYY-MM-DD'): vm.ppMonthly.start_date;
            let dt_date_to = vm.machineLine.end_date != ''? moment(vm.machineLine.end_date).format('YYYY-MM-DD'): vm.ppMonthly.end_date;
