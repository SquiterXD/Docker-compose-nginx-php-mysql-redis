<template>
    <div>
        <div class="row">
            <div class="col-md-8">
                <h2 class="tw-font-bold"> Stamp Daily Detail </h2>
            </div>
            <!-- <div class="col-md-4 text-right" v-if="header && canEdit">
                <button v-if="!edit_flag" type="button" :class="btnTrans.edit.class + ' btn-lg tw-w-25'" @click="changeStampData()"> 
                    <i :class="btnTrans.edit.icon"></i> {{ btnTrans.edit.text }}
                </button>
                <button v-if="edit_flag" type="button" :class="btnTrans.save.class + ' btn-lg tw-w-25'" @click.prevent="saveChangeInput">
                    <i :class="btnTrans.save.icon"></i> {{ btnTrans.save.text }}
                </button>
                <button v-if="edit_flag" type="button" :class="btnTrans.cancel.class + ' btn-lg tw-w-25'" @click="changeStampData()">
                        ...
                        <template v-for="(line, index) in lines">
                            <tr :style="line.holiday_flag == 'Y'? 'background-color: #cccccc;'
                                ...
                                <td class="text-right" :style="sel_daily == line.follow_date_format? 'background-color: #9AD9DB; vertical-align: middle;' : 'vertical-align: middle;'" @click="selDailyDate(line.follow_date_format)">
                                    <!-- <div style="width: 100px;"> {{ line.onhand_qty | number3Digit }} </div> -->
                                    <div style="width: 100px;">
                                        <!-- {{ onhandQuantity[line.follow_date] && index != 0? formatNumber(Number(onhandQuantity[line.follow_date])): formatNumber(Number(line.onhand_qty)) }} -->

                                        {{ formatNumber(Number(balanceOnhandWeekly[line.follow_date])) }}
                                    </div>
                                </td>
                                <td class="text-right" :style="sel_daily == line.follow_date_format? 'background-color: #9AD9DB;' : ''" @click="selDailyDate(line.follow_date_format)">
                                    ...
                                    ></receive-weekly>
                                    <!-- <div v-else style="width: 100px;"> {{ line.weekly_receive_qty | number3Digit }} </div> -->
                                </td>
                                <td class="text-right" :style="sel_daily == line.follow_date_format? 'background-color: #9AD9DB;' : ''" @click="selDailyDate(line.follow_date_format)">
                                    <receive-roll
                                        style="width: 130px;"
                                    ...
                                    ></receive-roll>
                                    <!-- <div v-else style="width: 100px;"> {{ line.receive_roll_qty | number3Digit }} </div> -->
                                </td>
                                <td class="text-right" :style="sel_daily == line.follow_date_format? 'background-color: #9AD9DB; vertical-align: middle;' : 'vertical-align: middle;'" @click="selDailyDate(line.follow_date_format)">
                                   <div style="width: 130px;"> {{ decimal(line.receipt_amount) }} </div>
                                </td>
                                <td class="text-right" :style="sel_daily == line.follow_date_format? 'background-color: #9AD9DB; vertical-align: middle;' : 'vertical-align: middle;'" @click="selDailyDate(line.follow_date_format)">
                                    <div style="width: 100px;"> {{ formatNumber(Number(line.claim_receive_qty)) }} </div>
                                </td>
                                <td class="text-right" :style="sel_daily == line.follow_date_format? 'background-color: #9AD9DB; vertical-align: middle;' : 'vertical-align: middle;'" @click="selDailyDate(line.follow_date_format)">
                                    <div style="width: 100px;"> {{ formatNumber(Number(line.issue_qty)) }} </div>
                                </td>
                                <td class="text-right" :style="sel_daily == line.follow_date_format? 'background-color: #9AD9DB; vertical-align: middle;' : 'vertical-align: middle;'" @click="selDailyDate(line.follow_date_format)">
                                    <div style="width: 100px;"> {{ formatNumber(Number(line.lost_qty)) }} </div>
                                </td>
                                <td class="text-right" :style="sel_daily == line.follow_date_format? 'background-color: #9AD9DB; vertical-align: middle;' : 'vertical-align: middle;'" @click="selDailyDate(line.follow_date_format)">
                                    <div style="width: 100px;"> {{ formatNumber(Number(line.damaged_qty)) }} </div>
                                </td>
                                <td class="text-right" :style="sel_daily == line.follow_date_format? 'background-color: #9AD9DB; vertical-align: middle;' : 'vertical-align: middle;'" @click="selDailyDate(line.follow_date_format)">
                                    <div style="width: 100px;"> {{ formatNumber(Number(line.incompleted_qty)) }} </div>
                                </td>
                                <td class="text-right" :style="sel_daily == line.follow_date_format? 'background-color: #9AD9DB; vertical-align: middle;' : 'vertical-align: middle;'" @click="selDailyDate(line.follow_date_format)">
                                    <div style="width: 100px;"> {{ formatNumber(Number(line.total_issue_qty)) }} </div>
                                </td>
                                <td class="text-right" :style="sel_daily == line.follow_date_format? 'background-color: #9AD9DB; vertical-align: middle;' : 'vertical-align: middle;'" @click="selDailyDate(line.follow_date_format)">
                                    <div style="width: 100px;"> {{ formatNumber(Number(line.total_daily_qty)) }} </div>
                                </td>
                                <td class="text-right" :style="sel_daily == line.follow_date_format? 'background-color: #9AD9DB; vertical-align: middle;' : 'vertical-align: middle;'" @click="selDailyDate(line.follow_date_format)">
                                    <div style="width: 100px;"> {{ formatNumber(Number(line.factory_bal_onhand_qty)) }} </div>
                                </td>
                                <td class="text-right" :style="sel_daily == line.follow_date_format? 'background-color: #9AD9DB; vertical-align: middle;' : 'vertical-align: middle;'" @click="selDailyDate(line.follow_date_format)">
                                    <div style="width: 100px;"> {{ formatNumber(Number(line.inventory_bal_onhand_qty)) }} </div>
                                </td>
                                <td class="text-right" :style="sel_daily == line.follow_date_format? 'background-color: #9AD9DB; vertical-align: middle;' : 'vertical-align: middle;'" @click="selDailyDate(line.follow_date_format)">
                                    <div style="width: 100px;"> {{ formatNumber(balanceOnhandWeekly[line.follow_date]) }} </div>
                                </td>
                                <td class="text-right" :style="sel_daily == line.follow_date_format? 'background-color: #9AD9DB; vertical-align: middle;' : 'vertical-align: middle;'" @click="selDailyDate(line.follow_date_format)">
                                    <div style="width: 100px;"> {{ decimal(balanceOnhandRoll[line.follow_date]) }} </div>
                                </td>
                                <td class="text-right" :style="sel_daily == line.follow_date_format? 'background-color: #9AD9DB; vertical-align: middle;' : 'vertical-align: middle;'" @click="selDailyDate(line.follow_date_format)">
                                    <div style="width: 100px;"> {{ decimal(balanceQuantity[line.follow_date]) }} </div>
                                </td>
                            </tr>
                        </template>
                        <tr>
                            ...
                            <td class="text-right" style="vertical-align: middle; background-color: #70d200;">
                                <div class="tw-font-bold text-right" style="width: 100%;">
                                    {{ formatNumber(Number(quantity.weekly_receive)) }}
                                </div>
                            </td>
                            <td class="text-right" style="vertical-align: middle; background-color: #70d200;">
                                <div class="tw-font-bold text-right" style="width: 100%;">
                                    {{ Number(quantity.roll_receive).toFixed(2) }}
                                </div>
                            </td>
                            <td class="text-right" style="vertical-align: middle; background-color: #70d200;">
                                <div class="tw-font-bold text-right" style="width: 100%;">
                                    {{ decimal(Number(quantity.total_receive)) }}
                                </div>
                            </td>
                            <td class="text-right" style="vertical-align: middle; background-color: #70d200;">
                                <div class="tw-font-bold text-right" style="width: 100%;">
                                    {{ formatNumber(Number(quantity.claim_receive)) }}
                                </div>
                            </td>
                            <td class="text-right" style="vertical-align: middle; background-color: #70d200;">
                                <div class="tw-font-bold text-right" style="width: 100%;">
                                    {{ formatNumber(Number(quantity.issue_receive)) }}
                                </div>
                            </td>
                            <td class="text-right" style="vertical-align: middle; background-color: #70d200;">
                                <div class="tw-font-bold text-right" style="width: 100%;">
                                    {{ formatNumber(Number(quantity.lost_receive)) }}
                                </div>
                            </td>
                            <td class="text-right" style="vertical-align: middle; background-color: #70d200;">
                                <div class="tw-font-bold text-right" style="width: 100%;">
                                    {{ formatNumber(Number(quantity.damaged_receive)) }}
                                </div>
                            </td>
                            <td class="text-right" style="vertical-align: middle; background-color: #70d200;">
                                <div class="tw-font-bold text-right" style="width: 100%;">
                                    {{ formatNumber(Number(quantity.incompleted_receive)) }}
                                </div>
                            </td>
                            <td class="text-right" style="vertical-align: middle; background-color: #70d200;">
                                <div class="tw-font-bold text-right" style="width: 100%;">
                                    {{ formatNumber(Number(quantity.total_issue_receive)) }}
                                </div>
                            </td>
                            <td class="text-right" style="vertical-align: middle; background-color: #70d200;">
                                <div class="tw-font-bold text-right" style="width: 100%;">
                                    {{ formatNumber(Number(quantity.total_daily_receive)) }}
                                </div>
                            </td>
