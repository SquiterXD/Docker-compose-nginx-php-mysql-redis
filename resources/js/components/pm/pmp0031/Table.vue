            ...
            <thead>
                <tr>
                    ...
                    <th class="text-center">
                        <small>หน่วยนับ(1)</small>
                    </th>
                    <th class="text-center"><small>จำนวนซอง</small></th>
                    <th class="text-center"><small>หน่วยนับ(2)</small></th>
                    <th class="text-center">
                        <small>จำนวนที่ต้องผลิต</small>
                    </th>
                    <th class="text-center"><small>หน่วยนับ(3)</small></th>
                    <th class="text-center">
                ...
                <tr v-for="(productPlanLine, index) in lines" :key="index">
                    ...
                    <td class="text-center">
                        <el-input
                            size="mini"
                            class="w-auto"
                            v-model="productPlanLine.uom_ptn.unit_of_measure"
                            readonly
                        >
                        </el-input>
                    </td>
