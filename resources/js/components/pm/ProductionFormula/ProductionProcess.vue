<template>
    <div class="ibox-content">
        ...
        <div class="row mt-3" v-if="this.wipStepList.length > 0">
            <div class="col-md-6">
...
<!-- ------------------------------------------------------------------วัตถุดิบที่ใช้-------------------------------------------------------------------- -->
        <div class="mt-5">
            <div class="row mb-2">
                ...
                <div class="col-9 text-right" v-if="this.oprn_id">
                ...
                <table class="table text-nowrap table-bordered  table-hover">
                    ...
                    <tbody>
                        <tr v-for="(row, index) in lines"  :key="index" :row="row">
                            ...
                            <td><el-input :name="'dataGroup['+row.oprn_id+']['+row.id+'][ingredient_folmula_qty]'" v-model="row.ingredient_folmula_qty" size="medium" @input="onlyNumeric(row)"></el-input></td>
                            <td><el-input :name="'dataGroup['+row.oprn_id+']['+row.id+'][ingredient_loss]'" v-model="row.ingredient_loss" size="medium"  @input="onlyNumeric(row)"></el-input></td>
                            <td> {{ row.ingredient_qty.toLocaleString() }}</td>
...
export default {
    ...
    methods:{
        ...
        addLine() {
            ...
            // console.log('Count Line --> ' + number + '0');
        ...
        async getItemList(query) {
            ...
            if (this.firstLoad) {
                defIngredientItemId = JSON.parse(JSON.stringify(this.defaultItems))
                this.firstLoad = false
            }
            console.log('aaaaaa', this.firstLoad, this.defaultItems, this.defIngredientItemId);
