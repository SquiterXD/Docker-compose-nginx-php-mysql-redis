        ...
        <div class="ibox-content">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <el-input name="item_header" :value="item_header" disabled></el-input>
                </div>
                <div class="col-md-4">
                    <label> สถานะ </label>
            ...
            <div class="row mt-2">
                <div class="col-md-4">
                    <label> ประเภทสูตร <span class="text-danger">*</span></label>
                     <el-input name="folmula_type_desc" :value="folmula_type_desc" disabled></el-input>
                ...
                <div class="col-md-4">
                    ...
                    <el-input name="period_year" v-model="period_year" disabled></el-input>
            ...
            <div class="row mt-2">
                <div class="col-md-4">
                    ...
                    <el-input name="routing_desc" :value="routing_desc" disabled></el-input>
                </div>
                <div class="col-md-4">
                    <div class="row">
                        <div class="col-md-7">
                        ...
                        <div class="col-md-5">
                            ...
                            <el-input name="uom_header_desc" :value="uom_header_desc" disabled></el-input>
                ...
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <el-input name="machine_desc" :value="machine_desc" disabled></el-input>
...
export default {
    ...
    methods: {
        ...
        async getWipStep() {
            ...
            if (this.folmula_type) {
                if (this.formula_type_desc == 'สูตรมาตรฐาน') {
