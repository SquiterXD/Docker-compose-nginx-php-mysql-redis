            ...
            <div class="tw-mb-4">
                ...
                <div class="text-right tw-mb-2">
                    ...
                    <button class="btn btn-inline-block btn-sm btn-success tw-w-40"
                        @click="onApprove"
                        :disabled="!isAllowApproval(biweeklyPlanHeader, biweeklyPlanLines)"
                    > 
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <pm-el-select name="biweekly_plan_version" id="input_biweekly_plan_version" 
                                    :select-options="biweeklyPlanVersions"
                                    option-key="version"
...
export default {
    ...
    components: { Loading, TablePlanLines },
                    ...
                    this.getBiweekOfPlans(this.periodYearValue, this.periodNameValue).then((value) => {
                        ...
                        if(this.biweeklyValue && this.printTypeValue && this.saleTypeValue && this.sourceVersionValue) {
                            ...
                            this.getSourceVersions(this.periodYearValue, this.periodNameValue, this.printTypeValue, this.saleTypeValue).then((value) => {
                                this.getBiweeklyPlanData(this.periodYearValue, this.periodNameValue, this.biweeklyValue, this.printTypeValue, this.saleTypeValue, this.sourceVersionValue, this.biweeklyPlanVersionValue);
                            });
                        }
    ...
    methods: {
        ...
        async onBiweeklyPlanVersionChanged(value) {
        ...
        async onApprove() {
            ...
            const resValidate = this.validateBeforeApproval(this.biweeklyPlanHeader, this.biweeklyPlanLines);

            if(resValidate.valid) {

                // call store sample result
                await axios.post(`/ajax/pm/plans/biweekly/approve`, reqBody)
                .then(res => {
                    ...
                    if(resData.status == "success") {
                        ...
                        swal("Success", `อนุมัติ ข้อมูลการวางแผนผลิตสิ่งพิมพ์รายปักษ์ : ${this.biweekly} เดือน : ${this.periodNameLabel} ปี ${this.periodYearLabel} ระบบการพิมพ์ ${this.printTypeLabel} version : ${this.biweeklyPlanVersion} )`, "success");

                    }

                    if(resData.status == "error") {
                        swal("เกิดข้อผิดพลาด", `อนุมัติ ข้อมูลการวางแผนผลิตสิ่งพิมพ์รายปักษ์ : ${this.biweekly} เดือน : ${this.periodNameLabel} ปี ${this.periodYearLabel} ระบบการพิมพ์ ${this.printTypeLabel} | ${resMsg}`, "error");
                    }
                    ...
                    console.log(error);
                    swal("เกิดข้อผิดพลาด", `อนุมัติ ข้อมูลการวางแผนผลิตสิ่งพิมพ์รายปักษ์ : ${this.biweekly} เดือน : ${this.periodNameLabel} ปี ${this.periodYearLabel} ระบบการพิมพ์ ${this.printTypeLabel} | ${error.message}`, "error");
                });
        ...
        async onReject() {
            ...
            if(resValidate.valid) {
                ...
                // call store sample result
                await axios.post(`/ajax/pm/plans/biweekly/reject`, reqBody)
                .then(res => {
                    ...
                    if(resData.status == "success") {
                        ...
                        swal("Success", `ไม่อนุมัติ ข้อมูลการวางแผนผลิตสิ่งพิมพ์รายปักษ์ : ${this.biweekly} เดือน : ${this.periodNameLabel} ปี ${this.periodYearLabel} ระบบการพิมพ์ ${this.printTypeLabel} version : ${this.biweeklyPlanVersion} )`, "success");

                    }

                    if(resData.status == "error") {
                        swal("เกิดข้อผิดพลาด", `ไม่อนุมัติ ข้อมูลการวางแผนผลิตสิ่งพิมพ์รายปักษ์ : ${this.biweekly} เดือน : ${this.periodNameLabel} ปี ${this.periodYearLabel} ระบบการพิมพ์ ${this.printTypeLabel} | ${resMsg}`, "error");
                    }
                    ...
                    console.log(error);
                    swal("เกิดข้อผิดพลาด", `ไม่อนุมัติ ข้อมูลการวางแผนผลิตสิ่งพิมพ์รายปักษ์ : ${this.biweekly} เดือน : ${this.periodNameLabel} ปี ${this.periodYearLabel} ระบบการพิมพ์ ${this.printTypeLabel} | ${error.message}`, "error");
                });
