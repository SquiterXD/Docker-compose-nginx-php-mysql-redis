        ...
        <table class="table table-sticky table-bordered mb-0" style="min-width: 1306px;">
            <thead>
                <tr>
                    ...
                    <th style="min-width: 200px; max-width: 200px;" class="text-center"> 
                        <span v-if="organizationCode == 'M06'"> รวม (พันมวน) </span>
                        <span v-else> รวม (ล้านมวน) </span> 
                    </th>
                </tr>
            </thead>
            ...
            <tbody v-if="salePlanItems.length > 0">
                ...
                <tr>
                    <th style="min-width: 320px; max-width: 320px;" class="text-left tw-bg-white freeze-col"> 
                        <div class="freeze-col-content" style="padding: 0px;">
                            <div class="tw-inline-block tw-pl-2 tw-py-4"> 
                                <span v-if="organizationCode == 'M06'"> ยอดรวมทุกตรา (พันมวน) </span>
                                <span v-else> ยอดรวมทุกตรา (ล้านมวน) </span> 
                            </div>
                        </div>
                    </th>
...
export default {
    ...
    props: ["organizationCode", "salePlans", "salePlanSummary"],
