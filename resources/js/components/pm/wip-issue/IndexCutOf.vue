...
export default {
    ...
    data() {
        return {
            ...
            wipIssueHeader: "",
            canSave: false,
            testUrl: 'http://web-service.test/pm/ajax/get-formulas?date=01/08/2564&blend_no=64M0621-024&opt_no=&oprn_no=WIP01-PRN_OTHER&item_id=202017&total_opt_quantity=2000&classification=03&product_item_number%20=undefined&program_code=PMP0051'
        };
    },
    mounted() {
        // this.getFormula();
    ...
    methods: {
        ...
        async getOprn() {
            axios
                ...
                .then(res => {
                    ...
                    let productBatchV = res.data.productBatchV;
                    let productBatchVs = res.data.productBatchVs;

                    this.oprns = oprns;
                    this.defaultOprn = defaultOprn;
                    this.loading.oprn = false;
                    this.productBatchV  = productBatchV;
                    this.productBatchVs = productBatchVs;
                })
                .then(() => {
        ...
        findOprn() {
            ...
            this.oprn = oprn;
            this.oprnDescription = this.oprn.manufacture_step.wip_step_desc;
        },
        // async getOprn() {
        //     axios
        //         .get(
        ...
        getFormula() {
            ...
            if (this.validateForm === false) {
                ...
                // this.totalOptQuantity =    total_opt_quantity
        ...
        async saveData() {
            ...
            if (this.validateForm() === false) {
                ...
                this.form_header.lines = this.formulas;
                this.form_header.item_classpification_code = this.classClassificationCode;
        ...
        submit() {
            ...
            this.formulas.forEach(formula => {
                // console.log(groupB[formula.group_line].length);
        ...
        async selectHeader(header) {
            ...
            // this.date_issue = moment(header.issue_date).add(543, 'years').toDate();
            // this.date = moment(header.complete_date).add(543, 'years').toDate();
            ...
            this.oprnDescription  =  header.wip_step_desc;
        ...
        modalOpen() {
            ...
            // axios.get(this.url.getHeaders+'?item_classification_code='+this.classClassificationCode+'&program_code='+this.programCode).then(res => {
    ...
    computed: {
        totalOptQuantity: function() {
            ...
            if(this.oprnSeletected){
                return this.oprn.confirm_qty;
                // return parseFloat(this.oprn.confirm_qty).toLocaleString(undefined, {minimumFractionDigits: 2})
            }

            return 0;
        },
        showTotalOptQuantity: function() {
            if(this.oprnSeletected){
                return parseFloat(this.oprn.confirm_qty).toLocaleString(undefined, {minimumFractionDigits: 2})
            }
        ...
        disabledSave(){
            ...
            if(this.wipIssueHeader.status == 'ยกเลิก'){
                return true;
            }
