    ...
    <div>
        <div class="row">
            <div class="col-md-4">
                ...
                <el-input type="text" name="account_code" v-model="account_code" size="small" placeholder="Please enter a value" autocomplete="off" :disabled="this.disableEdit"></el-input>
            </div>
            <div class="col-md-4">
                <label> Description </label>
                <el-input type="text" name="description" v-model="description" size="small" placeholder="Please enter a value" autocomplete="off"></el-input>
            </div>
            <div class="col-md-4">
                <label> COMPANY </label>
            ...
            <div class="col-md-4">
                ...
                <el-select  v-model="segment5"
                    ...
                    <el-option  v-for="budgetYear in budgetYears"
                                ...
                                :label="budgetYear.budget_year + ' : ' + budgetYear.description"
            ...
            <div class="col-md-4">
                ...
                <el-select  v-model="segment6"
                    ...
                    <el-option  v-for="budgetType in budgetTypes"
                                ...
                                :label="budgetType.budget_type + ' : ' + budgetType.description"
            ...
            <div class="col-md-4">
                ...
                <el-select  v-model="segment8"
                    ...
                    <el-option  v-for="budgetReason in budgetReasons"
                                ...
                                :label="budgetReason.budget_reason + ' : ' + budgetReason.description"
...
export default {
    ...
    mounted() {
        console.log('valueSetName <--->' + this.valueSetName);
     ...
     methods: {
        updateCoaFrom(res){
            ...
            if (res.name == this.valueSetName + '_GL_ACCT_CODE-DEPT_CODE') { this.segment3 = res.segment3; this.segment4 = null}
            ...
            if (res.name == this.valueSetName + '_GL_ACCT_CODE-BUDGET_TYPE') { this.segment6 = res.segment6; this.segment7 = null}
            ...
            if (res.name == this.valueSetName + '_GL_ACCT_CODE-MAIN_ACCOUNT') { this.segment9 = res.segment9; this.segment10 = null}
