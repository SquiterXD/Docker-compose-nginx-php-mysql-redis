        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="float-right mb-3">
                    ...
                    <button type="button" class="btn btn-success" @click.prevent="onCreateButtonClicked">
                        <i class="fa fa-plus"></i> สร้าง
                    </button>
                    <button type="button" class="btn btn-primary" @click.prevent="onClickSave('ยังไม่ส่งข้อมูล')"
                            :disabled="disableInput">
                        <i class="fa fa-save (alias)"></i> บันทึก
                    </button>
                    <button type="button" class="btn btn-primary" @click.prevent="onClickSave('โอนเรียบร้อย')"
                            :disabled="header.additive_header_id == '' || disableInput">
                        <i class="fa fa-check-circle-o"></i> ยืนยันการโอน
                    </button>
                    <button type="button" class="btn btn-danger" @click.prevent="onClickSave('ยกเลิกการโอน')"
                            :disabled="header.additive_header_id == '' || disableInput">
                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" v-model="header.department_desc"
                                               disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <ct-datepicker
                                            ...
                                            :clearable="false"
                                            :disabled="disableInput"
                                            :enableDate="date => isInRange(date, sysdate, null, true)"
                                            :value="toJSDate(header.transfer_date, 'yyyy-MM-dd')"
                                            @change="(date) => {
                                            if(date){
                                                header.transfer_date = jsDateToString(date)
                                            }else{
                                                header.transfer_date = null
                                            }
                                        }"/>
                                        ...
                                        <input
                                            ...
                                            type="text"
                                            :value="(()=>{
                                                    return toThDateString(toJSDate(header.transfer_date,'yyyy-MM-dd'))
                                                })()"
                                            readonly
                                            disabled>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" v-model="header.subinventory_from"
                                               disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" v-model="header.subinventory_to"
                                               disabled>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-7">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" v-model="header.transfer_number"
                                               disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label"> สถานที่จัดเก็บของคลังต้นทาง:<span
                                    ...
                                    <div class="col-lg-8">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" v-model="header.locator_from"
                                                       disabled>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label"> สถานที่จัดเก็บของคลังจัดเก็บ:<span
                                        style="color: red">*</span></label>
                                    <div class="col-lg-8">
                                        <div class="row">
                                            <div class="col-lg-6">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" v-model="header.locator_to"
                                                       disabled>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="float-right mb-3">
                    <div class="text-right">
                        <button type="button" class="btn btn-success" @click.prevent="onClickAddLine()"
                                :disabled="disableInput">
                            <i class="fa fa-plus"></i> เพิ่มรายการ
                        </button>
                        <button type="button" class="btn btn-danger" @click.prevent="onClickDeleteLine()"
                                :disabled="disableInput">
                ...
                <div class="ibox">
                    <div class="ibox-content">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="transferFinishGoods">
                                <thead>
                                <tr>
                                    <th class="text-center">
                                        <input type="checkbox" @click="onClickCheckedAll()" v-model="isCheckedAll"
                                               :disabled="disableInput">
                                    </th>
                                ...
                                <tr v-for="(line, index) in lines" :key="index">
                                    <td class="text-center">
                                        <input type="checkbox" v-model="checkedItem" :value="index"
                                               @change="onChangeChecked" :disabled="disableInput">
                                    </td>
                                    <td>
                                        <el-select
                                    ...
                                    <td class="col-readonly">
                                        <input type="text" class="form-control" v-model="line.item_description"
                                               disabled>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <input type="number" class="form-control" v-model="line.qty" min="0"
                                               @change="onChangeQty(index)" :disabled="disableInput">
                                    </td>
                                    <td class="col-readonly">
                                    ...
                                    <td class="col-readonly">
                                        <input
                                            ...
                                            type="text"
                                            disabled
                                            :value="toThDateString(luxon.DateTime.fromSQL(line.origination_date).toJSDate())">
                                    </td>
                                    <td class="col-readonly">
                                        <input
                                            class="form-control"
                                            type="text"
                                            disabled
                                            :value="toThDateString(luxon.DateTime.fromSQL(line.expire_date).toJSDate())">
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="modal-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <ct-datepicker
                                                ...
                                                :clearable="true"
                                                placeholder="โปรดเลือกวันที่"
                                                :value="toJSDate(qDateForm, 'yyyy-MM-dd')"
                                                :enableDate="date => isInRange(date, toJSDate(qDateForm), null, true)"
                                                @change="(date) => {
                                                    if(date){
                                                        qDateForm = jsDateToString(date)
                                                    }else{
                                                        qDateForm = null
                                                    }
                                                }"/>
                            ...
                            <div style="height: 300px; overflow: scroll;">
                                <table class="table">
                                    ...
                                    <tr v-for="header in resultHeaders" :key="header.additive_header_id"
                                        style="cursor: pointer" @click="onClickHeader(header.additive_header_id)">
                                        <td>{{ header.transfer_number }}</td>
                                        <td>{{
                                                toThDateString(luxon.DateTime.fromISO(header.transfer_date).toJSDate())
                                            }}
                                        </td>
                                        <td>{{ header.status }}</td>
...
import {$route, pm_transferFinishGoods_index,} from "../../router";
        ...
        onClickCheckedAll() {
            ...
            if (!this.isCheckedAll) {
                this.lines.forEach((line, index) => {
                    this.checkedItem.push(parseInt(index))
                })
            }
        },
        onChangeChecked() {
...
function gotoCreateNew() {
    window.location = $route(pm_transferFinishGoods_index)
}
...
#pm0043 td .el-input__inner, #pm0043 td input {
    border: 0px solid;
}

#pm0043 .mx-datepicker .mx-input-wrapper .mx-icon-calendar {
    right: 10px
}
</style>
