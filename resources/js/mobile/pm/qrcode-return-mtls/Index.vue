                ...
                <div class="row">
                    <div class="form-group mb-0 col-12">
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-7">
                                    ...
                                    <mb-datepicker
                                        ...
                                        :value="toJSDate(input.return_date, 'yyyy-MM-dd')"
                                        @change="(date) => {
                                            input.return_date = jsDateToString(date);
                                            validateInput('return_date');
                                        }"
                                    />
                            ...
                            <div class="form-group  row" v-if="process[step]['can_next_step']">
                                ...
                                <div class="col-lg-9">
                                    <div class="input-group m-b">
                                        <input ref="tranfer_qty" placeholder="จำนวนที่คืน" v-model="input.tranfer_qty"
                                    ...
                                    <template v-for="item in items" v-if="Object.keys(items).length">
                                        <tr>
                                            <td>
                                                ...
                                                <div>
                                                    <span class="text-muted">รายละเอียด: </span> {{ item.item_desc }}
                                                </div>
                                            </td>
                        ...
                        <form v-on:submit.prevent="showUser" v-loading="loading" v-if="step == 6">
                            ...
                            <div class="form-group  row" v-if="process[step]['can_next_step']">
                                <div class="col-sm-12">
                                    <input ref="assignee" placeholder="สแกน QR Code ผู้คืน" v-model="input.assignee"
        ...
        validateInput(input) {
            ...
            switch(input) {
                case 'return_date':
                    ...
                    if (vm.input.return_date == null || vm.input.return_date == '') {
