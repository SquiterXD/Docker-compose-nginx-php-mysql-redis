...
@section('page-title')
    <h2><x-get-program-code url="/qm/settings/qc-area"/> : เขตการตรวจสอบคุณภาพ : ผลิตภัณฑ์สำเร็จรูป</h2>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">
            <strong><x-get-program-code url="/qm/settings/qc-area"/> : เขตการตรวจสอบคุณภาพ : ผลิตภัณฑ์สำเร็จรูป</a></strong>
        </li>
    </ol>
@stop
        ...
        <div class="col-lg-12">
            <div class="text-center">
                ...
                <div class="ibox-content">
                    {!! Form::open(['route' => ['qm.settings.qc-area.index'], 
                                    "method" => "get" , 
                                    "autocomplete" => "off", 
                                    'class' => 'form-horizontal',
                                    'id' => "formSearch"]) !!}
                        <qc-area-search     :search = "{{ json_encode($search) }}"
                        ...
                        <div class="row clearfix text-right">
                            <div class="col" style="margin-top: 15px; margin-right: 5px;">
                                ...
                                <a type="button" href="{{ route('qm.settings.qc-area.index') }}" class="btn btn-danger">
                                    ล้าง
                                </a>
                            </div>
                        </div>
        ...
        <div class="col-lg-12">
            <div class="text-center m-t-lg">
                <div class="ibox-title" style="text-align:left;">
                    <h5><x-get-program-code url="/qm/settings/qc-area"/> : เขตการตรวจสอบคุณภาพ : ผลิตภัณฑ์สำเร็จรูป</h5>
                </div>
                <div class="ibox-content">
                    @include('qm.settings.qc-area._table')
                </div>
            </div>
        </div>
    </div>
