...
{{-- @section('page-title')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">
            <a href="{{ route('qm.settings.define-tests-packet-air-leaks.index') }}">กำหนดหัวข้อการทดสอบ : การตรวจอัตราลมรั่ว ของซองบุหรี่</a>
        </li>
        <li class="breadcrumb-item active">
        ...
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    {!! Form::open(['route' => ['qm.settings.define-tests-packet-air-leaks.store'], 
                                    "method" => "post", 
                                    "autocomplete" => "off", 
