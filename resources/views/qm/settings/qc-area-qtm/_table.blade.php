{!! Form::open([   'route' => ['qm.settings.qc-area-qtm.update'], 
                    "method" => "put", 
                    "autocomplete" => "off", 
                ...
                <tr>
                    ...
                    <td>
                        <input  placeholder="กรอกเขตการตรวจคุณภาพ" 
                                ...
                                :name="'dataGroup[{{$key}}][qc_area_qtm]'"
                                value={{ $qcArea->qc_area_qtm }}>
                    </td>
                    <td class="text-center">
                        <input  type="checkbox" 
...
<div class="col-12">
    <div class="row clearfix text-center">
        <div class="col-sm-12">
            ...
            <a href="{{ route('qm.settings.qc-area-qtm.index') }}" type="button" class="btn btn-danger">
