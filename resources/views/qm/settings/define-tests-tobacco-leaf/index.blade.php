...
{{-- @section('page-title')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">
            <strong><a href="{{ route('qm.settings.define-tests-tobacco-leaf.index') }}">กำหนดหัวข้อการทดสอบ : กลุ่มผลิตด้านใบยา</a></strong>
        </li>
    </ol>
@stop --}}
...
@section('page-title-action')
    <a href="{{ route('qm.settings.define-tests-tobacco-leaf.create') }}" class="{{ $btnTrans['create']['class'] }}">
        <i class="{{ $btnTrans['create']['icon'] }}"></i> {{ $btnTrans['create']['text'] }}
    </a>
@stop

@section('content')
    {!! Form::open(['route' => ['qm.settings.define-tests-tobacco-leaf.index'] , "method" => "get" , "autocomplete" => "off", 'class' => 'form-horizontal'])!!}
