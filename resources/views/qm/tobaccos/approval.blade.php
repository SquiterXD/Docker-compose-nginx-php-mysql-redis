...
@section('page-title')
    ...
    <h2>
        <x-get-program-code url="/qm/tobaccos/approval" /> อนุมัติผลการตรวจสอบคุณภาพ : กลุ่มผลิตด้านใบยา
    </h2>
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            <a href="{{ route('qm.tobaccos.approval') }}"> กลุ่มผลิตด้านใบยา </a>
        </li>
        <li class="breadcrumb-item">
...
@section('content')
    ...
    <div class="ibox">
        ...
        <div class="ibox-title">
            <h5> อนุมัติผลการตรวจสอบคุณภาพ : กลุ่มผลิตด้านใบยา </h5>
        </div>
        ...
        <div class="ibox-content qm-content">
            ...
            <div class="qm-form justify-content-center clearfix">
                ...
                {!! Form::open(['route' => ['qm.tobaccos.approval'], 'method' => 'get', 'autocomplete' => 'off', 'class' => 'form-horizontal']) !!}

                @include('qm.tobaccos._approval_search_form')
                ...
                <div class="row form-group text-center justify-content-center clearfix tw-my-6">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <a type="button" href="{{ route('qm.tobaccos.approval') }}"
                ...
                <div class="justify-content-center clearfix">
                    <qm-table-tobaccos show-type="approval"
