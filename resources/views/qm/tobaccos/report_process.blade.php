...
@section('page-title')
    ...
    <h2>
        <x-get-program-code url="/qm/tobaccos/report-process" /> รายงานผลการตรวจสอบคุณภาพในกระบวนการผลิตยาเส้น
    </h2>
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            รายงานผลการตรวจสอบคุณภาพในกระบวนการผลิตยาเส้น
        </li>
    </ol>
...
@section('content')
    ...
    <div class="ibox">
        ...
        <div class="ibox-title">
            <h5> รายงานผลการตรวจสอบคุณภาพในกระบวนการผลิตยาเส้น </h5>
        </div>
        ...
        <div class="ibox-content qm-content">
            ...
            <div class="qm-form justify-content-center clearfix">
                ...
                {!! Form::open(['route' => ['qm.tobaccos.report-process'], 'method' => 'get', 'autocomplete' => 'off', 'class' => 'form-horizontal']) !!}

                @include('qm.tobaccos._report_process_search_form')
                ...
                <div class="row form-group text-center justify-content-center clearfix tw-my-6">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <a type="button" href="{{ route('qm.tobaccos.report-process') }}"
                ...
                @if ($searched)
                    ...
                    <div class="text-right tw-mb-4">
                        ...
                        <div class="tw-inline-block">
                            {!! Form::open(['route' => ['qm.tobaccos.export-excel.report-process'], 'method' => 'post']) !!}
                        ...
                        <div class="tw-inline-block">
                            {!! Form::open(['route' => ['qm.tobaccos.export-pdf.report-process'], 'method' => 'post']) !!}
                                <input type="hidden" name="report_items" value="{{ json_encode($reportItems) }}" />
                                <input type="hidden" name="sample_date_from" value="{{ old('sample_date_from') ? old('sample_date_from') : (isset($searchInputs['sample_date_from']) ? $searchInputs['sample_date_from'] : '') }}" />
                                <input type="hidden" name="sample_date_to" value="{{ old('sample_date_to') ? old('sample_date_to') : (isset($searchInputs['sample_date_to']) ? $searchInputs['sample_date_to'] : '') }}" />
                    ...
                    <qm-table-tobacco-report-process
