...
@section('page-title')
    ...
    <h2>
        <x-get-program-code url="/qm/tobaccos/result" /> ลงผลการตรวจสอบคุณภาพ : กลุ่มผลิตด้านใบยา
    </h2>
...
@section('content')
    ...
    <div class="ibox">
        ...
        <div class="ibox-title">
            <h5> ลงผลการตรวจสอบคุณภาพ : กลุ่มผลิตด้านใบยา </h5>
        </div>
        ...
        <div class="ibox-content qm-content">
            ...
            <div class="qm-form justify-content-center clearfix">
                ...
                {!! Form::open(['route' => ['qm.tobaccos.result'], 'method' => 'get', 'autocomplete' => 'off', 'class' => 'form-horizontal']) !!}
                ...
                <div class="row form-group text-center justify-content-center clearfix tw-my-6">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <a type="button" href="{{ route('qm.tobaccos.result') }}"
                ...
                <div class="justify-content-center clearfix">
                    <qm-table-tobaccos show-type="result"
