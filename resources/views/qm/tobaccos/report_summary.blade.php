...
@section('page-title')
    ...
    <h2>
        <x-get-program-code url="/qm/tobaccos/report-summary" /> รายงานสรุปผลการตรวจสอบ : กลุ่มผลิตด้านใบยา
    </h2>
...
@section('content')
    ...
    <div class="ibox">
        ...
        <div class="ibox-title">
            <h5> รายงานสรุปผลการตรวจสอบ : กลุ่มผลิตด้านใบยา </h5>
        </div>
        ...
        <div class="ibox-content qm-content">
            ...
            <div class="qm-form justify-content-center clearfix">
                ...
                {!! Form::open(['route' => ['qm.tobaccos.report-summary'], 'method' => 'get', 'autocomplete' => 'off', 'class' => 'form-horizontal']) !!}

                @include('qm.tobaccos._report_summary_search_form')
                ...
                <div class="row form-group text-center justify-content-center clearfix tw-my-6">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <a type="button" href="{{ route('qm.tobaccos.report-summary') }}"
                ...
                @if ($searched)
                    ...
                    <div class="text-right tw-mb-4">
                        {!! Form::open(['route' => ['qm.tobaccos.export-excel.report-summary'], 'method' => 'post']) !!}
                            <input type="hidden" name="report_qm_groups" value="{{ json_encode($reportQmGroups) }}" />
                            <input type="hidden" name="report_qm_group_locators" value="{{ json_encode($reportQmGroupLocators) }}" />
                    ...
                    <qm-table-tobacco-report-summary :report-qm-groups="{{ json_encode($reportQmGroups) }}"
                        :report-qm-group-locators="{{ json_encode($reportQmGroupLocators) }}"
                        :report-items="{{ json_encode($reportItems) }}">
                    </qm-table-tobacco-report-summary>
