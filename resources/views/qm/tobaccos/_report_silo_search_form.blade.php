<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="row">
            ...
            <qm-input-search-locator-by-qm-group :qm-groups="{{ json_encode($qmGroups) }}"
                qm-group-from-value="{{ old('qm_group_from') ? old('qm_group_from') : (isset($searchInputs['qm_group_from']) ? $searchInputs['qm_group_from'] : '') }}"
                qm-group-to-value="{{ old('qm_group_to') ? old('qm_group_to') : (isset($searchInputs['qm_group_to']) ? $searchInputs['qm_group_to'] : '') }}"
                :locators="{{ json_encode($locators) }}" 
                locator-value="{{ old('locator_id') ? old('locator_id') : (isset($searchInputs['locator_id']) ? $searchInputs['locator_id'] : '') }}">
    ...
    <div class="col-md-6">
        ...
        <div class="row form-group">
            ...
            <label class="col-md-4 col-form-label"> ตรา / ชุด </label>
        
            <div class="col-md-8">
        
                <qm-el-select name="sample_opt" id="input_sample_opt" option-key="sample_opt" option-value="sample_opt" option-label="sample_opt"
                    :select-options="{{ json_encode($opts) }}" :clearable="true" :filterable="true"
                    value="{{ old('sample_opt') ? old('sample_opt') : (isset($searchInputs['sample_opt']) ? $searchInputs['sample_opt'] : '') }}"  />
...
<qm-severity-level-checkboxes v-show="false"
...
<qm-test-severity-code-checkboxes v-show="false"
