...
@section('page-title')
    ...
    <h2>
        <x-get-program-code url="/qm/packet-air-leaks/defect" /> บันทึกสาเหตุความผิดปกติทางคุณภาพอัตราลมรั่วของซองบุหรี่
    </h2>
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            <a href="{{ route('qm.packet-air-leaks.defect') }}"> การตรวจอัตราลมรั่วของซองบุหรี่ </a>
        </li>
        <li class="breadcrumb-item">
            บันทึกสาเหตุความผิดปกติทางคุณภาพ
        </li>
    </ol>
...
@section('content')
    ...
    <div class="ibox">
        ...
        <div class="ibox-title">
            <h5> บันทึกสาเหตุความผิดปกติทางคุณภาพอัตราลมรั่วของซองบุหรี่ </h5>
        </div>
        ...
        <div class="ibox-content qm-content">
            ...
            <div class="qm-form justify-content-center clearfix">
                ...
                {!! Form::open(['route' => ['qm.packet-air-leaks.defect'], 'method' => 'get', 'autocomplete' => 'off', 'class' => 'form-horizontal']) !!}

                @include('qm.packet-air-leaks._defect_search_form')
                ...
                <div class="row form-group text-center justify-content-center clearfix tw-my-6">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <a type="button" href="{{ route('qm.packet-air-leaks.defect') }}"
