...
@section('page-title')
    ...
    <h2>
        <x-get-program-code url="/qm/moth-outbreaks/track" /> การติดตามผลการตรวจสอบการระบาดของมอดยาสูบ
    </h2>
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            <a href="{{ route('qm.moth-outbreaks.track') }}"> การตรวจสอบการระบาดของมอดยาสูบ </a>
        </li>
        <li class="breadcrumb-item">
            การติดตามผลการตรวจสอบการระบาดของมอดยาสูบ
        </li>
    </ol>
...
@section('content')
    ...
    <div class="ibox">
        ...
        <div class="ibox-title">
            <h5> การติดตามผลการตรวจสอบการระบาดของมอดยาสูบ </h5>
        </div>
        ...
        <div class="ibox-content qm-content">
            ...
            <div class="qm-form justify-content-center clearfix">
                ...
                {!! Form::open(['route' => ['qm.moth-outbreaks.track'], 'method' => 'get', 'autocomplete' => 'off', 'class' => 'form-horizontal']) !!}

                @include('qm.moth-outbreaks._track_search_form')
                ...
                <div class="row form-group text-center justify-content-center clearfix tw-my-6">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <a type="button" href="{{ route('qm.moth-outbreaks.track') }}"
