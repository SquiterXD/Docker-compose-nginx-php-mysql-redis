...
@section('page-title')
    ...
    <h2>
        <x-get-program-code url="/qm/moth-outbreaks/report-summary" /> รายงานผลการตรวจสอบการระบาดของมอดยาสูบ - รายการผลการตรวจสอบ
    </h2>
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            รายงานผลการตรวจสอบการระบาดของมอดยาสูบ - รายการผลการตรวจสอบ
        </li>
    </ol>
...
@section('content')
    ...
    <div class="ibox">
        ...
        <div class="ibox-title">
            <h5> รายงานผลการตรวจสอบการระบาดของมอดยาสูบ - รายการผลการตรวจสอบ </h5>
        </div>
        ...
        <div class="ibox-content qm-content">
            ...
            <div class="qm-form justify-content-center clearfix">
                ...
                {!! Form::open(['route' => ['qm.moth-outbreaks.report-summary'], 'method' => 'get', 'autocomplete' => 'off', 'class' => 'form-horizontal']) !!}

                @include('qm.moth-outbreaks._report_summary_search_form')
                ...
                <div class="row form-group text-center justify-content-center clearfix tw-my-6">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <a type="button" href="{{ route('qm.moth-outbreaks.report-summary') }}"
                ...
                @if ($searched)
                    ...
                    <div class="text-right tw-mb-4">
                        @if(count($reportItems) > 0)
                            {!! Form::open(['route' => ['qm.moth-outbreaks.export-excel.report-summary'], 'method' => 'post']) !!}
                    ...
                    <qm-table-moth-outbreak-report-summary :report-items="{{ json_encode($reportItems) }}"></qm-table-moth-outbreak-report-summary>
