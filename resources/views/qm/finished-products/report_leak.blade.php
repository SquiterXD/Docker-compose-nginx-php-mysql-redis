...
@section('page-title')
    ...
    <h2>
        <x-get-program-code url="/qm/finished-products/report-leak" /> ความสัมพันธ์กับอัตรารั่วฟิล์มห่อซองบุหรี่ : กลุ่มผลิตภัณฑ์สำเร็จรูป
    </h2>
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            ความสัมพันธ์กับอัตรารั่วฟิล์มห่อซองบุหรี่
        </li>
    </ol>
...
@section('content')
    ...
    <div class="ibox">
        ...
        <div class="ibox-title">
            <h5> ความสัมพันธ์กับอัตรารั่วฟิล์มห่อซองบุหรี่ : กลุ่มผลิตภัณฑ์สำเร็จรูป </h5>
        </div>
        ...
        <div class="ibox-content qm-content">
            ...
            <div class="qm-form justify-content-center clearfix">
                ...
                {!! Form::open(['route' => ['qm.finished-products.report-leak'], 'method' => 'get', 'autocomplete' => 'off', 'class' => 'form-horizontal']) !!}

                @include('qm.finished-products._report_leak_search_form')
                ...
                <div class="row form-group text-center justify-content-center clearfix tw-my-6">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <a type="button" href="{{ route('qm.finished-products.report-leak') }}"
                ...
                @if ($searched)
                    ...
                    <div class="text-right tw-mb-4">
                        {!! Form::open(['route' => ['qm.finished-products.export-excel.report-leak'], 'method' => 'post']) !!}
                    ...
                    <qm-table-finished-product-report-leak :report-items="{{ json_encode($reportItems) }}"></qm-table-finished-product-report-leak>
