...
@section('page-title')
    ...
    <h2>
        <x-get-program-code url="/qm/finished-products/track" /> การติดตามผลการตรวจสอบ : กลุ่มผลิตภัณฑ์สำเร็จรูป
    </h2>
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            <a href="{{ route('qm.finished-products.track') }}"> กลุ่มผลิตภัณฑ์สำเร็จรูป </a>
        </li>
        <li class="breadcrumb-item">
...
@section('content')
    ...
    <div class="ibox">
        ...
        <div class="ibox-title">
            <h5> การติดตามผลการตรวจสอบ : กลุ่มผลิตภัณฑ์สำเร็จรูป </h5>
        </div>
        ...
        <div class="ibox-content qm-content">
            ...
            <div class="qm-form justify-content-center clearfix">
                ...
                {!! Form::open(['route' => ['qm.finished-products.track'], 'method' => 'get', 'autocomplete' => 'off', 'class' => 'form-horizontal']) !!}

                @include('qm.finished-products._track_search_form')
                ...
                <div class="row form-group text-center justify-content-center clearfix tw-my-6">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <a type="button" href="{{ route('qm.finished-products.track') }}"
