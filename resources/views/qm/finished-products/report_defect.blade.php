...
@section('page-title')
    ...
    <h2>
        <x-get-program-code url="/qm/finished-products/report-defect" /> รายงานตรวจสอบผลิตภัณฑ์มวนและบรรจุที่ไม่เป็นไปตามข้อกำหนด
    </h2>
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            รายงานตรวจสอบผลิตภัณฑ์มวนและบรรจุที่ไม่เป็นไปตามข้อกำหนด
        </li>
    </ol>
...
@section('content')
    ...
    <div class="ibox">
        ...
        <div class="ibox-title">
            <h5> รายงานตรวจสอบผลิตภัณฑ์มวนและบรรจุที่ไม่เป็นไปตามข้อกำหนด </h5>
        </div>
        ...
        <div class="ibox-content qm-content">
            ...
            <div class="qm-form justify-content-center clearfix">
                ...
                {!! Form::open(['route' => ['qm.finished-products.report-defect'], 'method' => 'get', 'autocomplete' => 'off', 'class' => 'form-horizontal']) !!}

                @include('qm.finished-products._report_defect_search_form')
                ...
                <div class="row form-group text-center justify-content-center clearfix tw-my-6">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <a type="button" href="{{ route('qm.finished-products.report-defect') }}"
                ...
                @if ($searched)
                    ...
                    <div class="text-right tw-mb-4">
                        {!! Form::open(['route' => ['qm.finished-products.export-excel.report-defect'], 'method' => 'post']) !!}
                            <input type="hidden" name="qm_processes" value="{{ json_encode($qmProcesses) }}" />
                    ...
                    <qm-table-finished-product-report-defect 
                        :qm-processes="{{ json_encode($qmProcesses) }}"
