<div class="row form-group">
    ...
    <qm-search-form-qtm-machines-report-under-average
        ...
        quality-status-value="{{ old('quality_status') ? old('quality_status') : (isset($searchInputs['quality_status']) ? $searchInputs['quality_status'] : 'FAILED') }}"
