...
@section('page-title')
    ...
    <h2>
        <x-get-program-code url="/qm/qtm-machines/report-quantum-neo" /> รายงานตรวจคุณภาพทางฟิสิกส์ของมวนบุหรี่/ก้นกรองโดยเครื่องมือวัด
    </h2>
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            รายงานตรวจคุณภาพทางฟิสิกส์ของมวนบุหรี่/ก้นกรองโดยเครื่องมือวัด
        </li>
    </ol>
...
@section('content')
    ...
    <div class="ibox">
        ...
        <div class="ibox-title">
            <h5> รายงานตรวจคุณภาพทางฟิสิกส์ของมวนบุหรี่/ก้นกรองโดยเครื่องมือวัด </h5>
        </div>
        ...
        <div class="ibox-content qm-content">
            ...
            <div class="qm-form justify-content-center clearfix">
                ...
                {!! Form::open(['route' => ['qm.qtm-machines.report-quantum-neo'], 'method' => 'get', 'autocomplete' => 'off', 'class' => 'form-horizontal']) !!}

                @include('qm.qtm-machines._report_quantum_neo_search_form')
                ...
                <div class="row form-group text-center justify-content-center clearfix tw-my-6">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <a type="button" href="{{ route('qm.qtm-machines.report-quantum-neo') }}"
                ...
                @if ($searched)
                    ...
                    <div class="text-right tw-mb-4">
                        {!! Form::open(['route' => ['qm.qtm-machines.export-pdf.report-quantum-neo'], 'method' => 'post', 'target' => '_blank']) !!}
                    ...
                    <qm-table-qtm-machine-report-quantum-neo 
