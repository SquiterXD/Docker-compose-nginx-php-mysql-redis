<div class="row form-group">
    ...
    <qm-search-form-qtm-machines-result
        ...
        task-type-value="{{ old('task_type_code') ? old('task_type_code') : (isset($searchInputs['task_type_code']) ? $searchInputs['task_type_code'] : '') }}"
        ...
        :show-sample-result-type-options="{{ json_encode($showSampleResultTypeOptions) }}"
