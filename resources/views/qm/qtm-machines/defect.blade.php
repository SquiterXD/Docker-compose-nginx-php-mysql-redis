...
@section('page-title')
    ...
    <h2>
        <x-get-program-code url="/qm/qtm-machines/defect" /> บันทึกสาเหตุความผิดปกติทางคุณภาพ QTM
    </h2>
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            <a href="{{ route('qm.qtm-machines.defect') }}"> บันทึกสาเหตุความผิดปกติทางคุณภาพ QTM </a>
        </li>
        <li class="breadcrumb-item">
            บันทึกสาเหตุความผิดปกติทางคุณภาพ QTM
        </li>
    </ol>
...
@section('content')
    ...
    <div class="ibox">
        ...
        <div class="ibox-title">
            <h5> บันทึกสาเหตุความผิดปกติทางคุณภาพ QTM </h5>
        </div>
        ...
        <div class="ibox-content qm-content">
            ...
            <div class="qm-form justify-content-center clearfix">
                ...
                {!! Form::open(['route' => ['qm.qtm-machines.defect'], 'method' => 'get', 'autocomplete' => 'off', 'class' => 'form-horizontal']) !!}

                @include('qm.qtm-machines._defect_search_form')
                ...
                <div class="row form-group text-center justify-content-center clearfix tw-my-6">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <a type="button" href="{{ route('qm.qtm-machines.defect') }}"
                ...
                <div class="justify-content-center clearfix">
                    <qm-table-qtm-machines show-type="defect" 
