...
@section('page-title')
    ...
    <h2>
        <x-get-program-code url="/qm/qtm-machines/track" /> การติดตามผลการตรวจสอบด้วยเครื่อง QTM
    </h2>
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            <a href="{{ route('qm.qtm-machines.track') }}"> การตรวจสอบด้วยเครื่อง QTM </a>
        </li>
        <li class="breadcrumb-item">
...
@section('content')
    ...
    <div class="ibox">
        ...
        <div class="ibox-title">
            <h5> การติดตามผลการตรวจสอบด้วยเครื่อง QTM </h5>
        </div>
        ...
        <div class="ibox-content qm-content">
            ...
            <div class="qm-form justify-content-center clearfix">
                ...
                {!! Form::open(['route' => ['qm.qtm-machines.track'], 'method' => 'get', 'autocomplete' => 'off', 'class' => 'form-horizontal']) !!}

                @include('qm.qtm-machines._track_search_form')
                ...
                <div class="row form-group text-center justify-content-center clearfix tw-my-6">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <a type="button" href="{{ route('qm.qtm-machines.track') }}"
                ...
                <div class="justify-content-center clearfix">
                    <qm-table-qtm-machines show-type="track" 
