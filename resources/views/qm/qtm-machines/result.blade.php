...
@section('page-title')
    ...
    <h2>
        <x-get-program-code url="/qm/qtm-machines/result" /> ลงผลการตรวจสอบด้วยเครื่อง QTM
    </h2>
...
@section('content')
    ...
    <div class="ibox">
        ...
        <div class="ibox-title">
            <h5> ลงผลการตรวจสอบด้วยเครื่อง QTM </h5>
        </div>
        ...
        <div class="ibox-content qm-content">
            ...
            <div class="qm-form justify-content-center clearfix">
                ...
                {!! Form::open(['route' => ['qm.qtm-machines.result'], 'method' => 'get', 'autocomplete' => 'off', 'class' => 'form-horizontal']) !!}

                @include('qm.qtm-machines._result_search_form')
                ...
                <div class="row form-group text-center justify-content-center clearfix tw-my-6">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <a type="button" href="{{ route('qm.qtm-machines.result') }}"
                ...
                <div class="text-right mb-3">
                    <a href="{{ route('qm.qtm-machines.error-export-excel', request()->all()) }}" target="_blank" class="btn btn-sm btn-primary">
                        <i class="fa fa fa-file-excel-o tw-mr-1"></i> QTM Auto Error Export
                    </a>
                </div>
                <div class="justify-content-center clearfix">
                    <qm-table-qtm-machines show-type="result" 
