@if (count($saleForecasts) > 0)
    <div class="row col-12" style="font-size: 15px;">
        ...
        <div class="form-group pl-2 pr-2 mb-0 col-lg-2 col-md-4 col-sm-6 col-xs-6 mt-2 text-left">
        ...
        <div class="form-group pl-2 pr-2 mb-0 col-lg-3 col-md-4 col-sm-6 col-xs-6 mt-2 text-left">
            ...
            <span>
                {{ optional($totalDayForOmSale)->sum('day_for_sale') ?? 0}} วัน
            </span>
        </div>
        ...
        <div class="form-group pl-2 pr-2 mb-0 col-lg-3 col-md-4 col-sm-6 col-xs-6 mt-2 text-left">
            ...
            <span>
                {{ optional($saleForecasts->first())->approve_date_format ?? '' }}
            </span>
        </div>
    </div>
