            ...
            @else
                @foreach ($productBiweeklies as $productBiweekly)
                   <tr>
                        ...
                        <td class="text-center" >
                            @if ($productBiweekly->main_type == 'ADJUSTMENT')
                        ...
                        <td class="text-center">
                            {{-- <a  href="{{ route('planning.follow-ups.check-created', [$productBiweekly->product_main_id]) }}"
