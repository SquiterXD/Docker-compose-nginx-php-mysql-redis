...
@section('page-title')
    ...
    <h2>
        <x-get-program-code url="/ct/ctr0019" /> รายงานกระดาษทำการปันส่วนของหน่วยงาน (สรุป)
    </h2>
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            รายงานกระดาษทำการปันส่วนของหน่วยงาน (สรุป)
        </li>
    </ol>
...
@section('content')
    ...
    <div class="ibox">
        ...
        <div class="ibox-title">
            <h5> รายงานกระดาษทำการปันส่วนของหน่วยงาน (สรุป) </h5>
        </div>
        ...
        <div class="ibox-content">
            ...
            <div class="justify-content-center clearfix">
                ...
                <div class="clearfix tw-my-6">
                    ...
                    {!! Form::open(['route' => ['ct.ctr0019.export'], 'method' => 'post']) !!}

                        {{-- FORM INPUT --}}

                        <ct-reports-ctr0019-form 
