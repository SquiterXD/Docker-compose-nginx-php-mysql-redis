<table>
    <thead>
        ...
        <tr>
            ...
            <th colspan="7" width="20" style="height: 30px; background-color: #ffffff; border: 1px solid #ffffff; font-weight: bold; font-size: 14px; text-align: center;">  
                <p> กระดาษทำการปันส่วนค่าใช้จ่ายของ {{ $allocateGroupCode["allocate_group_code_label"] }} ({{ $allocateGroupCode["allocate_group_code"] }}) และค่าใช้จ่ายที่รับโอนมาให้แต่ละศูนย์ต้นทุน </p>
            </th>
            <th colspan="3" width="20" style="height: 30px; background-color: #ffffff; border: 1px solid #ffffff; font-weight: bold; font-size: 14px; text-align: right;"> 
