...
<html>
    ...
    <table border="0" width="100%" style="border: 1px solid #000000; font-size: 12px;">
        ...
        @endphp
        @foreach ($datas->where('level_no', 1)->groupBy('item_number') as $lev1)
            @php
            ...
            @php
                $dataLevel2 = $datas->where('level_no', 2)->where('product_item_id', $lev1First->product_item_id);
                // Add defualt 0 Lev2 20221207
                $totalAqQty2 = 0;
                $totalAqSp2 = 0;
            ...
            @endif
            @foreach ($dataLevel2->groupBy('organization_code') as $orgCode => $lev2)
                @php
