    ...
    <table border="0" width="100%" style="border: 1px solid #000000; font-size: 12px;">
        <thead>
            ...
            @foreach($dataListH as $product_item_numbers )
                ...
                <td style="text-align: left;font-weight: bold; border-right: 1px solid #000000;">รวมตามคำสั่งผลิต {{$product_item_numbers->batch_no}}</td>
                ...
                <td style="text-align: right; border: 1px solid #000000;">{{$product_item_numbers->wage_cost+$product_item_numbers->vary_cost+$product_item_numbers->fixed_cost+($product_item_numbers->transaction_cost+$product_item_numbers->sumCost_wip_end+$product_item_numbers->cost_wip_begin)}}</td>
