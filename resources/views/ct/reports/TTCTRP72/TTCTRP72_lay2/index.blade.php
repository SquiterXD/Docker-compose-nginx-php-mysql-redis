        ...
        <table>
            <thead>
                <tr >
                    ...
                    <th style="border: 1px solid #000000; text-align: center; width: 100px;" rowspan=2 > <b>เกรด </b></th>
                        ...
                        @foreach ($QueryLevelMachine->where('organization_code', $org['organization_code'])
                            ...
                            <tr>
                                ...
                                @foreach ($QueryLevelItemHead->where('organization_code', $org['organization_code'])
                                                                ...
                                                                as $H)
                                <tr>
                                    <td style="border-left: 1px solid #000000; text-align: left;"><b>{{$H->product_code}}</b></td>
                                    <td style="border-left: 1px solid #000000; text-align: center;"><b>{{$H->product_name}}</b></td>
                                    <td style="border: 1px solid #000000; text-align: right;"><b>{{$H->sum_qty_item}}</b></td>
                                    <td style="border: 1px solid #000000; text-align: right;"><b>{{$H->sum_qty_use_item}}</b></td>
                                    <td style="border: 1px solid #000000; text-align: right;"><b>{{$H->sum_cost_rawmate_item}}</b></td>
                                    <td style="border: 1px solid #000000; text-align: right;"><b>{{$H->sum_wagecost_item}}</b></td>
                                    <td style="border: 1px solid #000000; text-align: right;"><b>{{$H->sum_varycost_item}}</b></td>
                                    <td style="border: 1px solid #000000; text-align: right;"><b>{{$H->sum_fixedcost_item}}</b></td>
                                    <td style="border: 1px solid #000000; text-align: right;"><b>{{$H->sum_totalcost_item}}</b></td>
                                    <td style="border: 1px solid #000000; text-align: right;"><b>{{$H->sum_costunit_item}}</b></td>
                                </tr>
                                    @foreach ($QueryLevelItemLine->where('organization_code', $org['organization_code'])
                                                                ->where('machine_line', $Machine['machine_line'])
                                                                ->where('product_type', $ProductType['product_type'])
                                                                ->where('product_type', $ProductType['product_type'])
                                                                ->where('product_code', $H['product_code'])
                                                                ->where('product_name', $H['product_name'])
                                                                as $L)

                                     <tr>
                                        <td style="border-left: 1px solid #000000; text-align: right;">{{$L->transaction_dateth}}</td>
                                        <td style="border-left: 1px solid #000000; text-align: right;"></td>
                                        <td style="border-left: 1px solid #000000; text-align: right;">{{$L->sum_qty_line}}</td>
                                        <td style="border-left: 1px solid #000000; text-align: right;">{{$L->sum_qty_use_line}}</td>
                                        <td style="border-left: 1px solid #000000; text-align: right;">{{$L->sum_cost_rawmate_line}}</td>
                                        <td style="border-left: 1px solid #000000; text-align: right;">{{$L->sum_wagecost_line}}</td>
                                        <td style="border-left: 1px solid #000000; text-align: right;">{{$L->sum_varycost_line}}</td>
                                        <td style="border-left: 1px solid #000000; text-align: right;">{{$L->sum_fixedcost_line}}</td>
                                        <td style="border-left: 1px solid #000000;border-right: 1px solid #000000; text-align: right;">{{$L->sum_totalcost_line}}</td>
