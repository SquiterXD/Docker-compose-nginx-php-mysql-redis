...
<table width="100%" border="1">
    <thead>
        ...
        <tr>
            ...
            <th align="center" rowspan="2" style="{{ $styleBorderTBFont16 . $fontBold }}">รายละเอียด</th>
    ...
    <tbody>
        @foreach ($data->lines as $line)
            ...
            <tr >
                ...
                <td style="{{ $font16 . $fontBold . $bTbB  }}" >{{ $line->sum_tran_qty }}</td>
                <td style="{{ $font16 . $fontBold . $bTbB  }}" >{{ $line->sum_qty }}</td>
                <td style="{{ $font16 . $fontBold . $bTbB  }}" >{{ $line->sum_cost }}</td>
                <td style="{{ $font16 . $fontBold . $bTbB  }}" >{{ $line->wage_cost }}</td>
                <td style="{{ $font16 . $fontBold . $bTbB  }}" >{{ $line->vary_cost }}</td>
                <td style="{{ $font16 . $fontBold . $bTbB  }}" >{{ $line->fixed_cost }}</td>
                <td style="{{ $font16 . $fontBold . $bTbB  }}" >{{ $line->sum_all }}</td>
                <td style="{{ $font16 . $fontBold . $bTbB  }}" >{{ $line->avg_per_unit }}</td>
            </tr>
        @endforeach
