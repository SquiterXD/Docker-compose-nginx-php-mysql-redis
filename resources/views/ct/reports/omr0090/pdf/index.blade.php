            ...
            <table style="width:100%">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="border-tom-bottom">ค่าบุหรี่</td>
                        <td class="border-tom-bottom">เงินสด/โอนบัญชี</td>
                        <td class="border-tom-bottom">คงเหลือ</td>
                    ...
                    @endphp
                    @php 
                    $items = $items->sortBy(function($i) { return $i['date'].$i['prepare_order_number']; })
                    ...
                    @foreach ( $items as $i)
                        <tr>
                            ...
                            @endphp
                            <td>{{ @number_format($i->sum(function($i) { return (int)$i['debt_amount']; }), 2) }}</td>
                            <td>{{ @number_format($i->sum(function($i) { return (int)$i['payment_amount']; }), 2) }}</td>
                            @php 
                    ...
                    <tr>
                        ...
                        <td  class="border-tom-bottom"></td>
                        <td  class="border-tom-bottom"></td>
                        <td  class="border-tom-bottom">{{ @number_format($totalDebtAmount, 2)}}</td>
                        <td  class="border-tom-bottom">{{ @number_format($totalPaymentAmount, 2)}}</td>
                        <td  class="border-tom-bottom"></td>
                        <td  class="border-tom-bottom"></td>
                    </tr>
                </tbody>
