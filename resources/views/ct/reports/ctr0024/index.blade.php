...
@section('page-title')
    ...
    <h2>
        <x-get-program-code url="/ct/ctr0024" /> รายงานบัตรต้นทุนมาตรฐาน
    </h2>
        ...
        <div class="ibox-content">
            ...
            <div class="justify-content-center clearfix">
                ...
                <div class="clearfix tw-my-6">
                    ...
                    {!! Form::open(['route' => ['ct.ctr0024.export'], 'method' => 'post']) !!}

                        {{-- FORM INPUT --}}

                        <ct-reports-ctr0024-form 
