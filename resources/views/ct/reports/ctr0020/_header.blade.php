    ...
    <thead>
        ...
        <tr>
            ...
            <th colspan="8" width="20" style="height: 30px; background-color: #ffffff; border: 1px solid #ffffff; font-weight: bold; font-size: 14px; text-align: center;">  
                <p> กระดาษทำการปันส่วนค่าใช้จ่ายของ {{ $allocateGroupCode["allocate_group_code_label"] }} ({{ $allocateGroupCode["allocate_group_code"] }}) และค่าใช้จ่ายที่รับโอนมาปันให้แต่ละหน่วยงาน </p>
            </th>
