        ...
        @endphp
            ...
            <table class ="table_data" >
                <thead>
                    <tr >
                        <!-- wip02 -->
                        <th style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; text-align: center; " rowspan=3 >เลขที่คำสั่งผลิต </th>
                        <th style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; text-align: center; width: 5px; " rowspan=3 > รหัสหมวด </th>
                ...
                <tr>
                    ...
                    <td style=" text-align: right; ">{{isset($productQty02Layout[$dataH[$cnt_batch]['batch_no']][$dataH[$cnt_batch]['product_code']]) ? 
                        number_format($productQty02Layout[$dataH[$cnt_batch]['batch_no']][$dataH[$cnt_batch]['product_code']],2): '0.00'}} </td>
                    <td style=" text-align: right; ">{{isset($LayoutQty02[$dataH[$cnt_batch]['batch_no']][$dataH[$cnt_batch]['product_code']]) ? 
                        number_format($LayoutQty02[$dataH[$cnt_batch]['batch_no']][$dataH[$cnt_batch]['product_code']],2) : ( isset($LayoutQty03[$dataH[$cnt_batch]['batch_no']][$dataH[$cnt_batch]['product_code']]) ? 
                                                                                                                              number_format($LayoutQty03[$dataH[$cnt_batch]['batch_no']][$dataH[$cnt_batch]['product_code']],2) : (isset($LayoutQty04[$dataH[$cnt_batch]['batch_no']][$dataH[$cnt_batch]['product_code']]) ? 
                                                                                                                                                                                                                                    number_format($LayoutQty04[$dataH[$cnt_batch]['batch_no']][$dataH[$cnt_batch]['product_code']],2) : '0.00' 
                                                                                                                                                                                                                                   ) 
                    ...
                    <td style=" text-align: right; ">{{isset($productQty03[$dataH[$cnt_batch]['batch_no']][$dataH[$cnt_batch]['product_code']]) ? 
                        number_format($productQty03[$dataH[$cnt_batch]['batch_no']][$dataH[$cnt_batch]['product_code']],2): '0.00'}} </td>
                    <td style=" text-align: right; ">{{isset($rec03Receive[$dataH[$cnt_batch]['batch_no']][$dataH[$cnt_batch]['product_code']]) ? 
                        number_format($rec03Receive[$dataH[$cnt_batch]['batch_no']][$dataH[$cnt_batch]['product_code']],2): '0.00'}} </td>
                    ...
                    <td style=" text-align: right; "> {{number_format( $sum03 ,2) }}</td>

                    <td style=" text-align: right; "> {{isset($lossQty03[$dataH[$cnt_batch]['batch_no']][$dataH[$cnt_batch]['product_code']]) ? 
                        number_format($lossQty03[$dataH[$cnt_batch]['batch_no']][$dataH[$cnt_batch]['product_code']],2): '0.00'}}</td>
                    
                    <td style=" text-align: right; "> {{isset($tran03Tranfer[$dataH[$cnt_batch]['batch_no']][$dataH[$cnt_batch]['product_code']]) ? 
                        number_format($tran03Tranfer[$dataH[$cnt_batch]['batch_no']][$dataH[$cnt_batch]['product_code']],2): '0.00'}} </td>
                    ...
                    <td style=" text-align: right; ">{{isset($productQty04[$dataH[$cnt_batch]['batch_no']][$dataH[$cnt_batch]['product_code']]) ? 
                        number_format($productQty04[$dataH[$cnt_batch]['batch_no']][$dataH[$cnt_batch]['product_code']],2): '0.00'}} </td>
                    <td style=" text-align: right; ">{{isset($rec04Receive[$dataH[$cnt_batch]['batch_no']][$dataH[$cnt_batch]['product_code']]) ? 
                        number_format($rec04Receive[$dataH[$cnt_batch]['batch_no']][$dataH[$cnt_batch]['product_code']],2): '0.00'}} </td>
                        ...
                        <td style=" text-align: right; "> {{number_format( $sum04 ,2) }}</td>
                        <td style=" text-align: right; ">{{isset($TranferQty04[$dataH[$cnt_batch]['batch_no']][$dataH[$cnt_batch]['product_code']]) ? 
                        number_format($TranferQty04[$dataH[$cnt_batch]['batch_no']][$dataH[$cnt_batch]['product_code']],2): '0.00'}} </td>
                        <td style=" text-align: right; ">{{isset($tran04Tranfer[$dataH[$cnt_batch]['batch_no']][$dataH[$cnt_batch]['product_code']]) ? 
                        number_format($tran04Tranfer[$dataH[$cnt_batch]['batch_no']][$dataH[$cnt_batch]['product_code']],2): '0.00'}} </td>
