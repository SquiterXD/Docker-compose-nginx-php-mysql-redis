...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
	...
	@include('pd.reports.PDR0001._style')
</head>
<body>
<?php $pageNo = 0 ?>
...
<table>
<tr>
	<td style="font-weight: bold;">โปรแกรม : PDP0001</td>
...
<tr>
	...
	<td style="text-align: center; font-weight: bold;" >รายงานตรวจสอบสารปรุง (Casing No.)</td>
	<td style="text-align: right; font-weight: bold;">{{$time}}</td>
</tr>
<tr>
	<td> </td>
	<td style="text-align: center; font-weight: bold;">Casing no. {{ $Simus->first()->simu_formula_no }} </td>
...
<table>
	<thead>
		<tr>
			<th class="border-stype-th" width="7%">Casing no.</th>
