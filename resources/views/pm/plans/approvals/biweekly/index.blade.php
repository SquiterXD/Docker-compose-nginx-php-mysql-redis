...
@section('page-title')
    ...
    <h2> <x-get-program-code url="/pm/plans/approvals/biweekly" /> อนุมัติแผนผลิตสิ่งพิมพ์รายปักษ์ </h2>
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            อนุมัติแผนผลิตสิ่งพิมพ์รายปักษ์
        </li>
    </ol>
...
@section('content')
    ...
    <pm-plans-approvals-biweekly-index 
