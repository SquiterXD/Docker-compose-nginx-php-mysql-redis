...
>
    <table  width="100%"  style="padding-left: 5px; padding-right: 5px;" >
        <thead>
            ...
            <tr>
                <td  width="33.33%" align="left"   style="{{ $font18 }}"><b>พิมพ์โดย : </b> {{ $profile->user_name }}</td>
            ...
            <tr>
                <td  width="33.33%" align="left"   style="{{ $font18 }}"><b>หน่วยงาน : </b> {{ $reportData->department_desc }}</td>
                <td  width="33.33%" align="center"   style="{{ $font18 }}"></td>
