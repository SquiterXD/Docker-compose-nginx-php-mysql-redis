...
@section('title', 'การขอเบิกวัตถุดิบภายใน')

@section('page-title')
    <h2><x-get-program-code url="/pm/internal-material-requests"/> การขอเบิกวัตถุดิบภายใน</h2>
    <ol class="breadcrumb">
        <li class="breadcrumb-item active">
            <a>การขอเบิกวัตถุดิบภายใน</a>
        </li>
    </ol>
@stop
...
@section('content')
<pm-internal-material-requests-index
