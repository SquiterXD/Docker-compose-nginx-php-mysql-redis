        ...
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    {{-- {!! Form::open(['route' => ['pm.settings.machine-relation.update', $machineRelation->machine_relation_id] , "method" => "post" , "autocomplete" => "off", 'class' => 'form-horizontal']) !!}
                    @method('PUT') --}}
                    <machine-relation-form 
                        :machine-groups="{{ json_encode($machineGroups) }}"
                        :default-value="{{ json_encode($machineRelation)}}"
                        :old="{{ json_encode(Session::getOldInput()) }}"
                        :url-save="{{ json_encode(route('pm.settings.machine-relation.update', $machineRelation->machine_relation_id)) }}"
