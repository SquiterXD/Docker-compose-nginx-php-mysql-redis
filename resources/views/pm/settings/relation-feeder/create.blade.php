        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-title">
                    <h5>สร้างรายการความสัมพันธ์การจ่าย</h5>
                </div>
                <div class="ibox-content">
                    {!! Form::open(['route' => ['pm.settings.relation-feeder.store'] , "method" => "post" , "autocomplete" => "off", 'class' => 'form-horizontal']) !!}

                    <relation-feeder-create     :machine-groups = "{{ json_encode($machineGroups) }}" 
                                                :feeder-groups = "{{ json_encode($feederGroups) }}">
                    </relation-feeder-create>
