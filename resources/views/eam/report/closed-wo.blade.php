...
{{-- @section('page-title')
  <h2><x-get-program-code url="/eam/report/closed-wo" />: CT ใบปิดงานซ่อม</h2>
  <ol class="breadcrumb">
...
@section('page-title')
  <x-get-page-title menu="" url="/eam/report/closed-wo" />
@stop

@section('content')
@php $checkAttrId = 'closedWo' @endphp
<div id="eam0027" class="ibox eam">
...
@section('scripts')
  ...
  <script>
    ...
    $("#closedWoBtn").click(() => {
      $('#closedWoBtnAction').attr('action', "{{ route('eam.ajax.report.closed-wo') }}")
