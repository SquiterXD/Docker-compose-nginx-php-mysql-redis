...
{{-- @section('page-title')
  <h2><x-get-program-code url="/eam/report/summary-month" />: CT รายงานสรุปใบรับงานประจำเดือน</h2>
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">
      <strong>CT รายงานสรุปใบรับงานประจำเดือน</strong>
    </li>
  </ol>
...
@section('page-title')
  <x-get-page-title menu="" url="/eam/report/summary-month" />
@stop

@section('content')
@php $checkAttrId = 'summaryMonth' @endphp
<div id="eam0030" class="ibox eam">
...
@section('scripts')
  ...
  <script>
    ...
    $("#modalReportSummaryMonthPrint").click(() => {
      $('#modalReportSummaryMonthPrintAction').attr('action', "{{ route('eam.ajax.work-order.report.summary-month') }}")
