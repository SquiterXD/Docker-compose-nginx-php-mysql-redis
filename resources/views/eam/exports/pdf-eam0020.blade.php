...
@foreach ($workOrders as $data)
    <div class="page">
        ...
        <div style="text-align: center; margin-top: 10px">ใบรับงาน (ผลิตชิ้นส่วนอะไหล่)</div>
...
@if(isset($data["data"]->creation_date))
            ...
            <div class="d-inblock alTop" style=" width: 12%; margin-left: 15px;">
                {{Str::upper($data["data"]->creation_date->format('d-M-y'))}}
            </div>
@else
            <div class="d-inblock alTop alRight" style="width: 10%;">วันที่รับงาน : </div>
...
@endif
        ...
        <div class="d-inblock alTop" style="width: 70%; margin-left: 15px;">
            ...
            {{$data["data"]->wip_class_description}}
        </div>
        ...
        <div class="d-inblock alTop" style="width: 70%; margin-left: 15px;">{{$data["data"]->description}}</div>

        <div style="text-align: center; margin-top: 15px;">รายละเอียดการผลิตอะไหล่</div>

        <div class="d-inblock alTop alRight" style="width: 22%;">รหัสอะไหล่ : </div>
        <div class="d-inblock alTop" style="width: 70%; margin-left: 15px;">{{$data["data"]->asset_number}}</div>

        <div class="d-inblock alTop alRight" style="width: 22%;">รายละเอียด : </div>
        <div class="d-inblock alTop" style="width: 70%; margin-left: 15px;">{{$data["data"]->asset_desc}}</div>

        <div class="d-inblock alTop alRight" style="width: 22%;">Part Number : </div>
        <div class="d-inblock alTop" style="width: 70%; margin-left: 15px;">{{$data["data"]->part_number}}</div>

        <div class="d-inblock alTop alRight" style="width: 22%;">Old Part Number : </div>
        <div class="d-inblock alTop" style="width: 70%; margin-left: 15px;">{{$data["data"]->part_number_old}}</div>

        <div class="d-inblock alTop alRight" style="width: 22%;">Old Item Number : </div>
        <div class="d-inblock alTop" style="width: 30%; margin-left: 15px;">{{$data["data"]->old_item_number}}</div>

        <div class="d-inblock alTop alRight" style="width: 12%;">Machine : </div>
        <div class="d-inblock alTop" style="width: 30%; margin-left: 15px;">{{$data["data"]->machine_01}}</div>

        <div class="d-inblock alTop alRight" style="width: 22%;">จำนวนสั่งทำ : </div>
        <div class="d-inblock alTop" style="width: 30%; margin-left: 15px;">{{$data["data"]->jp_qty}}</div>

        <div class="d-inblock alTop alRight" style="width: 12%;">หน่วยนับ : </div>
        <div class="d-inblock alTop" style="width: 30%; margin-left: 15px;">{{$data["data"]->primary_unit_of_measure}}</div>

        <div style="position: absolute; top: 455px; left: 0; width: 100%;">
        ...
        <div style="margin-top: 80px;">
            <div style="border-top: 1px solid; margin-bottom: 5px;"></div>
            <div class="d-inblock alTop" style="width: 80px;">หมายเหตุ :</div>
            <div class="d-inblock alTop" style="width: 280px;">
                {{$data["data"]->wo_reference ? 'เลขที่ใบรับงานอ้างอิง : ' . $data["data"]->wo_reference : ''}}
            </div>
...
@endif
            ...
            <div class="d-inblock alTop" style="width: 37%; margin-left: 15px;">{{$data["data"]->actual_total_cost ? $data["data"]->actual_total_cost : '0'}} บาท</div>
        </div>
        <div>
@if(isset($data["data"]->scheduled_completion_date))
            <div class="d-inblock alTop alRight" style="width: 22%;">วันที่เสร็จ : </div>
            <div class="d-inblock alTop" style="width: 20%; margin-left: 15px;">{{Str::upper($data["data"]->scheduled_completion_date->format('d-M-y'))}}</div>
@else
            <div class="d-inblock alTop alRight" style="width: 22%;">วันที่เสร็จ : </div>
            <div class="d-inblock alTop" style="width: 20%; margin-left: 15px;"></div>
@endif
            <div class="d-inblock alTop alRight" style="width: 12%;">Workhour : </div>
            <div class="d-inblock alTop" style="width: 37%; margin-left: 15px;">{{$data["data"]->actual_duration ? $data["data"]->actual_duration : '0'}} ชม.</div>
        </div>
