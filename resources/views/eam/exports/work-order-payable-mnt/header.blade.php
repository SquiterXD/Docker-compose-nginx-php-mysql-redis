...
<body onload="subst()" style="margin:0; padding: 0; overflow:hidden;">
    ...
    <table class="table-content" style="width:100%">
            <tr style="text-align: center;">
                <td colspan="3" style="width:33%" align="left">EAM_508 V 1.1</td>
                <td colspan="4" style="width:33%">การยาสูบแห่งประเทศไทย</td>
            ...
            <tr style="text-align: center;">
                ...
                <td  colspan="4" style="width:33%">รายงานข้อมูลระบบเจ้าหนี้เข้าระบบบำรุงรักษาเครื่องจักร</td>
                <td colspan="3" style="text-align: right; width:33%;">
                    จำนวนหน้า / หน้าทั้งหมด <span class="page"></span> / <span class="topage"></span>
                </td>
            </tr>
            <tr>
                <td colspan="10" style="padding-left: 442px;">ประจำวันที่ : {{Str::upper($date['from']) }} ถึง : {{Str::upper($date['to']) }}</td>
            </tr>
            <tr>
                <td></td>
                <td></td>
