...
<body onload="subst()" style="margin:0; padding: 0; overflow:hidden;">
    ...
    <table class="table-content" style="width:100%">
            <tr style="text-align: center;">
                <td colspan="3" style="text-align: left; width:33%">EAM_509 V 1.0 </td>
            ...
            <tr style="text-align: center;">
                ...
                <td  colspan="5" style="width:33%"> รายงานส่งค่าแรงระหว่างประกอบเข้าบัญชีแยกประเภท</td>
                <td colspan="3" style="text-align: right; width:33%;">
                    จำนวนหน้า / หน้าทั้งหมด <span class="page"></span> / <span class="topage"></span>
                </td>
            </tr>
            <tr>
                <td  colspan="11" style="text-align: center;">ประเภท  Job :  อะไหล่&nbsp;&nbsp;&nbsp;&nbsp;ค่าแรงระหว่างประกอบเดือน เดือน/ปี : {{$date['period']}}</td>
            </tr>
            <tr>
                <td></td>
                <td></td>
