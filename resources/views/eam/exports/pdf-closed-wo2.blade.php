<title>ใบปิดงานซ่อม (โรงพิมพ์)</title>
<style type="text/css">
    @font-face {
...
<div class="page">
    ...
    <div>
        ...
        <div style="display: inline-block; width: 35%; margin-top: 50px;">ใบสั่งงาน (Work Order) :
    ...
    <table width="100%" border="0">
        <tr>
            <td align="right" valign="top" style="font-family: 'SarabunSans';font-size: 10px; width: 19%; white-space: nowrap; ">รายละเอียดใบสั่งงาน : &nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td style="font-family: 'SarabunSans';font-size: 10px;margin-right: auto;white-space: normal; word-wrap: break-word; line-break: anywhere; overflow-wrap: break-word;
        	word-break: break-all;"> {{$itemMain->description}}</td>
        </tr>
        <!-- <tr>
            <td align="right" valign="top" style="font-family: 'SarabunSans';font-size: 10px; width: 19%; white-space: nowrap; ">รายละเอียดใบสั่งงาน : &nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td style="font-family: 'SarabunSans';font-size: 10px;margin-right: auto;white-space: normal; word-wrap: break-word; line-break: anywhere;"> Sunt reprehenderit excepteur consectetur veniam sunt ea exercitation. Consectetur fugiat ad deserunt commodo sunt eiusmod. Consequat veniam occaecat tempor consectetur aliquip labore ea voluptate Lorem sint. Elit enim veniam sit amet consectetur quis laborum ad nisi laborum ea incididunt. </td>
        </tr> -->
    </table>
    <!-- <div style="white-space: nowrap; width: 100%; margin-left: 33px;">รายละเอียดใบสั่งงาน :
        <div style="display: inline; margin-left: 15px; margin-right: auto;white-space: normal; word-wrap: break-word; line-break: anywhere; overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">{{$itemMain->description}}</div>
    </div> -->
