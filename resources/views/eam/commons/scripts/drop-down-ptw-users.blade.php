...
<script>
  var dataDropDownPtwUsers= []
  var dataDropDownPtwUsersDefault= []
  $.ajax({
    url: "{{ route('eam.ajax.lov.ptw-user') }}",
    method: 'GET',
    success: function (response) {
      dataDropDownPtwUsers= response.data.filter(row => {
      ...
      autocomplete(document.getElementById("nameCreate"), dataDropDownPtwUsers, document.getElementById("nameCreateBtn"));
    },
