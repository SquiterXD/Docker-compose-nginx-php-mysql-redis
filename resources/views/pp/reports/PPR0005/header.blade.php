<table>
    ...
    <tr>
        ...
        <th style="text-align: center; font-weight: bold;width: 400px; border: 1px solid #FFF;">
            ปีงบประมาณ : {{ $biweekly->period_year_thai }} เดือน : {{ $biweekly->thai_month }} ครั้งที่ : {{ optional($stampMonthly)->version_no }}
        </th>
        <th style="text-align: right; font-weight: bold;width: 300px; border: 1px solid #FFF;">หน้า : 1 / 1 </th>
    </tr>
    <tr>
        <th style="text-align: left; font-weight: bold;width: 300px; border: 1px solid #FFF;"> </th>
        <th style="text-align: center; font-weight: bold; width: 700px; border: 1px solid #FFF;">
            รหัสแสตมป์ : {{ $stampItems? $stampItems->first()->stamp_code: '' }} {{ $stampItems? $stampItems->first()->stamp_description: '' }}
        </th>
        <th style="text-align: right; font-weight: bold;width: 300px; border: 1px solid #FFF;"> </th>
    </tr>
</table>