...
<div class="modal fade" id="enter-due-date" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog pt-0 modal-md" role="document" style="width: 400px;">
        ...
        {!! Form::open(['route' => ['ie.cash-advances.set_due_date',$cashAdvance->cash_advance_id], 
              'method' => 'POST',
            ...
            <div class="modal-body clearfix">
                <div class="col-md-12">
                    ...
                    <div class="row ">
                        ...
                        {!! Form::text('due_date', $cashAdvance->due_date, ['class'=>'form-control','id'=>'txt_due_date', 'autocomplete'=>'off']) !!}
                    </div>
                </div>
            </div>
