<div class="row">
    <div class="col-md-12 no-padding-xs">
        @if($cashAdvance->isNotLock() && !$cashAdvance->onClearing() && canEnter('/ie/cash-advances') && $cashAdvance->canImportantEditData())
		...
		<div class="clearfix" id="div_clearing_receipt_list">
	        ...
	        @include('ie.commons.receipts._table',['parent'=>$cashAdvance, 'editable'=> (canEnter('/ie/cash-advances') && !$cashAdvance->onClearing())])
