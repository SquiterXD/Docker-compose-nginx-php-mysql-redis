@if( $cashAdvance->isNotLock() )
				...
				<div class="modal-content">
					<div class="modal-body" id="modal-body-edit-form">
						<div class="m-l-xs m-r-lg mm-xs">
							...
							<h3 class="m-b-md">Edit Cash Advance : {{ $cashAdvance->clearing_document_no }}</h3>
							<hr class="m-b-xs">
							{!! Form::hidden('process_type', 'CLEARING', ["id" => 'txt_process_type']) !!}
	...
	@else
		<div id="modal-edit-form-cl" class="modal fade" aria-hidden="true">
			<div class="modal-dialog pt-0 modal-lg">
				<div class="modal-content">
					<div class="modal-body" id="modal-body-edit-form">
						<div class="m-l-xs m-r-lg mm-xs">
							{!! Form::model($cashAdvance, ['route' => ['ie.cash-advances.update_cl', $cashAdvance->cash_advance_id], 'class' => 'form-horizontal', 'method' => 'patch', 'id' => 'form-edit-cash-advance'] ) !!}
							<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
							<h3 class="m-b-md">Edit Cash Advance : {{ $cashAdvance->clearing_document_no }}</h3>
							<hr class="m-b-xs">
							{!! Form::hidden('process_type', 'CLEARING', ["id" => 'txt_process_type']) !!}
							<div class="row clearfix">
								<div class="col-sm-12" id="modal_content_edit_cl">
									{{-- FORM CASH ADVANCE HTML --}}
									{{-- @include('ie.cash-advances._form', ['action' => 'edit']) --}}
								</div>
							</div>
							...
							<div class="row clearfix">
								<div class="col-sm-12 text-right">
									<button type="submit" class="btn btn-primary" id="btn-submit-edit-cl" data-loading-text="<i class='fa fa-spinner fa-spin'></i> Saving ...">
										Save
									</button>
									<button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
								</div>
