<div class="row d-none" id="div-reim-search-form">
    <div class="col-md-10">
        <form id="reim-search-form" action="{{ url()->current() }}">
            <div class="row mb-2">
                <div class="col-md-4">
            ...
            <div class="row mb-2">
                ...
                <div class="col-md-5">
                    <label for="">Inv. Date From - To</label>
    ...
    <div class="col-md-2 text-right d-flex align-items-end flex-column">
        ...
        <div class="mt-auto">
            ...
            <a type="button" class="btn btn-danger" href="{{route('ie.reimbursements.index')}}">Clear</a>
        </div>
    </div>
</div>
<div class="row">
