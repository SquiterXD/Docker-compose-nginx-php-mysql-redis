<div class="row">
    <div class="col-md-12 no-padding-xs">
        @if($reim->isNotLock() && canEnter('/ie/reimbursements') && $reim->canImportantEditData())
		...
		<div class="clearfix" id="div_clearing_receipt_list">
	        ...
	        @include('ie.commons.receipts._table', ['parent'=>$reim , 'editable' => canEnter('/ie/reimbursements')])
