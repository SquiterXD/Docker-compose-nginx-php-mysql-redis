...
@section('page-title')
    <h2>
        <div> <x-get-program-code url="/ie/settings/locations" /> Locations</div>
...
@section('page-title-action')
    {{-- <div class="text-right m-t-lg">
        <button class="btn btn-success" data-toggle="modal" href="#modal-create-form">
                    ...
                    @if(count($locations) > 0)
                        @foreach ($locations as $location)
                            <tr>
                                ...
                                <td class="hidden-xs">
                                    {{ array_key_exists($location->org_id, $operatingUnits) ? $operatingUnits[$location->org_id] : '' }}
                                </td>
                                <td class="text-right">
