<div id="modal-create-form" class="modal fade" aria-hidden="true">
        <div class="modal-dialog pt-0 modal-md">
            <div class="modal-content">
                ...
                {!! Form::open(['route' => ['ie.settings.ca-sub-categories.infos.store',$ca_category->ca_category_id,$ca_sub_category->ca_sub_category_id], 'class' => 'form-horizontal']) !!}
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h3 class="m-b-md">
                        <div>Create CA Sub-Category Infomation</div>
                        <div><small>สร้างข้อมูลรายละเอียดของประเภทการเบิกเงินทดรองย่อยใหม่</small></div>
