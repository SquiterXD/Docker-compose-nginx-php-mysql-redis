 {{-- <div class="table-responsive"> --}}
    <table class="table table-hover">
        ...
        @if(count($unblockers)>0)
	        @foreach($unblockers as $index => $userId)
				...
				<tr>
		            ...
		            <td width="5%">
		            	<a href="#" id="btn_remove_unblocker_{{ $user->user_id }}" data-value="{{ $user->user_id }}" class="btn btn-outline btn-danger btn-xs">
			...
			<tr>
				<td colspan="5">
					<h3 class="text-center m-t-md m-b-md" style="color:#bbb">
						Not found unblocking responsible user.
					</h3>
				</td>
			</tr>
	    @endif
