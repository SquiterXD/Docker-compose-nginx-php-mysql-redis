 {{-- <div class="table-responsive"> --}}
    <table class="table table-hover">
        ...
        @if(count($showAllUsers)>0)
	        @foreach($showAllUsers as $index => $userId)
				...
				<tr>
		            ...
		            <td width="5%">
		            	<a href="#" id="btn_remove_show_all_{{ $user->user_id }}" data-value="{{ $user->user_id }}" class="btn btn-outline btn-danger btn-xs">
