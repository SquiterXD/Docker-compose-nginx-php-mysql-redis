...
@section('page-title')
    <h2>
        <x-get-program-code url="/ie/settings/categories" /> Categories  <br>
                    ...
                    <div class="forum-item" style="margin: 7px 0; padding: 7px 0 10px;">
                        <div class="row">
                            ...
                            <div class="col-md-4 text-right">
                                <a href="{{ route('ie.settings.sub-categories.index',[$category->category_id]) }}" class="btn btn-resize btn-default">
                                    <i class="fa fa-th-list m-r-xs"></i> Sub-Categories
                                </a>
                                <a href="{{ route('ie.settings.categories.edit', $category) }}" class="btn btn-resize btn-warning">
