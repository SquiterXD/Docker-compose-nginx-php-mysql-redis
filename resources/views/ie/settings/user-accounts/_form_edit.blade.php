{!! Form::model($account, ['route' => ['ie.settings.user-accounts.update', $account->user_account_id], 'class' => 'form-horizontal', 'method' => 'patch', 'id'=>'form-edit-account'] ) !!}
    ...
    <div class="row m-b-sm">
        ...
        <div class="col-md-6">
            ...
            {!! Form::text('account_number', $account->account_number, ["class" => 'form-control input-sm', "id" => "txt_account_number", "autocomplete" => "off","style"=>"width:100%", "maxlength"=>"10"]) !!}
        </div>
    </div>
