...
@section('page-title')
    ...
    <h2 class="hidden-xs hidden-sm">
        <x-get-program-code url="/ie/settings/categories" /> {{ $category->name }} : Sub-Categories <br>
                ...
                <table class="table table-hover">
                    <thead>
                        <tr class="active">
                            ...
                            <th width="9%" class="text-center hidden-sm hidden-xs">
                                <div>Start Date</div>
