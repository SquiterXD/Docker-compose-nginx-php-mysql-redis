{!! Form::open(['route' => ['ie.receipts.lines.store',$receipt->receipt_id], 
                    'method' => 'POST',
    ...
    <div class="text-right">
        ...
        <button type="button" id="btn_cancel_create_receipt_line" class="btn btn-danger" data-dismiss="modal">Cancel</button>
    </div>
        ...
        function getSubCategories(categoryId)
        {
            $.ajax({
                ...
                beforeSend: function( xhr ) {
                    $("#progress_modal_create").removeClass('d-none');
            ...
            .done(function(result) {
                ...
                $("#progress_modal_create").addClass('d-none');
                bindEventSubCategory();
            });
        }
