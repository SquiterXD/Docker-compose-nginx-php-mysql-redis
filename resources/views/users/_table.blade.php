    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-right hidden-sm hidden-xs">
                {{ $user->creation_date->format(trans('date.format')) }}
                {{ $user->creation_date->format(trans('date.time-format')) }}
            </td>
            <td class="text-right hidden-sm hidden-xs">
                {{ $user->last_update_date->format(trans('date.format')) }}
                {{ $user->last_update_date->format(trans('date.time-format')) }}
            </td>
            @if (canEnter('/users'))
            <td class="text-right">
