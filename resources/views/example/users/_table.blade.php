<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ $user->name }}</td>
            <td>{{ $user->email }}</td>
            <td class="text-right hidden-sm hidden-xs">{{ parseToDateTh($user->creation_date) }}</td>


            <td class="text-right hidden-sm hidden-xs">{{ parseToDateTh($user->last_update_date) }}</td>
