            ...
            <div class="subpage smallgap">
                <div class="border">
                    ...
                    <div style="padding-top: 85px;">
                        <h2 class="report-title angsanaUPC">บัญชีราคาสินค้า (INVOICE) </h2>
                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="d-block text-center">
                                    <p>{{ !empty($proformaData) ? $proformaData->attribute1 : '' }}</p>
                                </div>

                                {{-- <p class="">Status.</p>
                                <div class="d-block text-center">
                                    <p>{{ !empty($proformaData) ? $proformaData->sa_status : '' }}</p>
                                </div> --}}
                            </td>
                            <td>
                ...
                <table class="table-report-foreign text-xs table3">
                    <tr>
                        <td rowspan="2">
                            ...
                            <div class="d-block pl-2">
                                <p>
                                    {{ !empty($proformaData) ? $proformaData->remark : '' }}
                                </p>
