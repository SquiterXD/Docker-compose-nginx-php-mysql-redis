                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control select2-tags sel-debit" style="width: 100%;" id="reserved1" name="reserved1">
                            ...
                            <option value="{{ $item->reserved1 }}" data-value="{{ $item->description }}">{{ $item->reserved1 }} - {{ $item->description }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control select2-tags sel-debit" style="width: 100%;" id="reserved2" name="reserved2">
                            ...
                            <option value="{{ $item->reserved2 }}" data-value="{{ $item->description }}">{{ $item->reserved2 }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
