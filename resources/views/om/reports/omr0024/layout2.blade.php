                ...
                <thead>
                    <tr>
                        <th class="text-center" 
                            rowspan="2" 
                            style="width:120px;border-top:1px solid #000; border-bottom:1px solid #000">
                            เลขที่ใบกำกับสินค้า
                        </th>
                        <th class="nowarp" 
                            rowspan="2" 
                            style="white-space: nowrap; text-align: left !important; padding-left:15px;border-top:1px solid #000; border-bottom:1px solid #000">
                            ชื่อร้านค้า
                        </th>
