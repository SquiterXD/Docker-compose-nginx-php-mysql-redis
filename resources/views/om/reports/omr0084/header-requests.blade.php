...
<tr>
<td width="33%">
    <h6   class="tw-inline-block tw-font-bold text-left"> โปรแกรม :  OMR0084</h6>
    </td>
...
<tr>
    ...
    <td width="33%"style="text-align: center; "> 
        <div>
            <h6     
                    class="text-center tw-inline-block tw-font-bold text-center"> การบันทึกเจ้าหนี้ค่าบุหรี่ สโมสร (เงินสด)                          
            </h6>                     
        </div>
