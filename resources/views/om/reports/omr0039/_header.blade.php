...
<td></td>
    ...
    <tr>
        <td width="33%">
                <div    style="font-size: 16px;" 
                        class="tw-inline-block tw-font-bold text-left"> รหัสโปรแกรม :  OMR0039                       
                </div>                     
        ...
        <td width="33%"style="text-align: center; "> 
            <div>
                <div    style=" font-size: 16px;" 
                        class="text-center tw-inline-block tw-font-bold text-center"> สรุปใบลดหนี้ทางการค้า (Cr.Note)                          
                </div>                     
            </div>
    ...
    <tr>
        ...
        <td style="text-align: center; ">
                <div    style="font-size: 16px;" 
                        class="tw-inline-block tw-font-bold text-center"> ตั้งแต่เดือน {{$START_DATE}} ถึง วันที่ {{$END_DATE}}  </div> 
        </td>
        <td>
