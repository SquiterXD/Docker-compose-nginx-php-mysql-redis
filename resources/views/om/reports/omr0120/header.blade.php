...
<div class="row col-lg-12">
    <div class="col-md-4" style="font-size: 16px; text-align: left; width: 150px;">
        <div style="margin-bottom: 15px;"> <strong> รหัสโปรแกรม : OMR0120</strong>  </div>
        <div style="margin-bottom: 15px;"> <strong> สั่งพิมพ์ : {{ $user->user_id }} </strong> </div>
    </div>
...
<div class="row col-lg-12">
    ...
    <div align="right" class="col-md-4" style="font-size: 16px;">
        <strong> หน่วยนับบุหรี่ : {{ $cigarette_type->unit_of_measure  }} </strong>
    </div>
</div>
