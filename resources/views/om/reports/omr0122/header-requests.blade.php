...
<tr>
<td width="33%">
    <h5   class="tw-inline-block tw-font-bold text-left"> โปรแกรม :  OMR0085</h5>
    </td>
...
<tr>
    ...
    <td width="33%"style="text-align: center; "> 
        <div>
            <h5     
                    class="text-center tw-inline-block tw-font-bold text-center"> รายการเรียกเก็บเงินค่าบุหรี่                        
            </h5>                     
        </div>
...
<tr>
    ...
    <td style="text-align: center; ">
            <h5     
                    class="tw-inline-block tw-font-bold text-center">{{$BANK}}   </h5> 
    </td>
    <td>
...
<tr>
    ...
    <td style="text-align: center; ">
            <h5     
                    class="tw-inline-block tw-font-bold text-center"> วัน {{$day}} ที่ {{$Pdate}}   </h5> 
    </td>
