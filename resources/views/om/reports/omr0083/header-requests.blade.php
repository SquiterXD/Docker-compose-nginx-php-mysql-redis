...
<tr>
<td width="33%">
    <h5   class="tw-inline-block tw-font-bold text-left"> โปรแกรม :  OMR0083</h5>
    </td>
...
<tr>
    ...
    <td width="33%"style="text-align: center; "> 
        <div>
            <h5     
                    class="text-center tw-inline-block tw-font-bold text-center"> การบันทึกเจ้าหนี้ค่าบุหรี่เงินสด                          
            </h5>                     
        </div>
