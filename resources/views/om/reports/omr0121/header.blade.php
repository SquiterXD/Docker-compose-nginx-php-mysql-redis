...
<div class="row col-lg-12">
    <div class="col-md-4" style="font-size: 16px; text-align: left; width: 150px;">
        <div style="margin-bottom: 15px;"> <strong> รหัสโปรแกรม : OMR0121 </strong>  </div>
    ...
    <div class="col-md-4" style="font-size: 20px; text-align: center; font-weight: bold;">
        ...
        <div style="margin-bottom: 10px;"> ปีงบประมาณตั้งแต่ {{ @$years_fromth }}  ถึงปีงบที่  {{ @$years_toth }} </div>
    </div>
