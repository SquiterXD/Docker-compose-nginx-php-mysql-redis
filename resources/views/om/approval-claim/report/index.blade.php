...
<body>
            ...
            <tr>
                ...
                <td>
                    <p>
                        ...
                        วัน-เวลา ที่สร้าง : {{ $claimInfo['date_thai_claim_date'] }} น.
                    </p>
                </td>
            </tr>
            <tr>
                <td colspan="2">เรียน <span style="margin-left: 0.5cm;">ผู้อำนวยการฝ่ายขาย</span></td>
            </tr>

            <tr>
                <td colspan="2">
                    <span>ด้วย <span style="margin-left: 0.5cm;  margin-bottom:0.2cm;"> {{ @$customeInfo['customer_name'] }} </span>
                    ...
                    <span>ได้รับสินค้าจากโรงงานยาสูบ พบว่ามีบุหรี่ชำรุด/เสียหาย ขาดบรรจุดังรายการต่อไปนี้</span>
                </td>
            </tr>
        </table>
    </div>
    ...
    <div style="border: 1px solid #ccc; padding: 0.1cm 0.5cm;  margin-bottom:0.2cm">
        ...
        <ul>
            <li style="list-style: none">
                ...
                กองลูกค้าสัมพันธ์ ฝ่ายขายพร้อมทั้งแนบรูปถ่าย ดังนี้
                <ul>
            ...
            <li style="list-style: none">
                ...
                <ul>
                    <li style="list-style: none">2.1 ถ่ายภาพลักษณะการขาดบรรจุทันทีที่พบ 3 จุดดังนี้
                        <ul>
                            <li style="list-style: none">- ข้างหีบบุหรี่จุดที่พิมพ์รหัสการผลิต และโรงงานผลิต</li>
                            <li style="list-style: none">- หน้าหีบบุหรี่จุดที่พิมพ์รหัสการผลิต และโรงงานผลิต</li>
                            <li style="list-style: none">- ลักษระการขาดบรรจุ</li>
                        </ul>
                    </li>
                </ul>
            </li>
    ...
    @foreach ($attachments as $key => $item)
        ...
        <img style="width:60%" 
             src="{{ storage_path(str_replace('/var/www/service-38090/storage/','',$item['path_name']).$item['file_name']) }}" 
             alt=""> 
        <br><br>
    @endforeach
</body>
