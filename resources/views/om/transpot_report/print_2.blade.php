...
<body class="font-thsarabun" style="padding:12px;">
    @php
        ...
        $tsum3 = 0;
        $tsum4 = 0;
        $countarray = count($new_data_2);
        $round = 0;
    @endphp
    @foreach ($new_data_2 as $k => $data_chunk)
    @php
        $round++;
        $key_number = 0;
    @endphp
      ...
      @endphp
            ...
            <table style="width: 100%;border-collapse: collapse;" @if(count($data) == 20) class="page" @endif>
                ...
                @endphp
                    <tr class="list">
                        ...
                        <td class="text-right space" style="text-align: right">{{ number_format($d['sum'],6) }}</td>
        ...
        @php
            ...
            $tsum4 += $sum4;
        @endphp
            @if(!empty($new_data_2) && $round == $countarray)
            <tr class="list">
