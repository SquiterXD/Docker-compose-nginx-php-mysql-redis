...
@section('page-title')
    <h2> OMP0077 : Credit Note กรณีอื่นๆ สำหรับขายต่างประเทศ</h2>
    <ol class="breadcrumb">
        <li class="breadcrumb-item">
            <a href="/">Home</a>
        </li>
        <li class="breadcrumb-item active">
            <strong> OMP0077 : Credit Note กรณีอื่นๆ สำหรับขายต่างประเทศ</strong>
        </li>
    </ol>
@stop
...
<div class="ibox">
    <div class="ibox-title">
        <h3>OMP0077 : Credit Note กรณีอื่นๆ สำหรับขายต่างประเทศ</h3>
    </div>
            ...
            <div class="col-12">
                <div class="form-header-buttons">
                    ...
                    <div class="buttons multiple">
                        ...
                        <button class="btn btn-md btn-primary in_confirm_remark" disabled type="button" onclick="saveInvoiceRemark();" ><i class="fa fa-save"></i> บันทึกหมายเหตุ</button>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-icon">
                                <input type="text" list="ceditnote_number_list" class="form-control" autocomplete="off" id="ceditnote_number_show" name="ceditnote_number_show" placeholder="" value="">
                                <datalist id="ceditnote_number_list">

                                </datalist>

                                {{-- <input type="text" list="ceditnote_list" class="form-control" autocomplete="off" id="ceditnote_number_show" name="ceditnote_number_show" placeholder="" value="">
                                <datalist id="ceditnote_list">
                                    <option value=""></option>
                    ...
                    <div class="col-xl-8">
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="input-icon">
                                        {{-- <select name="customer_number" id="customer_list" class="custom-select select2" onchange="searchcustomer(this.value)" >

                                        </select> --}}
                                        <input type="text" list="customer_list" autocomplete="off" class="form-control form_input_disabled" id="customer_number"  name="customer_number" onchange="searchcustomer(this.value);getCreditNoteList(this.value);" onkeyup="searchcustomer(this.value);getCreditNoteList(this.value);">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control blue text-right form_input_disable" disabled onblur="formatCurrency('price_amount','blur');" onkeyup="formatCurrency('price_amount');" id="price_amount" name="price_amount" placeholder="" value="">
                    ...
                    <div class="col-xl-12">
                        <div class="form-group">
                            ...
                            @include('om.creditnote._form_credit_other_export')
                        </div>
                    </div><!--col-->
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form_input_disable" autocomplete="off" disabled  name="number_order" id="number_order" placeholder="" value="">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="custom-select select2 form_input_disable" autocomplete="off" disabled name="invoice_channel" id="channelreceiving_list" >
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form_input_disable" id="approve_document" autocomplete="off"  disabled name="approve_document" placeholder="" value="">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form_input_disable" id="convertion_rate" onblur="formatCurrency('convertion_rate','blur');" onkeyup="formatCurrency('convertion_rate');" autocomplete="off"  disabled name="convertion_rate" placeholder="" value="">
                        </div>
                    </div>

                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="d-block">ประเภทการรับเงิน</label>
                            <div class="d-md-flex">
                                <div class="mr-3 mt-2"><label><input type="radio" class="term_radio" value="30" id="term_28" name="type_payment"><span> เงินเชื่อ 30 วัน</span></label></div>
                                ...
                                <div class="mt-2"><label>     <input type="radio" class="term_radio" value="0" id="term_0" name="type_payment" checked><span> เงินสด</span></label></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="" class="d-block">หมายเหตุ</label>
                            ...
                            <tr class="align-middle">
                                <td>
                                    <div class="input-icon">
                                        ...
                                        <input type="hidden" id="invoice_line" name="invoice_line[1]">
                                ...
                                <td id="order_date_1">00</td>
                                <td id="order_duedate_1">00</td>
                                <td><span id="contact_1">-</span> <input type="hidden" name="creadit_group[1]" id="creadit_group_1"> </td>
                                <td id="day_duedate_1">0</td>
                                <td id="payover_1">0.00</td>
                                <td class="text-right">
                                ...
                                <td>
                                    <div class="wihtout-text m-auto"><label><input type="checkbox" value="Y" name="payment_status[1]" id="payment_status_1" onclick="checkAmount('1');"></label></div>
                                </td>
                            </tr>
...
<script>
    ...
    function customer_list()
    {
        ...
        $.ajax({
            url : '{{ url("om/ajax/credit-note-other_export/customer_list") }}',
            type : 'post',
            data : {
                '_token'    : '{{ csrf_token() }}',
                customer : customer
    ...
    function getCreditNoteList(customer)
    {
        ...
        $.ajax({
            url : '{{ url("om/ajax/credit-note-other_export/getcreditnote") }}',
            type : 'post',
            data : {
                '_token'    : '{{ csrf_token() }}',
    ...
    function checkAmount()
    {
        ...
        $.each($("input[name^=payment_status]"),function(key,value){
            if($(value).prop('checked')){
                var value = $("input[name='payment_total[1]']").val().toString().replace(/,/g, '');
                new_amount += parseFloat(value);
            }
        });

        $("#price_amount_data").val(new_amount);
    ...
    function searchcustomer(code)
    {
        ...
        // var customer = $("#customer_number").val();
        console.log(customer_list_arr[code]);
    ...
    function create_invoice()
    {
        ...
        loading();
        $.ajax({
            url         : '{{ url("om/ajax/credit-note-other_export/gencreatenumber") }}',
            type        : 'post',
            data        : {
                '_token' : '{{ csrf_token() }}'
            },
            success:function(rest){
                ...
                if(data.status){
                    ...
                    reActiveApproveDatePicker(data.data.date);
    ...
    {
        $.ajax({
            url : '{{ url("om/ajax/credit-note-other_export/channelreceiving_list") }}',
            type : 'post',
            data : {
                '_token'    : '{{ csrf_token() }}',
            },
    ...
    function searchOrder()
    {
        ...
        loading();
        $.ajax({
            url : '{{ url("om/ajax/credit-note-other_export/get_order") }}',
            type : 'post',
            data : {
                '_token'    : '{{ csrf_token() }}',
                customer_id      : customer_id,
            ...
            success:function(rest){
                ...
                if(invoice_search.item_line){
                    ...
                    if(statusinv == 'Confirm' || statusinv == 'Cancelled'){
    ...
    function selectOrder(number)
    {
        ...
        $("#order_number_data").val(data.number);
        $("#product_type").val(data.product_type);
        $("#amount_order_1").html(numberFormat(data.total));
        $("#order_date_1").html(data.order_date);
        $("#order_duedate_1").html(data.payment_duedate);
        $("#contact_1").html(data.payment);
        $("#creadit_group_1").val(data.payment);
        $("#day_duedate_1").html(data.day);
        $("#payover_1").html(data.payover);
        $("#total_amount_shop").val(numberFormat(data.total));
        $("#total_amount_order").val(data.total);
        $("#payment_total_1").val(numberFormat(data.amount));
        $("#total_payment").val(numberFormat(data.amount));
        $("#invoice_line").val(data.line_id);
        if(data.line_id){
        ...
        //         if(i == 1){
        //             $("#order_id").val(val.id);
        //             $("#amount_order_1").html(val.total_group);
        ...
        //             $("#payment_total_1").val(val.amount);
        //         }else{
        //             html += '<tr class="align-middle tr_line">';
        //             html += '    <td>';
        //             html += '    </td>';
        //             html += '    <td class="text-right" id="amount_order_'+i+'">'+val.total_group+'</td>';
        ...
        //             html += '         <input type="text" class="form-control text-right" onkeyup="sumTotal();" name="payment_total['+i+']" id="payment_total_'+i+'" placeholder="" value="'+val.amount+'">';
        //             html += '     </td>';
        //             html += '    <td>';
        //             html += '        <div class="wihtout-text m-auto"><label><input type="checkbox" value="Y" name="payment_status['+i+']" id="payment_status_'+i+'"></label></div>';
        //             html += '        <input type="hidden" name="invoice_line['+i+']" value="'+val.line_id+'" >'
        //             html += '    </td>';
        //             html += '</tr>';
        //         }
        //         i += 1;
        ...
        //     $("#total_amount_shop").val(total);
        //     $("#total_amount_order").val(total);
        //     $("#total_payment").val(alltotal);
        // }else{
        //     var key = Object.keys(order_list[number]);
        //     $("#order_id").val(data[key[0]].id);
        //     $("#amount_order_1").html(data[key[0]].amount);
        ...
        //     $("#total_amount_shop").val(data[key[0]].amount);
        //     $("#total_amount_order").val(data[key[0]].amount);
        //     $("#payment_total_1").val(data[key[0]].amount);
        //     $("#total_payment").val(data[key[0]].amount);
        // }
    }
    function saveInvoiceRemark() {
        loading();
        $.ajax({
            url: '{{ url("om/ajax/credit-note-other_export/save_invoice") }}',
            type: 'post',
            data: {
                _type: 'remark',
                remark: $('textarea[name="remark"]').val(),
                invoice_headers_number: $('#ceditnote_number_show').val(),
                '_token': '{{ csrf_token() }}'
            },
            dataType: 'json',
            success: function (rest) {
    ...
    {
        var h_amount = $("#price_amount").val();
        var l_amount = $("#total_payment").val();
        var order    = $("#order_number_1").val();

        if(order){
            if($("#payment_status_1").prop('checked',true)){
                if(h_amount  != l_amount){
                    AlertToast('Waring','โปรดตรวจสอบจำนวนเงินและ จำนวนเงินที่ขำระ ให้ตรงกัน','error');
                    return false;
                }
            }
        }
        ...
        $.ajax({
            ...
            success:function(rest){
                ...
                if(data.status){
                    ...
                    $("#ceditnote_number_show").val(data.header_number).trigger('change');
    ...
    function sumTotal()
    {
        ...
        $.each($('input[name^=payment_total]'),function(idx,elem){
            var value = $(elem).val().toString().replace(/,/g, '');
            total += parseFloat(value);
        });

        $("#total_payment").val(numberFormat(total));
        $("#price_amount").val(numberFormat(total));
        $("#price_amount_data").val(total.toFixed(2));
    }
    ...
    function searchInvoice()
    {
        ...
        loading();
        $.ajax({
            url     : '{{ url("om/ajax/credit-note-other_export/search_invoice") }}',
            type    : 'post',
            data    : {
                '_token'    : '{{ csrf_token() }}',
                number      : number,
            ...
            success:function(rest){
                ...
                invoice_search = data;
                statusinv = data.invoice_status;
                $(".in_confirm_remark").prop('disabled', false)
                if(data.invoice_status == 'Cancelled'){
                    ...
                    $(".term_radio").prop('disabled',true);
                    deActiveDatePicker(data.document_date);
                    deActiveApproveDatePicker(data.approve_date);
                    ...
                    $(".in_create").prop('disabled',true);
                    $(".form_input_disable").prop('disabled',false);
                    reActiveDatePicker(data.document_date);
                    reActiveApproveDatePicker(data.approve_date);
                ...
                $("#convertion_rate").val(data.exchange_rate);
    ...
    function cancel_invoice()
    {
        ...
        loading();
        $.ajax({
           url : '{{ url("om/ajax/credit-note-other_export/cancel_invoice") }}',
           type : 'post',
           data : {
                '_token'    : '{{ csrf_token() }}',
    ...
    function formatCurrency(input, blur) {
        ...
        if (input_val.indexOf(".") >= 0) {
            ...
            right_side = right_side.substring(0, 9);
            // join number by .
    ...
    function reActiveApproveDatePicker(value_date)
    {
        var vue = new Vue({
            data(){
                return {
    ...
    function deActiveApproveDatePicker(value_date)
    {
        var vue = new Vue({
            data(){
                return {
        ...
        var vue = new Vue({
            ...
            methods:{
                selected(date) {
                    ...
                    var formattedDate = `${parts[0].value}/${parts[2].value}/${parts[4].value}`;
                    $("#ceditnote_date").val(formattedDate)
                }
            }
...
@include('om.creditnote._script_credit_other_export')
@stop
