    ...
    <table class="table table-bordered">
        <thead>            
            <tr>
                ...
                <th class="text-center">เงื่อนไขการขนส่ง</th>
        ...
        <tbody> 
            @foreach ($terms as $term)
                <tr>    
                    {{-- {{dd(urlencode("/om/settings/term-export/{$term->term_name}/edit"))}}                 --}}
                    <td> {{ $term->term_name }} </td>
                    <td> {{ $term->description }} </td>
                    <td> {{ $term->shipment_condition }} </td>
                    ...
                    <td align="center">
                        @if (canEnter('/om/settings/term-export'))
                            {{-- <a href="{{urlencode("/om/settings/term-export/{$term->term_name}/edit")}}" class="btn btn-warning btn-xs">
                                <i class="fa fa-edit m-r-xs"></i> แก้ไข
                            </a> --}}
                            <a href="{{ route('om.settings.term-export.edit', $term->term_name) }}" class="btn btn-warning btn-xs">
                                <i class="fa fa-edit m-r-xs"></i> แก้ไข
                            </a>
                            {{-- <a href="{{ route('om.settings.term-export.edit', $term->term_name) }}" class="btn btn-warning btn-xs">
                                <i class="fa fa-edit m-r-xs"></i> แก้ไข
