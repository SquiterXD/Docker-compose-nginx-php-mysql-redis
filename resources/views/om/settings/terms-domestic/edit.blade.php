        ...
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    {!! Form::open(['route' => ['om.settings.term.update', $term->term_name] , "method" => "post" , "autocomplete" => "off", 'class' => 'form-horizontal']) !!}
                        @method('PUT')                        
                        
                        {{-- @include('om.settings.country._form') --}}

                        <payment-term-form :default-value="{{ json_encode($term) ?? []}}"> </payment-term-form>
