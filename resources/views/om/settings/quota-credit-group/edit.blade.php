        ...
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    {!! Form::open(['route' => ['om.settings.quota-credit-group.update', $quotaCreditGroup->quota_credit_id] , "method" => "post" , "autocomplete" => "off", 'class' => 'form-horizontal']) !!}
                    @method('PUT')
                    <quota-credit-group-form 
                        :default-value="{{ json_encode($quotaCreditGroup)}}"
                        :items="{{json_encode($items)}}"
                        :quota-groups="{{json_encode($quotaGroups)}}"
                    ...
                    <div class="col-12 mt-3">
                        ...
                        <div class="row clearfix m-t-lg text-right">
                            <div class="col-sm-12">
                                ...
                                <a href="{{ route('om.settings.quota-credit-group.index') }}" type="button" class="btn btn-sm btn-warning"> <i class="fa fa-times"></i> ยกเลิก </a> --}}

                                <button class="btn btn-sm {{ trans('btn')['save']['class'] }}" type="submit"> 
                                    <i class="{{ trans('btn')['save']['icon'] }}"></i> 
                                    {{ trans('btn')['save']['text'] }} 
                                </button>
                                <a href="{{ route('om.settings.quota-credit-group.index') }}" type="button" class="btn btn-sm {{ trans('btn')['cancel']['class'] }}"> 
