        ...
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    {!! Form::open(['route' => ['om.settings.over-quota-approval.update', $overQuotaApproval->over_quota_id] , "method" => "post" , "autocomplete" => "off", 'class' => 'form-horizontal']) !!}
                    @method('PUT')
                    
                    <over-quota-approval-form 
                        :autho-rity-lists="{{json_encode($authoRityLists)}}"
                        :old="{{ json_encode(Session::getOldInput()) }}"
                        :default-value="{{ json_encode($overQuotaApproval)}}"
                        >
                    </over-quota-approval-form>
                    ...
                    <div class="col-12 mt-3">
                        ...
                        <div class="row clearfix m-t-lg text-right">
                            <div class="col-sm-12">
                                ...
                                <a href="{{ route('om.settings.over-quota-approval.index') }}" type="button" class="btn btn-sm btn-warning"> <i class="fa fa-times"></i> ยกเลิก </a> --}}
