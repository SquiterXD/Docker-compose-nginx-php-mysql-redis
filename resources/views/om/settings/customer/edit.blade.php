        ...
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    {!! Form::open(['route' => ['om.settings.customer.update', $customer->customer_approval_id] , "method" => "post" , "autocomplete" => "off", 'class' => 'form-horizontal']) !!}
                        @method('PUT') 

                        <customer-form :default-value="{{ json_encode($customer)}}"
