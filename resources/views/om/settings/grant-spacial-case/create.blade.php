        ...
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    {!! Form::open(['route' => ['om.settings.grant-spacial-case.store'] , "method" => "post" , "autocomplete" => "off", 'class' => 'form-horizontal']) !!}
                    ...
                    <div class="col-12 mt-3">
                        ...
                        <div class="row clearfix m-t-lg text-right">
                            <div class="col-sm-12">
                                ...
                                <a href="{{ route('om.settings.grant-spacial-case.index') }}" type="button" class="btn btn-sm btn-warning"> <i class="fa fa-times"></i> ยกเลิก </a> --}}

                                <button class="btn btn-sm {{ trans('btn')['save']['class'] }}" type="submit"> 
                                    <i class="{{ trans('btn')['save']['icon'] }}"></i> 
                                    {{ trans('btn')['save']['text'] }} 
                                </button>
                                <a href="{{ route('om.settings.grant-spacial-case.index') }}" type="button" class="btn btn-sm {{ trans('btn')['cancel']['class'] }}"> 
