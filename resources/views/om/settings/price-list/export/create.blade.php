        ...
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    {{-- {!! Form::open(['route' => ['om.settings.price-list-export.store'] , "method" => "post" , "autocomplete" => "off", 'class' => 'form-horizontal']) !!} --}}
                    ...
                    <price-list-export-form 
                            ...
                            :url-save="{{ json_encode(route('om.settings.price-list-export.store')) }}"
