    ...
    <table class="table table-bordered">
        <thead>            
            <tr>
                ...
                <th class="text-center">หมายเหตุรายการ</th>
                <th></th>
            </tr>
        </thead>
        <tbody> 
            @foreach ($headers as $header)
                <tr>                    
                    ...
                    <td align="center"> 
                        {{ $header->effective_dates_from ? parseToDateTh($header->effective_dates_from) : '' }}
                        {{-- {{ $header->effective_dates_from ? date(trans('date.format-date'),strtotime($header->effective_dates_from)) : '' }}  --}}
                    </td>
                    <td align="center"> 
                        {{ $header->effective_dates_to ? parseToDateTh($header->effective_dates_to) : '' }}
                    ...
                    <td class="text-center">
                        <a href="{{ route('om.settings.price-list.show', $header->list_header_id) }}" class="btn btn-white btn-xs">
                            <i class="fa fa-file-text-o"></i> รายละเอียด
                        </a>
                        <a href="{{ route('om.settings.price-list.edit', $header->list_header_id) }}" class="btn btn-warning btn-xs">
