        ...
        <div class="subpage smallgap">
            <div class="border">
                ...
                <div style="padding-top: 85px;">
                    @if ($proformaData->percentage_rate != 0 && $proformaData->payment_type_code == 10)
                        <h2 class="report-title angsanaUPC">INVOICE</h2>
                    @else
                        <h2 class="report-title angsanaUPC">INVOICE / TAX INVOICE</h2>
                    @endif
                </div>
                ...
                <table class="table-report-foreign text-xs table1">
                            ...
                            <div class="d-block pl-2">
                                <p>
                                    ...
                                    @if ((!empty($proformaData->ship_city) || !empty($proformaData->ship_district) || !empty($proformaData->ship_province_name)) && $proformaData->ship_country_code == 'TH')
                                        <br>{{ !empty($proformaData->ship_district) ? $proformaData->ship_district.', ' : '' }} 
                                            {{ !empty($proformaData->ship_city) ? $proformaData->ship_city.', ' : '' }} 
                                            {{ !empty($proformaData->ship_province_name) ? $proformaData->ship_province_name.', ' : '' }}
                                    @endif
                                    <br>{{ !empty($proformaData->ship_country_name) ? $proformaData->ship_country_name : '' }} 
                                        {{ !empty($proformaData->ship_postal_code) ? ', ' . $proformaData->ship_postal_code : '' }}</p>
                            </div>
                        </td>
                        <td>
                            <p class="title">No.</p>
                            <div class="d-block text-center">
                                <p>{{ !empty($proformaData) ? $proformaData->pick_release_no : '' }}</p>
                            </div>

                            {{-- <p class="">Status.</p>
                            <div class="d-block text-center">
                                <p>{{ !empty($proformaData) ? $proformaData->pick_release_status : '' }}</p>
                            </div> --}}
                        </td>
                        <td>
                            <p class="title">Date</p>
                            <div class="d-block text-center">
                                <p>{{ !empty($proformaData) ? $proformaData->pick_release_approve_date : '' }}</p>
                            </div>
                        </td>
                    </tr>
                    {{-- <tr>
                        <td>
                            <div class="d-block text-center">
                                <p>Ref. PI No.{{ !empty($proformaData) ? $proformaData->pi_number : '' }}</p>
                            </div>
                        </td>
                        <td>
                            <div class="d-block text-center">
                                <p>DATE : {{ !empty($proformaData) ? $proformaData->pi_date : '' }}</p>
                            </div>
                        </td>
                    </tr> --}}
                    <tr>
                    ...
                    <tr>
                        <td colspan="2" rowspan="3">
                            ...
                            <div class="d-block pl-2">
                                <p>
                                    {{ !empty($proformaData->customer_name) ? $proformaData->customer_name : '' }}<br>
                ...
                <table class="table-report-foreign text-xs table3">
                    ...
                    <tr>
                        ...
                        <td colspan="2" style="border-left: none;">
                            <p class="title ml-2">ON BEHALF OF<br>TOBACCO AUTHORITY OF THAILAND</p>
                            <div class="signature ml-2"></div>
                ...
                <p class="text-center">NOTE : ALL FOREIGN BANK CHARGES INCLUDING COSTS OF POSTAGE OR WIRING WILL BE BORNE BY APPLICANT </p>
