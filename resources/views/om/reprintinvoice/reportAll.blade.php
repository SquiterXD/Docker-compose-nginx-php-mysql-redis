                    ...
                    <td class="" valign="top" style="padding-top: 43px;">
                        ...
                        <table class="font-16" style="margin-top: 13px;">
                            <tr>
                                ...
                                <td class="text-right">
                                    {{ $dataItem['order']->source_system == 'E-commerce' || $dataItem['order']->source_system == 'E-COMMERCE' ? $dataItem['order']->order_number : $dataItem['order']->remark_source_system }}
                                </td>
                                <td style="text-left headers-send">
                            ...
                            <tr style="margin-top:-6mm">
                                ...
                                <td class="text-right headers-send" colspan="2">
                                    {{ ($dataItem['order']->cust_po_number)}} <br>
                                    {{ $dataItem['order']->ship_to_site_name }}
                                </td>
