                    ...
                    <table class="header-company" style="width: 100%;">
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <span class="line-height-address" style="padding-left: 10px;display: block;">{{ $dataItem['order']->s_province_code == '10' ? $dataItem['order']->s_district : "ตำบล".$dataItem['order']->s_district  }} {{ $dataItem['order']->s_city }}</span>
                                <span class="line-height-address" style="padding-left: 10px;display: block;">{{ $dataItem['order']->s_province_code == '10' ? $dataItem['order']->s_province_name : "จังหวัด".$dataItem['order']->s_province_name}} {{ $dataItem['order']->s_postal_code }} <span class="company_phone"> {{ !empty($dataItem['order']->contact_phone) ? 'T. '.$dataItem['order']->contact_phone : '' }}</span></span>
                                ...
                                <span class="line-height-address" style="padding-left: 10px;display: block;">{{ $dataItem['order']->province_code == '10' ? $dataItem['order']->district : "ตำบล".$dataItem['order']->district }} {{ $dataItem['order']->city }}</span>
                                <span class="line-height-address" style="padding-left: 10px;display: block;">{{ $dataItem['order']->province_code == '10' ? $dataItem['order']->province_name : "จังหวัด".$dataItem['order']->province_name }} {{ $dataItem['order']->postal_code }} <span class="company_phone"> {{ !empty($dataItem['order']->contact_phone) ? 'T. '.$dataItem['order']->contact_phone : '' }}</span></span>
                                @endif
                            </td>
                        </tr>
                        <tr>
