...
<form action='{{route("om.order.prepare.create.submit")}}' method="POST" id='create_prepare'>
    {{csrf_field()}}

    <div class="ibox">
        <div class="ibox-title">
            <h3>สร้างใบเตรียมการขาย - บุหรี่</h3>
        </div>
                ...
                <div class="col-12">
                    <div class="form-header-buttons">
                        <div class="buttons multiple">
                            <button class="btn btn-md btn-success" type="button" onclick='document.getElementById("create_prepare").submit()'><i class="fa fa-plus"></i> สร้าง</button>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    <input type="text" class="form-control" name="order_no" placeholder="เลขที่ใบสั่งซื้อ" value="">
                                    <i class="fa fa-search"></i>
                                </div>
                            </div>
                        </div><!--col-->
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="customer_po" placeholder="เลขที่ PO ของลูกค้า" value="">
                            </div>
                        </div><!--col-->
                                ...
                                <div class="row space-5 align-items-center">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-icon">
                                            ...
                                            <i class="fa fa-search"></i>  --}}
                                            <select class="custom-select" name='show_order_status'>
                                    ...
                                    <div class="col-md-6 mt-2 mt-md-0">
                                        <div class="i-checks f13"><label><div class="icheckbox_square-green disabled"><input type="checkbox" value="option_d1" name="a" disabled="" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div></label></div>
                                    </div>
                                </div><!--row-->
                            </div>
                        </div><!--col-->
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="note_system" placeholder="" value="">
                            </div>
                        </div><!--col-->
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group mw-100">
                                ...
                                <div class="input-icon">
                                    <input type="text" class="form-control date" name="order_date" placeholder="" value="" disabled>
                                    <i class="fa fa-calendar"></i>
                                </div>
                            </div>
                        </div><!--col-->
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    <input type="text" class="form-control date" name="ship_date" placeholder="" value="">
                                    <i class="fa fa-calendar"></i>
                                </div>
                            </div>
                        </div><!--col-->
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group mw-100">
                                ...
                                <div class="row space-5">
                                    <div class="col-8">
                                        <input type="text" class="form-control" name="year" id='year' placeholder="" value="" readonly>
                                    </div>
                                    <div class="col-4">
                                        <input type="text" class="form-control" name="period" id='period' placeholder="" value="" readonly>
                                    </div>
                                </div><!--row-->
                            </div>
                        </div><!--col-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    <select class="custom-select" name='order_type'>
                                        ...
                                        <option value='{{$type->order_type_id}}'>{{$type->description}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    <input type="text" class="form-control" id='bill_to' placeholder="" value="" readonly>
                        ...
                        <div class="col-xl-9">
                            <div class="form-group mw-100">
                                ...
                                <input type="text" class="form-control" name="note" placeholder="" value="">
                            </div>
                        </div><!--col-->
...
<script>
        ...
        $('#addline').click(()=>{
            ...
            html += `
                                <tr class="align-middle" name='line${i}' id='line${i}'>
                                    ...
                                    <td class="text-right" id='item_price${i}' name='item_price${i}'>2,740.00</td>
                                    <td class="text-right" id='item_amount${i}' name='item_amount${i}'>10,960.00</td>
                                    <td class="text-right" id='item_all_quota${i}' name='id='item_all_quota${i}'>1,000.00</td>

                                    <td class="text-right" id='item_remaining_quota${i}' name='item_remaining_quota${i}'>996.00</td>

                                    <td class="text-right" id='item_remaining${i}' name='item_remaining${i}'>1050</td>
    ...
    function approve() {
        // $('#status_confirm').prop("selected", true);
        // console.log('approving...')
        // document.getElementById('status_confirm').selected = 'selected'
        // $('#status_confirm').val('Confirm')
        // $('#order_status').val('Confirm')
        $('#order_status').val('Confirm')
        document.getElementById('create_prepare').submit()
    }
</script>
