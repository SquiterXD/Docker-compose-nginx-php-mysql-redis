<div>
    <table>
        ...
        <tr>
            <th style="text-align: center; font-size: 16px;" colspan="14"><strong>ปี : {{ $header->year + 543}} ณ วันที่ : {{ parseToDateTh($header->start_addition_date) }} - {{ parseToDateTh($header->end_addition_date) }}</strong></th>
        </tr>
    </table>
    <table class="table table-responsive-sm table-bordered" style="border: 1px solid #000000;">
        <thead>
            <tr>
                ...
                <th style="border: 1px solid #000000; text-align: center; vertical-align: middle;"><strong>Transaction Amount <br>จำนวนเงิน (บาท)</strong></th>
                <th style="border: 1px solid #000000; text-align: center; vertical-align: middle;"><strong>Coverage Amount <br>มูลค่าทุนประกัน เพิ่ม/ลด</strong></th>
                <th style="border: 1px solid #000000; text-align: center; vertical-align: middle;"><strong>Premium <br>ค่าเบี้ยประกัน เพิ่ม/ลด</strong></th>
                ...
                <th style="border: 1px solid #000000; text-align: center; vertical-align: middle;"><strong>Net Amount <br>ค่าเบี้ยประกัน เพิ่ม/ลดสุทธิ</strong></th>
        ...
        <tbody>
            @foreach ($datas as $data)
                ...
                <tr>
                    ...
                    <td style="border: 1px solid #000000; text-align: center;">{{ $data->cat_segment4 }}</td>
                    <td style="border: 1px solid #000000;">{{ $data->cat_segment4_desc }}</td>
                    <td style="border: 1px solid #000000; text-align: center;">{{ number_format($data->original_quantity, 2) }}</td>
