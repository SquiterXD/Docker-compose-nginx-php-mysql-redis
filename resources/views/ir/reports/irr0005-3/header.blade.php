...
<body style="border:0; margin: 0;" onload="subst()">
    <div class="row col-lg-12">
        ...
        <div class="flexrow">
            ...
            <div style="width: 450px; text-align: center;" width="40%"><strong>รายงานรถยนต์สิ้นอายุกรมธรรม์</strong></div>
            <div style="width: 250px; text-align: right;" width="30%"><strong> เวลา : </strong> {{ date('H:i') }}</div>
        </div>

        <div class="flexrow">
            <div style="width: 250px;" width="30%"> </div>
            <div style="width: 450px; text-align: center;" width="40%"><strong>เดือน {{ $thaimonths[date('m', strtotime($month))]}}  {{ date('Y', strtotime($month))+543 }}</strong></div>
        ...
        <div class="flexrow" >
            ...
            <div style="text-align: center;"> รายงานรถยนต์สิ้นอายุกรมธรรม์ </div>
