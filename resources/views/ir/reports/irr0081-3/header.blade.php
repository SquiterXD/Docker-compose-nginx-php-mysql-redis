...
<body style="border:0; margin: 0;" onload="subst()">
    <div class="row col-lg-12">
        ...
        <div class="flexrow">
            ...
            <div style="width: 450px; text-align: center;" width="40%"><strong>รายงานดุลค่าเบี้ยประกันภัยสินค้า ประจำเดือน {{ $thaimonths[date('m', strtotime($month))]}}  {{ date('Y', strtotime($month))+543 }}</strong></div>
        ...
        <div class="flexrow">
            ...
            <div style="width: 450px; text-align: center;" width="40%">
                <strong>
                    ตั้งแต่วันที่ {{ date('d', strtotime($start_date)) }} {{ $thaimonths[date('m', strtotime($start_date))]}}   {{ date('Y', strtotime($start_date))+543 }}
                    ถึงวันที่ {{ date('d', strtotime($end_date)) }} {{ $thaimonths[date('m', strtotime($end_date))]}}   {{ date('Y', strtotime($end_date))+543 }} </strong>
                </div>
