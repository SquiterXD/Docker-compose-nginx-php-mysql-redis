    ...
    <div class="page-break">
        ...
        <table class="table" >
            <thead>
                ...
                <tr style="background-color: #c4c4c4; border-top: 1px solid #000;border-bottom: 1px solid #000;height:50px;font-weight:bold;">
                    ...
                    <th style="border-right:1px solid #000;text-align:center;font-weight:bold;">มูลค่าทุนประกัน<br>เพิ่ม(ลด) (บาท) {{ $comp_percent }}%</th>
                    <th style="border-right:1px solid #000;text-align:center;font-weight:bold;">อัตราเบี้ย<br>ประกัน</th>
                    <th style="border-right:1px solid #000;text-align:center;font-weight:bold;min-width:60px;">ระยะเวลาตั้งแต่-สิ้นสุด</th>
                    <th style="border-right:1px solid #000;text-align:center;font-weight:bold;">วัน/<br>{{ $days_left }}</th>
                    <th style="border-right:1px solid #000;width:150px;text-align:center;font-weight:bold;">ค่าเบี้ยประกัน<br>เพิ่ม(ลด) (บาท)<br>{{ $insur_percent }}%</th>

                    <th style="border-right:1px solid #000;width:150px;text-align:center;font-weight:bold;">คำนวน<br>ปิดบัญชี<br>เพิ่ม(ลด) (บาท)</th>
                    @foreach($months as $month)
                    <th style="border-right:1px solid #000;width:150px;text-align:center;font-weight:bold;">ค่าเบี้ย<br>เฉลี่ย<br>{{ $month->mth_th }}</th>
                    @endforeach
            ...
            @if(count($company)>0)
                ...
                <tr style="height:25px;">
                    ...
                    @endforeach
                <!-- sub total -->
                <tr style="background-color:#f3f3f3; border-bottom:1px solid #000;border-top:1px solid #000;height:25px;font-weight:bold;">
                    <td style="border-right:1px solid #000;border-left:1px solid #000;"></td>
                    ...
                    <td style="border-right:1px solid #000;text-align: right;font-weight:bold;">{{ $lines->max("date_f") }} - {{ $lines->max("date_t") }}</td>
                    <td style="border-right:1px solid #000;text-align: right;font-weight:bold;">{{ number_format($lines->max("days_left"),0) }}</td>
                ...
                @endforeach
                <!--  Grand Total -->
                <tr style="background-color:#f3f3f3; border-bottom:1px solid #000;height:30px;font-weight:bold;">
                    ...
                    <td style="border-right:1px solid #000;text-align: right;font-weight:bold;">{{ $company->max("date_f") }} - {{ $company->max("date_t") }}</td>
                    <td style="border-right:1px solid #000;text-align: right;font-weight:bold;">{{ number_format($company->max("days_left"),0) }}</td>
