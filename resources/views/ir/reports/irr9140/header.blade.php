...
<head>
    ...
    <title>รายงานการเรียกชดใช้ค่าเสียหายจากบริษัทประกันภัย</title>
...
<body style="border:0; margin: 0;" onload="subst()">
    ...
    <div class="row col-lg-12">
        ...
        <div class="flexrow">
            ...
            <div style="text-align: center;"> รายงานการเรียกชดใช้ค่าเสียหายจากบริษัทประกันภัย ประจำปี {{ $year+543 }} </div>
