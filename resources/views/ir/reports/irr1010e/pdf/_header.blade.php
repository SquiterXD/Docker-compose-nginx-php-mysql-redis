    ...
    <div class="row">
        <div  style=" width:20%;"> <h3> </h3> </div>
        <div style="width:60%;" align="center"> <h3> {{  $programCode == 'IRR1010' ? 'รายงานมูลค่าประกัน (Inventory) รายเดือน' : 'เปลี่ยนชื่อรายงานเป็น ข้อมูลมูลค่าทุนประกัน (Inventory) รายปี'}}</h3> </div>
