...
<html>
    ...
    @endphp
    <body>
        @foreach ($assetsByPolicy->groupBy('policy_set_number') as $policyNumber => $assets)
        <table>
            @php
                ...
                $companies    = $assets->where('company_name','!=', null )->unique('company_name')->pluck('company_name');
            @endphp
            <thead>
                <tr>
