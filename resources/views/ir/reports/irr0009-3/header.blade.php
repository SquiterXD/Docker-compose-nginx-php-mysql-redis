...
<body style="border:0; margin: 0;" onload="subst()">
    <div class="row col-lg-12">
        ...
        <div class="flexrow">
            ...
            <div style="width: 450px; text-align: center;" width="40%"><strong>รายงานดุลค่าเบี้ยประกันภัยสถานีน้ำมัน ประจำเดือน {{ $thaimonths[date('m', strtotime($month))]}}  {{ date('Y', strtotime($month))+543 }}</strong></div>
