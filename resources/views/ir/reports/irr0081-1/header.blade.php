...
<body style="border:0; margin: 0;" onload="subst()">
    <div class="row col-lg-12">
        ...
        <div class="flexrow">
            <div width="20%"><strong> สั่งพิมพ์ : </strong> {{ \Auth::user()->name }}</div>
            <div style="text-align: center;">
                <strong>
                    รายงานรายละเอียดส่วนเฉลี่ยค่าเบี้ยประกันภัยความเสี่ยงภัยสินค้า ประจำเดือน โดยการประกันแบบ Declarative Policy
                </strong>
            </div>
        ...
        <div class="flexrow">
            ...
            <div style="width: 450px; text-align: center;" width="40%">
                <strong>
                    ประจำเดือน {{ $thaimonths[date('m', strtotime($month))]}}  {{ date('Y', strtotime($month))+543 }}
                </strong>
            </div>
            <div style="width: 250px; text-align: right;" width="30%">
