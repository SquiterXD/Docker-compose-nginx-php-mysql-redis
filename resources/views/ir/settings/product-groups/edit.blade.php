        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-title">
                    <h5><x-get-program-code url="/ir/settings/product-groups" />: ข้อมูลกลุ่มสินค้าคงคลัง</h5>
                </div>
                <div class="ibox-content">
                    {!! Form::open(['route' => ['ir.settings.product-groups.update'] , "method" => "post" , "autocomplete" => "off", 'class' => 'form-horizontal']) !!}
                        <group-products-edit-componies  :policy-set-headers = "{{ json_encode($policySetHeaders) }}"
