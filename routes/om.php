...
//test
use App\Http\Controllers\OM\TomTest\TomTestController;
//end test
...
//test 
Route::get('tom-test/{id?}',function($id){
    return 'tom welcome id : '.$id;
});
// Route::get('tomview',function(){
//     return view('om.tomtest.index');
// });
Route::get('tomview', [TomTTestController::class,'index']);
//end test 
