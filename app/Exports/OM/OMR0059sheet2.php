...
class OMR0059sheet2  extends DefaultValueBinder implements WithCustomValueBinder, FromView, WithColumnWidths, WithColumnFormatting
{
    ...
    public function view(): View
    {
        ...
        return view(
            'om.reports.omr0059.excel.sheet2'
            ,$this->compact
        );
    }
