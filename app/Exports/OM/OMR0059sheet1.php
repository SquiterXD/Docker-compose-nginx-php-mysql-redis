...
class OMR0059sheet1  extends DefaultValueBinder implements WithCustomValueBinder, FromView, WithColumnWidths, WithColumnFormatting
{
    ...
    public function view(): View
    {
        ...
        return view(
            'om.reports.omr0059.excel.index'
            ,$this->compact
        );
    }
