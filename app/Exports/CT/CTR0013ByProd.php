...
class CTR0013ByProd implements FromView, ShouldAutoSize, WithColumnFormatting
{
    ...
    public function view(): View
    {
        ...
        $sql  = "
            declare
                rpt_id number;
            begin
                ptct_report_pkg.CTR0013_PROD (P_YEAR         => '$year'
        ...
        // $datas = PtctCtr0013V::where('rpt_id', $result['rpt_id'])->where('batch_no', '66MG601015')->orderByRaw("item_number, batch_no, organization_code")->get();
        ...
        return  view('ct.Reports.ctr0013.excel.prod.index',compact(
                                    'datas'
                                    ,'nowDateTh'
                                    ,'P_REPORT_TYPE'
                                    ,'REPORT_TYPE'
