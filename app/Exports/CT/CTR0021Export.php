...
class CTR0021Export extends \PhpOffice\PhpSpreadsheet\Cell\StringValueBinder implements FromView, WithStyles, WithCustomValueBinder
{
    ...
    public function view(): View
    {
        ...
        return view('ct.reports.ctr0021.export', compact(
            'programCode',
            'reportDate',
            'reportTime',
            'periodYearTh',
