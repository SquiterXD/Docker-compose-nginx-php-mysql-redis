...
class DefineTestsPacketAirLeaksController extends Controller
{
    ...
    {  
        ...
        $btnTrans = trans('btn');
        return  view('qm.settings.define-tests-packet-air-leaks.index',
    ...
    public function create()
    {
        ...
        $testTypeCode = '5';
        $btnTrans = trans('btn');                                
        return  view('qm.settings.define-tests-packet-air-leaks.create',
                compact('units', 'dataTypes', 'resultSeverites', 'btnTrans', 'testTypeCode'));
    }

    public function store(Request $request)
    {
        $profile = getDefaultData('/qm/settings/define-tests-packet-air-leaks');
        ...
        return redirect()->route('qm.settings.define-tests-packet-air-leaks.index')->with('success','ทำการเพิ่มรายการเรียบร้อยแล้ว');
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('qm.settings.define-tests-packet-air-leaks.index')->with('success','เปลี่ยนแปลงข้อมูลเรียบร้อยแล้ว');
    }
}
