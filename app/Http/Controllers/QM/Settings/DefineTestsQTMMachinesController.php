...
class DefineTestsQTMMachinesController extends Controller
{
    ...
    { 
        ...
        $btnTrans = trans('btn');
        return  view('qm.settings.define-tests-qtm-machines.index',
    ...
    public function create()
    {
        ...
        $btnTrans = trans('btn');    
        $testTypeCode = '3';                            
        return  view('qm.settings.define-tests-qtm-machines.create',
                compact('units', 'dataTypes', 'resultSeverites', 'btnTrans', 'testTypeCode'));
    }

    public function store(Request $request)
    {
        $profile = getDefaultData('/qm/settings/define-tests-qtm-machines');
        ...
        return redirect()->route('qm.settings.define-tests-qtm-machines.index')->with('success','ทำการเพิ่มรายการเรียบร้อยแล้ว');
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('qm.settings.define-tests-qtm-machines.index')->with('success','เปลี่ยนแปลงข้อมูลเรียบร้อยแล้ว');
    }
}
