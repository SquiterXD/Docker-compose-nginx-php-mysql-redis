...
class IRR6050PController extends Controller{
	public function export($programCode, $request){
        ...
        $tb_set="
            ...
            WHERE program_code='IRP0003' and POLICY_SET_HEADER_ID='{$s_set}'
        ";
        ...
        $tb_view="
            ...
            WHERE l.program_code='IRP0003' and NVL(l.ASSET_STATUS,'')='Y'
                ...
                and l.year='{$s_period}'
                {$sql_con}
            GROUP BY {$comp_name},{$comp_percent},{$insur_percent},l.department_name,l.location_name,l.CATEGORY_DESCRIPTION
            order by {$comp_name},{$comp_percent},{$insur_percent},l.location_name,l.department_name,l.CATEGORY_DESCRIPTION
        ";
        ...
        $pdf = PDF::loadView('ir.reports.irr6050p.pdf.index',compact('data','titles','months','repTitle','programCode','progTitle','progPara','status','remark'))
