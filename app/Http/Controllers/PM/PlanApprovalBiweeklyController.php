...
class PlanApprovalBiweeklyController extends BaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('pm.plans.approvals.biweekly.index', compact('periodYears', 'planStatuses', 'printTypes', 'saleTypes', 'uomCodes', 'searchInputs'));
