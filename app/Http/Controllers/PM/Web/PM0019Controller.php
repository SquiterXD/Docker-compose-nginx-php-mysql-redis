...
class PM0019Controller extends BaseController
{
    ...
    {
        $lookups = DB::select("select a.period_year, a.period_name
            , b.period_year + 543 as thai_year --, b.thai_year
            , trim(b.thai_month) thai_month, a.biweekly, b.biweekly_id, to_char(b.start_date, 'YYYY-MM-DD') start_date, to_char(b.end_date, 'YYYY-MM-DD') end_date
        ...
        if (count($defPeriodData) > 0) {
            $defPeriodYear = $defPeriodData->first()->period_thai_year;
        }
