    ...
    public function detail()
    {
        ...
        try {
            ...
            if ($step > 0) {
                ...
                $html = view('mobile.pm.qrcode-return-mtls._detail_html', compact(
                ...
                if ($step == 7) {
                    ...
                    $planDate       = ($currentData->return_date);
        ...
        try {
            ...
            // $html = view('mobile.pm.qrcode-tranfer-materials._detail_html', compact(
