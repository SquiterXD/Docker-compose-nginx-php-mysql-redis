...
class CreditNoteRanchTransferController extends Controller
{
    public function index()
    {
        $list  = InvoiceHeaderModel::where('program_code','OMP0034')->orderBy('invoice_headers_number','desc')->get();
        ...
        $accont_gl      = MappingAccountModel::where('account_code','10')->first();
        $accont_cr_gl   = MappingAccountModel::where('account_code','13')->first();
        ...
        return view('om.creditnote.ranch_transfer',compact('segment','account_mapping','accont_gl','buget_year_segment','accont_cr_gl','list'));
    }
}
