...
class FNDListOfValues extends Model
{
    ...
    public function scopeCompany($query,$orgId = null)
    {
        $flexValueSetName = self::getFlexNameByAppColumnName('SEGMENT1',$orgId);
        return $query->where('flex_value_set_name',$flexValueSetName)->enabled();
    }

    public function scopeEVM($query,$orgId = null)
    {
    ...
    public function scopeCostCenter($query,$orgId = null)
    {
        $flexValueSetName = self::getFlexNameByAppColumnName('SEGMENT4',$orgId);
        return $query->where('flex_value_set_name',$flexValueSetName)->enabled();
    }

    public function scopeBudgetYear($query,$orgId = null)
    {
        $flexValueSetName = self::getFlexNameByAppColumnName('SEGMENT5',$orgId);
        return $query->where('flex_value_set_name',$flexValueSetName)->enabled();
    }

    public function scopeBudgetType($query,$orgId = null)
    {
        $flexValueSetName = self::getFlexNameByAppColumnName('SEGMENT6',$orgId);
        return $query->where('flex_value_set_name',$flexValueSetName)->enabled();
    }

    public function scopeBudgetDetail($query,$orgId = null)
    {
        $flexValueSetName = self::getFlexNameByAppColumnName('SEGMENT7',$orgId);
        return $query->where('flex_value_set_name',$flexValueSetName)->enabled();
    }

    public function scopeBudgetReason($query,$orgId = null)
    {
    ...
    {
        $flexValueSetName = self::getFlexNameByAppColumnName('SEGMENT10',$orgId);
        return $query->where('flex_value_set_name',$flexValueSetName)->enabled();
    }

    public function scopeReserve1($query,$orgId = null)
    {
        $flexValueSetName = self::getFlexNameByAppColumnName('SEGMENT11',$orgId);
        return $query->where('flex_value_set_name',$flexValueSetName)->enabled();
    }

    public function scopeReserve2($query,$orgId = null)
    {
        $flexValueSetName = self::getFlexNameByAppColumnName('SEGMENT12',$orgId);
        return $query->where('flex_value_set_name',$flexValueSetName)->enabled();
    }
