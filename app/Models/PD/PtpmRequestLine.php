...
/**
 * @property mixed|string REQUEST_LINE_ID
 * @property mixed|string REQUEST_HEADER_ID
 * @property mixed|string CREATED_BY
 * @property mixed|string LAST_UPDATED_BY
 */
class PtpmRequestLine extends Model
{
    use HasFactory, Notifiable;

//        $o = new PtpmRequestLines();
//        $o->REQUEST_LINE_ID = '1';
//        $o->REQUEST_HEADER_ID = '1';
//        $o->CREATED_BY = '1';
//        $o->LAST_UPDATED_BY = '1';
//        $o->save();
