...
class WorkOrderMtReturnInterface
{
    public static function Import($batchNo, $organizationId, $wipEntityId, $operationSeqNum, $inventoryItemId, $lotNo)
    {
        ...
        $sql    =   "
                        ...
                        BEGIN
                        PTEAM_MATERIAL_ISSUE_PKG.RETURN_MATERIAL_ISSUE(
