(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_pd_pages_PD0004_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pd/pages/PD0004.vue?vue&type=script&lang=js&":
/*!***********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pd/pages/PD0004.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _httpClient__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../httpClient */ "./resources/js/pd/httpClient.js");
...
function goToIndex() {
  ...
  window.location = (0,_router__WEBPACK_IMPORTED_MODULE_7__.$route)(_router__WEBPACK_IMPORTED_MODULE_7__.pd_invMaterialItems_index);
}

function redirectTo(inventoryItemId) {
  window.location = (0,_router__WEBPACK_IMPORTED_MODULE_7__.$route)(_router__WEBPACK_IMPORTED_MODULE_7__.pd_invMaterialItems_show, {
...
function createRawMaterialItem(createRawMaterialItem) {
  ...
  return _httpClient__WEBPACK_IMPORTED_MODULE_1__.instance.post((0,_router__WEBPACK_IMPORTED_MODULE_7__.$route)(_router__WEBPACK_IMPORTED_MODULE_7__.api_pd_invMaterialItem_store), {
    'inv_material_item': createRawMaterialItem
  });
}

function updateRawMaterialItem(updateRawMaterialItem) {
  console.debug('updateRawMaterialItem', updateRawMaterialItem); // noinspection JSUnresolvedVariable

  return _httpClient__WEBPACK_IMPORTED_MODULE_1__.instance.put((0,_router__WEBPACK_IMPORTED_MODULE_7__.$route)(_router__WEBPACK_IMPORTED_MODULE_7__.api_pd_invMaterialItem_update, {
...
function searchRawMaterialItem(inventoryItemCode, description, rawMaterialTypeCode) {
  ...
  var route = (0,_router__WEBPACK_IMPORTED_MODULE_7__.$route)(api_pd_invMaterialItem_search) + '?' + new URLSearchParams(searchParams).toString();
  return _httpClient__WEBPACK_IMPORTED_MODULE_1__.instance.get(route);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  props: {
    ...
    existed_items_in_oracle: {
      type: Array
    },
    inv_material_item: {
      type: Object
    },
    raw_material_type_list: {
      type: Array
    },
    is_create_new: {
      type: Boolean,
  ...
  data: function data() {
    return {
      ...
      lodash: {
        ...
        isEqual: (lodash_isEqual__WEBPACK_IMPORTED_MODULE_3___default()),
        cloneDeep: (lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_4___default())
      },
      preventUnload: _utils__WEBPACK_IMPORTED_MODULE_6__.preventUnload,
      invMaterialItemModel: lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_4___default()(this.inv_material_item),
      rawMaterialTypeList: lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_4___default()(this.raw_material_type_list),
      isSearching: false,
      searchModel: {
        rawMaterialTypeCode: '',
        rawMaterialType: '',
      ...
      itemCatCode: '',
      form: {
        raw_material_id: lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(this.inv_material_item, 'raw_material_id'),
        inventory_item_code: lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(this.inv_material_item, 'inventory_item_code'),
        raw_material_type_code: lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(this.inv_material_item, 'raw_material_type_code'),
        raw_material_type: lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(this.inv_material_item, 'raw_material_type'),
        blend_no: lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(this.inv_material_item, 'blend_no'),
        description: lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(this.inv_material_item, 'description')
      },
      ...
      descList: [],
      isCreateNew: lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_4___default()(this.is_create_new),
      loading: false,
      hasDataChange: false,
      maxBlendNoDigit: 5
    };
  ...
  mounted: function mounted() {
    ...
    this.existedItems.forEach(function (existedItem) {
      var isExistsInventoryItemCodeList = _this.dataInventoryItemCodeList.some(function (item) {
        return item.inventory_item_code === existedItem.inventory_item_code;
      });

      if (!isExistsInventoryItemCodeList) {
        _this.dataInventoryItemCodeList.push({
          raw_material_type_code: existedItem.raw_material_type_code,
          inventory_item_code: existedItem.inventory_item_code
        });
      }

      var isExistsDescList = _this.dataDescList.some(function (item) {
        return item.description === existedItem.description;
      });

      if (!isExistsDescList) {
        _this.dataDescList.push({
          raw_material_type_code: existedItem.raw_material_type_code,
  ...
  watch: {
    'form.raw_material_type_code': function formRaw_material_type_code(val) {
      console.log('val', val);
      this.itemCatCode = '10' + val;
      this.existedItemsOnSelectedType = this.existedItems.filter(function (existedItem) {
        return existedItem.raw_material_type_code === val;
      });
    ...
    'form.blend_no': function formBlend_no(val) {
      console.log('val', val);
      this.form.inventory_item_code = "";
  ...
  computed: {},
  methods: {
    onSelectedRawMaterialType: function onSelectedRawMaterialType() {
      var selectedRawMaterialTypeCode = this.searchModel.rawMaterialTypeCode;
      this.inventoryItemCodeList = this.dataInventoryItemCodeList;
      this.descList = this.dataDescList; //filter inventory item code list in search modal

      this.inventoryItemCodeList = this.inventoryItemCodeList.filter(function (item) {
        return item.raw_material_type_code === selectedRawMaterialTypeCode;
      }); //filter description list in search modal

      this.descList = this.descList.filter(function (item) {
        return item.raw_material_type_code === selectedRawMaterialTypeCode;
      });
    },
    ...
    filterByRawMaterialTypeCode: function filterByRawMaterialTypeCode(existedItems) {
      var _this2 = this;
      ...
      return existedItems.filter(function (item) {
        return item.raw_material_type_code === _this2.searchModel.rawMaterialTypeCode.toString();
      });
    },
    filterByInventoryItemCode: function filterByInventoryItemCode(existedItems) {
      var _this3 = this;

      if (!this.searchModel.inventoryItemCode && this.searchModel.inventoryItemCode === '') return existedItems;
      return existedItems.filter(function (item) {
        return item.inventory_item_code === _this3.searchModel.inventoryItemCode;
      });
    },
    filterByDescription: function filterByDescription(existedItems) {
      var _this4 = this;

      if (!this.searchModel.description && this.searchModel.description === '') return existedItems;
      return existedItems.filter(function (item) {
        return item.description === _this4.searchModel.description;
      });
    },
    onClickItem: function onClickItem(rawMaterialId) {
      var _this5 = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.t0 = _this5.hasDataChange;
                ...
                _context.next = 4;
                return (0,_commonDialogs__WEBPACK_IMPORTED_MODULE_5__.showSimpleConfirmationDialog)('มีการเปลี่ยนแปลงข้อมูลโดยที่ยังไม่ได้บันทึก ต้องการออกจากหน้านี้?');
              ...
              case 7:
                ...
                (0,_utils__WEBPACK_IMPORTED_MODULE_6__.cancelPreventUnload)();
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.t0 = _this6.hasDataChange;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 3:
                ...
                if (!_this7.isCreateNew) {
                  // update existing data
                  console.log('updated', _this7.form);
                  updateRawMaterialItem(_this7.form).then(function (_ref) {
                    var data = _ref.data;
                    console.debug('updateRawMaterialItem(update) success', data);

                    _this7.setNewData(data);

                    _this7.hasDataChange = false;
                    (0,_utils__WEBPACK_IMPORTED_MODULE_6__.cancelPreventUnload)();
                  }).then(function () {
                    return (0,_commonDialogs__WEBPACK_IMPORTED_MODULE_5__.showSaveSuccessDialog)();
                  })["catch"](function (err) {
                    console.debug('updateRawMaterialItem(update) error', err);
                    return (0,_commonDialogs__WEBPACK_IMPORTED_MODULE_5__.showGenericFailureDialog)(err.toString());
                  });
                } else {
                  console.log('created', _this7.form);
                  createRawMaterialItem(_this7.form).then(function (_ref2) {
                    var data = _ref2.data;
                    console.debug('createRawMaterialItem(create) success', data);
                    _this7.hasDataChange = false;
                    (0,_utils__WEBPACK_IMPORTED_MODULE_6__.cancelPreventUnload)();
                    (0,_commonDialogs__WEBPACK_IMPORTED_MODULE_5__.showSaveSuccessDialog)().then(function () {
                      var inventoryItemId = lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(data, 'inv_material_item.inventory_item_id', null);
                    ...
                    (0,_commonDialogs__WEBPACK_IMPORTED_MODULE_5__.showGenericFailureDialog)(lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(err, 'response.data.v_err_msg', null));
                  });
                }
    ...
    validate: function validate() {
      ...
      if (!this.form.blend_no) {
        ...
        var items = this.existedItemsOnSelectedType.filter(function (item) {
          return item.blend_no === _this8.form.blend_no;
        });
        var itemsInOracle = this.existed_items_in_oracle.filter(function (item) {
          return item.item_number === _this8.form.inventory_item_code;
        });
      ...
      if (errors.length > 0) {
        (0,_commonDialogs__WEBPACK_IMPORTED_MODULE_5__.showValidationFailedDialog)(errors);
        return false;
      }
    ...
    setNewData: function setNewData(newData) {
      ...
      this.descList = [];
      this.existedItems.forEach(function (existedItem) {
        var isExistsDescList = _this9.dataDescList.some(function (item) {
          return item.description === existedItem.description;
        });

        if (!isExistsDescList) {
          _this9.dataDescList.push({
            raw_material_type_code: existedItem.raw_material_type_code,
            description: existedItem.description
          });
        }
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pd/pages/PD0004.vue?vue&type=style&index=0&lang=css&":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pd/pages/PD0004.vue?vue&type=style&index=0&lang=css& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".el-autocomplete-suggestion {\n  z-index: 3000 !important;\n}\n#PD0004 .el-select {\n  width: 100%;\n}\n\n\n", ""]);
// Exports
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_PD0004_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./PD0004.vue?vue&type=style&index=0&lang=css& */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pd/pages/PD0004.vue?vue&type=style&index=0&lang=css&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_PD0004_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_1__.default, options);
...
/***/ "./resources/js/pd/pages/PD0004.vue":
/*!******************************************!*\
  !*** ./resources/js/pd/pages/PD0004.vue ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => __WEBPACK_DEFAULT_EXPORT__
/* harmony export */ });
/* harmony import */ var _PD0004_vue_vue_type_template_id_fcaa5460___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./PD0004.vue?vue&type=template&id=fcaa5460& */ "./resources/js/pd/pages/PD0004.vue?vue&type=template&id=fcaa5460&");
/* harmony import */ var _PD0004_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./PD0004.vue?vue&type=script&lang=js& */ "./resources/js/pd/pages/PD0004.vue?vue&type=script&lang=js&");
/* harmony import */ var _PD0004_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./PD0004.vue?vue&type=style&index=0&lang=css& */ "./resources/js/pd/pages/PD0004.vue?vue&type=style&index=0&lang=css&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__.default)(
  _PD0004_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__.default,
  _PD0004_vue_vue_type_template_id_fcaa5460___WEBPACK_IMPORTED_MODULE_0__.render,
  _PD0004_vue_vue_type_template_id_fcaa5460___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/pd/pages/PD0004.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/pd/pages/PD0004.vue?vue&type=script&lang=js&":
/*!*******************************************************************!*\
  !*** ./resources/js/pd/pages/PD0004.vue?vue&type=script&lang=js& ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => __WEBPACK_DEFAULT_EXPORT__
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_PD0004_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./PD0004.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pd/pages/PD0004.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_PD0004_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__.default); 

/***/ }),

/***/ "./resources/js/pd/pages/PD0004.vue?vue&type=style&index=0&lang=css&":
/*!***************************************************************************!*\
  !*** ./resources/js/pd/pages/PD0004.vue?vue&type=style&index=0&lang=css& ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_PD0004_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/style-loader/dist/cjs.js!../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./PD0004.vue?vue&type=style&index=0&lang=css& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pd/pages/PD0004.vue?vue&type=style&index=0&lang=css&");


/***/ }),

/***/ "./resources/js/pd/pages/PD0004.vue?vue&type=template&id=fcaa5460&":
/*!*************************************************************************!*\
  !*** ./resources/js/pd/pages/PD0004.vue?vue&type=template&id=fcaa5460& ***!
  \*************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_PD0004_vue_vue_type_template_id_fcaa5460___WEBPACK_IMPORTED_MODULE_0__.render,
/* harmony export */   "staticRenderFns": () => /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_PD0004_vue_vue_type_template_id_fcaa5460___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_PD0004_vue_vue_type_template_id_fcaa5460___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./PD0004.vue?vue&type=template&id=fcaa5460& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pd/pages/PD0004.vue?vue&type=template&id=fcaa5460&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pd/pages/PD0004.vue?vue&type=template&id=fcaa5460&":
/*!****************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pd/pages/PD0004.vue?vue&type=template&id=fcaa5460& ***!
  \****************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
              ...
              "button",
              {
                ...
                on: {
                  click: function($event) {
                    ...
                    return _vm.onCreateButtonClicked($event)
                  }
                }
              },
              [
                _c("i", { class: _vm.btn_trans.create.icon }),
                _vm._v(
                  "\n                        " +
                    _vm._s(_vm.btn_trans.create.text) +
                    "\n                    "
                )
              ]
            ),
            ...
            _c(
              "button",
              {
                ...
                attrs: {
                  type: "button",
                  "data-toggle": "modal",
                  "data-target": "#rawMaterialSearchModal"
                }
              },
              [
            ...
            _c("div", { staticClass: "ibox-content" }, [
                    ...
                    _c(
                      "el-select",
                      {
                        attrs: {
                          ...
                          disabled: !_vm.isCreateNew,
                          filterable: ""
                        },
                        on: {
                          change: function(item) {
                            _vm.console.debug(item, item.description)
                            this$1.hasDataChange = true
                            _vm.preventUnload()

                            this$1.form.raw_material_type_code =
                              item.flex_value_meaning
                            this$1.form.raw_material_type = item.description
                          }
                        }
                      },
                      _vm._l(_vm.rawMaterialTypeList, function(item) {
                        return _c("el-option", {
                          key: item.flex_value_meaning,
                          attrs: { label: item.description, value: item }
                        })
                      }),
                      1
                    )
                ...
                _c("div", { staticClass: "col-md-3" }, [
                  _c("input", {
                    ...
                    attrs: {
                      id: "input-blend-no",
                      type: "text",
                      maxlength: _vm.maxBlendNoDigit,
                      disabled: !_vm.isCreateNew
                    },
                    domProps: { value: this.form.blend_no },
                    on: {
                      input: function(event) {
                        _vm.form.blend_no = event.target.value
                        this$1.form = Object.assign({}, _vm.form)
                      },
                      change: function() {
                        _vm.preventUnload()
                        this$1.hasDataChange = true
              ...
              _c("div", { staticClass: "form-group row" }, [
                ...
                _c("div", { staticClass: "col-md-3" }, [
                  _c("input", {
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: this.form.inventory_item_code,
                        expression: "this.form.inventory_item_code"
                      }
                    ],
                    staticClass: "form-control",
                    attrs: {
                    ...
                    domProps: { value: this.form.inventory_item_code },
                    on: {
                      change: function() {
                        _vm.preventUnload()
                        this$1.hasDataChange = true
              ...
              _c("div", { staticClass: "form-group row" }, [
                ...
                _c("div", { staticClass: "col-md-3" }, [
                  _c("input", {
                    staticClass: "form-control",
                    attrs: { id: "input-inv-item-description", type: "text" },
                    domProps: { value: this.form.description },
                    on: {
                      change: function() {
                        _vm.preventUnload()
                        this$1.hasDataChange = true
            ...
            _c("div", [
              _c(
                "div",
                {
                  ...
                  attrs: { id: "rawMaterialSearchModal" }
                },
                [
                  _c(
                    "div",
                          ...
                          _c("form", [
                                  ...
                                  _c(
                                    "el-select",
                                    {
                                      ...
                                      attrs: {
                                        ...
                                        placeholder: "กรุณาเลือกประเภทวัตถุดิบ",
                                        "value-key": "description",
                                        value: _vm.searchModel.rawMaterialType,
                                        filterable: ""
                                      },
                                      on: {
                                        change: function(item) {
                                          ...
                                          this$1.searchModel.rawMaterialTypeCode =
                                            item.flex_value_meaning
                                          this$1.searchModel.rawMaterialType =
                                            item.description
                                          _vm.onSelectedRawMaterialType()
                                        }
                                      }
                                    },
                                    _vm._l(_vm.rawMaterialTypeList, function(
                                      item
                                    ) {
                                      return _c("el-option", {
                                        key: item.flex_value_meaning,
                                ...
                                [
                                  _c(
                                    "el-select",
                                    {
                                      ...
                                      model: {
                                        value:
                                          _vm.searchModel.inventoryItemCode,
                                        callback: function($$v) {
                                          _vm.$set(
                                            _vm.searchModel,
                                            "inventoryItemCode",
                                        ...
                                        expression:
                                          "searchModel.inventoryItemCode"
                                      }
                                    },
                                    _vm._l(this.inventoryItemCodeList, function(
                                      item
                                    ) {
                                      return _c("el-option", {
                                ...
                                [
                                  _c(
                                    "el-select",
                                    {
                                      ...
                                      model: {
                                        value: _vm.searchModel.description,
                                        callback: function($$v) {
                                          _vm.$set(
                                            _vm.searchModel,
                                            "description",
                                        ...
                                        expression: "searchModel.description"
                                      }
                                    },
                                    _vm._l(this.descList, function(item) {
                                      return _c("el-option", {
                            ...
                            _c("div", { staticClass: "form-group row" }, [
                              _c("div", { staticClass: "col-md-12" }, [
                                _c("div", { staticClass: "float-right pr-3" }, [
                                  _c(
                                    "button",
                                    {
                                    ...
                                    [
                                      _c("i", {
                                        class: _vm.btn_trans.reset.icon
                                      }),
                                      _vm._v(
                                        "\n                                                            " +
                                  ...
                                  _c(
                                    "button",
                                    {
                                      ...
                                      on: {
                                        click: function($event) {
                                          $event.preventDefault()
                                          return _vm.submitSearchForm()
                                        }
                                      }
                                    },
                                    [
                                      _c("i", {
                                        class: _vm.btn_trans.search.icon
                                      }),
                                      _vm._v(
                                        "\n                                                            " +
                                          _vm._s(_vm.btn_trans.search.text) +
  ...
  function() {
    ...
    return _c("div", { staticClass: "ibox-title" }, [
      _c("div", { staticClass: "row align-items-center" }, [
        _c("div", { staticClass: "col-sm-12 col-lg-2 align-middle" }, [
          _c("h5", [_vm._v("สร้างรหัสวัตถุดิบ - ยาเส้น")])
        ])
      ])
    ])
  },
