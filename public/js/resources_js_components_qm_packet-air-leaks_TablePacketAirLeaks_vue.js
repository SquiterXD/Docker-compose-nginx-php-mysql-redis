(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_qm_packet-air-leaks_TablePacketAirLeaks_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/qm/packet-air-leaks/TablePacketAirLeaks.vue?vue&type=script&lang=js&":
/*!**********************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/qm/packet-air-leaks/TablePacketAirLeaks.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  props: ["authUser", "showType", "items", "total", "page", "perPage", "machines", "listBrands", "listLeakPositions", "approvalData", "approvalRole"],
  components: {
    ...
    return {
      sampleItems: JSON.parse(this.items).map(function (item) {
        return _objectSpread(_objectSpread({}, item), {}, {
          ...
          machine_description: _this.getMachineDesc(_this.machines, item.qc_area, item.machine_name),
  ...
  methods: {
    ...
    getMachineDesc: function getMachineDesc(machines, qcArea, machineName) {
      var result = "";
      var foundMachineWithQcArea = machines.find(function (item) {
        return item.machine_name == machineName && item.qc_area == qcArea;
      });
      ...
      if (foundMachineWithQcArea) {
        ...
        var foundMachine = machines.find(function (item) {
    ...
    getSampleSpecifications: function getSampleSpecifications(sampleNo, organizationId, inventoryItemId) {
      ...
      return axios.get("/qm/ajax/packet-air-leaks/get-sample-specifications", {
        params: params
      }).then(function (res) {
        var resResults = JSON.parse(res.data.data.results).map(function (item) {
          return _objectSpread(_objectSpread({}, item), {}, {
            position_leak_entered: null,
            position_leak_required: null // position_leak_none: null,
    ...
    // onSampleTestTimeChanged(value, sampleItem){
    //     sampleItem.test_time = value;
    // },
    // onSampleTestTimeClosed(value, sampleItem){
    //     // SHOW LOADING
    //     this.isLoading = true;
    //     const reqBody = {
    ...
    //         test_time: sampleItem.test_time,
    //     };
    //     axios.post(`/qm/ajax/packet-air-leaks/update-sample-test-time`, reqBody)
    //     .then((res) => {
    ...
    //             // swal("Success", `แก้ไขข้อมูลเวลาที่วัด (เลขที่การตรวจสอบ : ${sampleItem.sample_no} )`, "success");
    //         }
    //         if(resData.status == "error") {
    //             swal("Error", `ไม่สามารถแก้ไขข้อมูลเวลาที่วัด (เลขที่การตรวจสอบ : ${sampleItem.sample_no}) | ${resMsg}`, "error");
    //         }
    //     })
    //     .catch((error) => {
    //         console.log(error);
    //         // HIDE LOADING
    //         this.isLoading = false;
    //         swal("Error", `ไม่สามารถแก้ไขข้อมูลเวลาที่วัด (เลขที่การตรวจสอบ : ${sampleItem.sample_no})  | ${error.message}`, "error");
    //     });
    // },
    onSampleResultSubmitted: function onSampleResultSubmitted(data) {
      ...
      if (data.status == "success") {
        ...
        var resSampleTestTime = data.test_time;
        this.sampleItems.forEach(function (element, i) {
          ...
          if (_this3.sampleItems[i].sample_no == resSampleNo) {
            ...
            _this3.sampleItems[i].test_time = resSampleTestTime;
          }
        });
      }
    },
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 4;
                return axios.post("/qm/ajax/packet-air-leaks/approval/approve", reqBody).then(function (res) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 4;
                return axios.post("/qm/ajax/packet-air-leaks/approval/approve-all", reqBody).then(function (res) {
                  var resData = res.data.data;
                  var resMsg = resData.message;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 4;
                return axios.post("/qm/ajax/packet-air-leaks/approval/reject", reqBody).then(function (res) {
                  var resData = res.data.data;
                  var resMsg = resData.message;
                  var resSample = resData.sample ? JSON.parse(resData.sample) : null;
                  var resApprovalStatusCode = resData.approval_status_code ? resData.approval_status_code : "10";
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _context5.next = 4;
                return axios.post("/qm/ajax/packet-air-leaks/approval/return", reqBody).then(function (res) {
                  var resData = res.data.data;
                  var resMsg = resData.message;
                  var resSample = resData.sample ? JSON.parse(resData.sample) : null;
                  var resApprovalStatusCode = resData.approval_status_code ? resData.approval_status_code : "10";
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                _context6.next = 4;
                return axios.post("/qm/ajax/packet-air-leaks/approval/unapprove", reqBody).then(function (res) {
                  var resData = res.data.data;
                  var resMsg = resData.message;
                  var resSample = resData.sample ? JSON.parse(resData.sample) : null;
                  var resApprovalStatusCode = resData.approval_status_code ? resData.approval_status_code : "10";
...
/***/ "./resources/js/components/qm/packet-air-leaks/TablePacketAirLeaks.vue":
/*!*****************************************************************************!*\
  !*** ./resources/js/components/qm/packet-air-leaks/TablePacketAirLeaks.vue ***!
  \*****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => __WEBPACK_DEFAULT_EXPORT__
/* harmony export */ });
/* harmony import */ var _TablePacketAirLeaks_vue_vue_type_template_id_cdf01926___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./TablePacketAirLeaks.vue?vue&type=template&id=cdf01926& */ "./resources/js/components/qm/packet-air-leaks/TablePacketAirLeaks.vue?vue&type=template&id=cdf01926&");
/* harmony import */ var _TablePacketAirLeaks_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./TablePacketAirLeaks.vue?vue&type=script&lang=js& */ "./resources/js/components/qm/packet-air-leaks/TablePacketAirLeaks.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  _TablePacketAirLeaks_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__.default,
  _TablePacketAirLeaks_vue_vue_type_template_id_cdf01926___WEBPACK_IMPORTED_MODULE_0__.render,
  _TablePacketAirLeaks_vue_vue_type_template_id_cdf01926___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/qm/packet-air-leaks/TablePacketAirLeaks.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/components/qm/packet-air-leaks/TablePacketAirLeaks.vue?vue&type=script&lang=js&":
/*!******************************************************************************************************!*\
  !*** ./resources/js/components/qm/packet-air-leaks/TablePacketAirLeaks.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => __WEBPACK_DEFAULT_EXPORT__
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TablePacketAirLeaks_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./TablePacketAirLeaks.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/qm/packet-air-leaks/TablePacketAirLeaks.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TablePacketAirLeaks_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__.default); 

/***/ }),

/***/ "./resources/js/components/qm/packet-air-leaks/TablePacketAirLeaks.vue?vue&type=template&id=cdf01926&":
/*!************************************************************************************************************!*\
  !*** ./resources/js/components/qm/packet-air-leaks/TablePacketAirLeaks.vue?vue&type=template&id=cdf01926& ***!
  \************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_TablePacketAirLeaks_vue_vue_type_template_id_cdf01926___WEBPACK_IMPORTED_MODULE_0__.render,
/* harmony export */   "staticRenderFns": () => /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_TablePacketAirLeaks_vue_vue_type_template_id_cdf01926___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_TablePacketAirLeaks_vue_vue_type_template_id_cdf01926___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./TablePacketAirLeaks.vue?vue&type=template&id=cdf01926& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/qm/packet-air-leaks/TablePacketAirLeaks.vue?vue&type=template&id=cdf01926&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/qm/packet-air-leaks/TablePacketAirLeaks.vue?vue&type=template&id=cdf01926&":
/*!***************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/qm/packet-air-leaks/TablePacketAirLeaks.vue?vue&type=template&id=cdf01926& ***!
  \***************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                      ...
                      _c("tr", { key: sampleItem.sample_no }, [
                        ...
                        _c(
                          ...
                          [
                            _vm._v(
                              "\n                        " +
                                _vm._s(sampleItem.machine_description) +
                                "\n                    "
                            )
                          ]
                        ),
                      ...
                      sampleItem.specification_showed
                        ? _c("tr", { key: sampleItem.sample_no + "_line" }, [
                            _c(
                              ...
                              [
                                _c("qm-table-packet-air-leak-results", {
                                  attrs: {
