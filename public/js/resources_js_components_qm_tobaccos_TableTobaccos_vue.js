(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_qm_tobaccos_TableTobaccos_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/qm/tobaccos/TableTobaccos.vue?vue&type=script&lang=js&":
/*!********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/qm/tobaccos/TableTobaccos.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
    ...
    return {
      sampleItems: JSON.parse(this.items).map(function (item) {
        return _objectSpread(_objectSpread({}, item), {}, {
          ...
          date_drawn_show: item.date_drawn_formatted ? moment__WEBPACK_IMPORTED_MODULE_2___default()(item.date_drawn_formatted).add(543, 'years').format('DD/MM/YYYY') : "",
          locator_desc: _this.getLocatorDesc(item),
          location_full_desc: _this.getLocationFullDesc(item),
  ...
  methods: {
    getLocatorDesc: function getLocatorDesc(item) {
      ...
      var locationFullDesc = foundLocator ? "".concat(foundLocator.locator_desc) : "";
      return locationFullDesc;
    },
    getLocationFullDesc: function getLocationFullDesc(item) {
      var foundLocator = this.locators.find(function (i) {
        return i.inventory_location_id == item.locator_id;
      });
      var locationFullDesc = foundLocator ? "".concat(foundLocator.location_desc ? foundLocator.location_desc : "", " : ").concat(foundLocator.locator_desc ? foundLocator.locator_desc : "") : "";
      return locationFullDesc;
    },
    ...
    onResultButtonClicked: function onResultButtonClicked(sampleNo, organizationId, inventoryItemId, locatorId, event) {
      var _this2 = this;
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.next = 5;
                  return _this2.getSampleSpecifications(sampleNo, organizationId, inventoryItemId, locatorId);
    ...
    getSampleSpecifications: function getSampleSpecifications(sampleNo, organizationId, inventoryItemId, locatorId) {
      var params = {
        sample_no: sampleNo,
      ...
      return axios.get("/qm/ajax/tobaccos/get-sample-specifications", {
        params: params
      }).then(function (res) {
        return {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 4;
                return axios.post("/qm/ajax/tobaccos/approval/approve", reqBody).then(function (res) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 4;
                return axios.post("/qm/ajax/tobaccos/approval/approve-all", reqBody).then(function (res) {
                  var resData = res.data.data;
                  var resMsg = resData.message;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 4;
                return axios.post("/qm/ajax/tobaccos/approval/reject", reqBody).then(function (res) {
                  var resData = res.data.data;
                  var resMsg = resData.message;
                  var resSample = resData.sample ? JSON.parse(resData.sample) : null;
                  var resApprovalStatusCode = resData.approval_status_code ? resData.approval_status_code : "10";
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _context5.next = 4;
                return axios.post("/qm/ajax/tobaccos/approval/return", reqBody).then(function (res) {
                  var resData = res.data.data;
                  var resMsg = resData.message;
                  var resSample = resData.sample ? JSON.parse(resData.sample) : null;
                  var resApprovalStatusCode = resData.approval_status_code ? resData.approval_status_code : "10";
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                _context6.next = 4;
                return axios.post("/qm/ajax/tobaccos/approval/unapprove", reqBody).then(function (res) {
                  var resData = res.data.data;
                  var resMsg = resData.message;
                  var resSample = resData.sample ? JSON.parse(resData.sample) : null;
                  var resApprovalStatusCode = resData.approval_status_code ? resData.approval_status_code : "10";
...
/***/ "./resources/js/components/qm/tobaccos/TableTobaccos.vue":
/*!***************************************************************!*\
  !*** ./resources/js/components/qm/tobaccos/TableTobaccos.vue ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => __WEBPACK_DEFAULT_EXPORT__
/* harmony export */ });
/* harmony import */ var _TableTobaccos_vue_vue_type_template_id_708ffa93___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./TableTobaccos.vue?vue&type=template&id=708ffa93& */ "./resources/js/components/qm/tobaccos/TableTobaccos.vue?vue&type=template&id=708ffa93&");
/* harmony import */ var _TableTobaccos_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./TableTobaccos.vue?vue&type=script&lang=js& */ "./resources/js/components/qm/tobaccos/TableTobaccos.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  _TableTobaccos_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__.default,
  _TableTobaccos_vue_vue_type_template_id_708ffa93___WEBPACK_IMPORTED_MODULE_0__.render,
  _TableTobaccos_vue_vue_type_template_id_708ffa93___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/qm/tobaccos/TableTobaccos.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/components/qm/tobaccos/TableTobaccos.vue?vue&type=script&lang=js&":
/*!****************************************************************************************!*\
  !*** ./resources/js/components/qm/tobaccos/TableTobaccos.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => __WEBPACK_DEFAULT_EXPORT__
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TableTobaccos_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./TableTobaccos.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/qm/tobaccos/TableTobaccos.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TableTobaccos_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__.default); 

/***/ }),

/***/ "./resources/js/components/qm/tobaccos/TableTobaccos.vue?vue&type=template&id=708ffa93&":
/*!**********************************************************************************************!*\
  !*** ./resources/js/components/qm/tobaccos/TableTobaccos.vue?vue&type=template&id=708ffa93& ***!
  \**********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_TableTobaccos_vue_vue_type_template_id_708ffa93___WEBPACK_IMPORTED_MODULE_0__.render,
/* harmony export */   "staticRenderFns": () => /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_TableTobaccos_vue_vue_type_template_id_708ffa93___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_TableTobaccos_vue_vue_type_template_id_708ffa93___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./TableTobaccos.vue?vue&type=template&id=708ffa93& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/qm/tobaccos/TableTobaccos.vue?vue&type=template&id=708ffa93&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/qm/tobaccos/TableTobaccos.vue?vue&type=template&id=708ffa93&":
/*!*************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/qm/tobaccos/TableTobaccos.vue?vue&type=template&id=708ffa93& ***!
  \*************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
          ...
          _c("thead", [
            _c("tr", [
              ...
              _c(
                ...
                [_vm._v(" สามารถแก้ไขผลการตรวจสอบได้ ")]
              ),
              _vm._v(" "),
              _c(
                "th",
                      ...
                      _c("tr", { key: sampleItem.sample_no }, [
                        ...
                        _c(
                          ...
                          [
                            _vm._v(
                              "\n                        " +
                                _vm._s(sampleItem.location_full_desc) +
                                "\n                    "
                            )
                          ]
                        ),
      ...
      [
        _c("div", { staticClass: "freeze-col-content" }, [
          _c(
            ...
            {
              staticClass:
                "text-center tw-text-xs tw-inline-block tw-align-top tw-py-8",
