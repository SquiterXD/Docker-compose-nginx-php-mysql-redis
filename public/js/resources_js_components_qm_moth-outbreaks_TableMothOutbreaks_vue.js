(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_qm_moth-outbreaks_TableMothOutbreaks_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/qm/moth-outbreaks/TableMothOutbreaks.vue?vue&type=script&lang=js&":
/*!*******************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/qm/moth-outbreaks/TableMothOutbreaks.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
    ...
    return {
      sampleItems: JSON.parse(this.items).map(function (item) {
        return _objectSpread(_objectSpread({}, item), {}, {
          ...
          location_full_desc: _this.getLocatorDesc(item),
  ...
  methods: {
      ...
      if (sample.sample_operation_status == 'CP') {
        if (approvalRole) {
          ...
          if (approvalLevelCode == "2") {
            // Supervisor
            if (sample.approval_status_code == "10" || sample.approval_status_code == "11") {
    ...
    getSampleSpecifications: function getSampleSpecifications(sampleNo, organizationId, inventoryItemId, locatorId) {
      ...
      return axios.get("/qm/ajax/moth-outbreaks/get-sample-specifications", {
        params: params
      }).then(function (res) {
        return {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 4;
                return axios.post("/qm/ajax/moth-outbreaks/approval/approve", reqBody).then(function (res) {
                  ...
                  if (resData.status == "success") {
                    ...
                    sampleData.approval_status_code = resApprovalStatusCode; // sampleData.operator_approval_status = this.getOperatorApprovalStatus(this.approvalData, resApprovalStatusCode);
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 4;
                return axios.post("/qm/ajax/moth-outbreaks/approval/approve-all", reqBody).then(function (res) {
                  var resData = res.data.data;
                  var resMsg = resData.message;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 4;
                return axios.post("/qm/ajax/moth-outbreaks/approval/reject", reqBody).then(function (res) {
                  var resData = res.data.data;
                  var resMsg = resData.message;
                  var resSample = resData.sample ? JSON.parse(resData.sample) : null;
                  var resApprovalStatusCode = resData.approval_status_code ? resData.approval_status_code : "10";
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _context5.next = 4;
                return axios.post("/qm/ajax/moth-outbreaks/approval/return", reqBody).then(function (res) {
                  var resData = res.data.data;
                  var resMsg = resData.message;
                  var resSample = resData.sample ? JSON.parse(resData.sample) : null;
                  var resApprovalStatusCode = resData.approval_status_code ? resData.approval_status_code : "10";
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                _context6.next = 4;
                return axios.post("/qm/ajax/moth-outbreaks/approval/unapprove", reqBody).then(function (res) {
                  var resData = res.data.data;
                  var resMsg = resData.message;
                  var resSample = resData.sample ? JSON.parse(resData.sample) : null;
                  var resApprovalStatusCode = resData.approval_status_code ? resData.approval_status_code : "10";
...
/***/ "./resources/js/components/qm/moth-outbreaks/TableMothOutbreaks.vue":
/*!**************************************************************************!*\
  !*** ./resources/js/components/qm/moth-outbreaks/TableMothOutbreaks.vue ***!
  \**************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => __WEBPACK_DEFAULT_EXPORT__
/* harmony export */ });
/* harmony import */ var _TableMothOutbreaks_vue_vue_type_template_id_a2da93cc___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./TableMothOutbreaks.vue?vue&type=template&id=a2da93cc& */ "./resources/js/components/qm/moth-outbreaks/TableMothOutbreaks.vue?vue&type=template&id=a2da93cc&");
/* harmony import */ var _TableMothOutbreaks_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./TableMothOutbreaks.vue?vue&type=script&lang=js& */ "./resources/js/components/qm/moth-outbreaks/TableMothOutbreaks.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  _TableMothOutbreaks_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__.default,
  _TableMothOutbreaks_vue_vue_type_template_id_a2da93cc___WEBPACK_IMPORTED_MODULE_0__.render,
  _TableMothOutbreaks_vue_vue_type_template_id_a2da93cc___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/qm/moth-outbreaks/TableMothOutbreaks.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/components/qm/moth-outbreaks/TableMothOutbreaks.vue?vue&type=script&lang=js&":
/*!***************************************************************************************************!*\
  !*** ./resources/js/components/qm/moth-outbreaks/TableMothOutbreaks.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => __WEBPACK_DEFAULT_EXPORT__
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TableMothOutbreaks_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./TableMothOutbreaks.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/qm/moth-outbreaks/TableMothOutbreaks.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TableMothOutbreaks_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__.default); 

/***/ }),

/***/ "./resources/js/components/qm/moth-outbreaks/TableMothOutbreaks.vue?vue&type=template&id=a2da93cc&":
/*!*********************************************************************************************************!*\
  !*** ./resources/js/components/qm/moth-outbreaks/TableMothOutbreaks.vue?vue&type=template&id=a2da93cc& ***!
  \*********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_TableMothOutbreaks_vue_vue_type_template_id_a2da93cc___WEBPACK_IMPORTED_MODULE_0__.render,
/* harmony export */   "staticRenderFns": () => /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_TableMothOutbreaks_vue_vue_type_template_id_a2da93cc___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_TableMothOutbreaks_vue_vue_type_template_id_a2da93cc___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./TableMothOutbreaks.vue?vue&type=template&id=a2da93cc& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/qm/moth-outbreaks/TableMothOutbreaks.vue?vue&type=template&id=a2da93cc&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/qm/moth-outbreaks/TableMothOutbreaks.vue?vue&type=template&id=a2da93cc&":
/*!************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/qm/moth-outbreaks/TableMothOutbreaks.vue?vue&type=template&id=a2da93cc& ***!
  \************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                      ...
                      sampleItem.specification_showed
                        ? _c("tr", { key: sampleItem.sample_no + "_line" }, [
                            _c(
                              ...
                              [
                                _c("qm-table-moth-outbreak-results", {
                                  attrs: {
