(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_om_rma_export_Index_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/om/rma_export/Index.vue?vue&type=script&lang=js&":
/*!**************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/om/rma_export/Index.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    onAdd: function onAdd() {
      var vm = this;
      vm.dsaNumber = true;
      vm.selNumber.rma_date = moment__WEBPACK_IMPORTED_MODULE_1___default()().format("DD/MM/YYYY");
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                vm.selNumber.rma_date = moment__WEBPACK_IMPORTED_MODULE_1___default()(vm.selNumber.rma_date) // .add(543, "years")
                .format("DD/MM/YYYY");
              ...
              case 10:
                ...
                return vm.filterInvoice.findIndex(function (o) {
                  return o.pi_header_id == vm.selNumber.invoice_id;
                });

              case 15:
                iIdx = _context.sent;
                vm.selInvoice = vm.filterInvoice[iIdx];
                vm.selInvoice.pick_release_approve_date = moment__WEBPACK_IMPORTED_MODULE_1___default()(vm.selInvoice.pick_release_approve_date) // .add(543, "years")
                .format("DD/MM/YYYY");
                  ...
                  while (1) {
                    switch (_context4.prev = _context4.next) {
                      case 0:
                        ...
                        _context4.next = 4;
                        return axios.get(vm.url.ajax_get_new_number) // Get new rma number list after create new one
                      ...
                      case 4:
                        ...
                        vm.selNumber.rma_date = moment__WEBPACK_IMPORTED_MODULE_1___default()(vm.selNumber.rma_date).format("DD/MM/YYYY");
                        vm.procAdding = false;
                        _context4.next = 10;
                        return vm.filterInvoice.findIndex(function (o) {
                          return o.pi_header_id == vm.selNumber.invoice_id;
    ...
    onConfirm: function onConfirm() {
      var vm = this;
      var previousRma = [];
      var errorRma = []; // Check rma quantity
      ...
      if (vm.selNumber.status_rma != "Draft") {
        ...
        if (vm.orderLines.length == 0) {
          ...
          Swal.fire({
            ...
            var _ref2 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee6(result) {
                        ...
                        for (_i = 0; _i < vm.orderLines.length; _i++) {
                          ...
                          if (vm.enaRow[_i] == true) {
                            ...
                            vm.claimLines.push({
                              ...
                              order_line_id: vm.orderLines[_i]['pi_line_id'],
    ...
    onTest1: function onTest1() {
      var vm = this;
      Swal.fire({
        title: 'Please wait ...'
      });
      Swal.showLoading();
      axios.get(vm.url.ajax_get_new_number).then(function (response) {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _context7.next = 2;
                return axios.get(_this4.url.ajax_convert_unit, {
                  params: {
                    orgId: _this4.selInvoice.org_id,
                    itemId: _this4.orderLines[idx].item_id,
                    qty: _this4.orderLines[idx].enter_rma_quantity,
                    fromUnit: _this4.orderLines[idx].enter_rma_uom,
                    toUnit: _this4.orderLines[idx].uom_code
                  }
                }).then(function (response) {
                  _this4.orderLines[idx].rma_quantity = response.data.convertResult;
                })["catch"](function (error) {
                  // Error 😨
                  Swal.close();
              ...
              case 2:
                console.log('orgId : ' + _this4.selInvoice.org_id);
                console.log('itemId : ' + _this4.orderLines[idx].item_id);
                console.log('qty : ' + _this4.orderLines[idx].enter_rma_quantity);
                console.log('fromUnit :' + _this4.orderLines[idx].enter_rma_uom);
                console.log('toUnit :' + _this4.orderLines[idx].uom_code);
                console.log('result :' + _this4.orderLines[idx].rma_quantity);
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                if (!(typeof _this5.orderLines[idx].rma_quantity_cbb == "undefined")) {
                  _context8.next = 8;
                  break;
                }
              ...
              case 8:
                _context8.next = 10;
                return axios.get(_this5.url.ajax_convert_unit, {
                  params: {
                    orgId: _this5.selInvoice.org_id,
                    itemId: _this5.orderLines[idx].item_id,
                    qty: _this5.orderLines[idx].rma_quantity_cbb,
                    fromUnit: 'CGC',
                    toUnit: _this5.orderLines[idx].uom_code
                  }
                }).then(function (response) {
                  cgc = response.data.convertResult;
                  console.log('orgId : ' + _this5.selInvoice.org_id);
                  console.log('itemId : ' + _this5.orderLines[idx].item_id);
                  console.log('qty : ' + _this5.orderLines[idx].enter_rma_quantity);
                  console.log('fromUnit :' + 'CGC');
                  console.log('toUnit :' + _this5.orderLines[idx].uom_code);
              ...
              case 10:
                if (!(typeof _this5.orderLines[idx].rma_quantity_carton == "undefined")) {
                  _context8.next = 14;
                  break;
                }
              ...
              case 14:
                ...
                return axios.get(_this5.url.ajax_convert_unit, {
                  params: {
                    orgId: _this5.selInvoice.org_id,
                    itemId: _this5.orderLines[idx].item_id,
                    qty: _this5.orderLines[idx].rma_quantity_carton,
                    fromUnit: 'CG2',
                    toUnit: _this5.orderLines[idx].uom_code
                  }
                }).then(function (response) {
              ...
              case 16:
                if (!(typeof _this5.orderLines[idx].rma_quantity_pack == "undefined")) {
                  _context8.next = 20;
                  break;
                }
              ...
              case 20:
                ...
                return axios.get(_this5.url.ajax_convert_unit, {
                  params: {
                    orgId: _this5.selInvoice.org_id,
                    itemId: _this5.orderLines[idx].item_id,
                    qty: _this5.orderLines[idx].rma_quantity_pack,
                    fromUnit: 'CGP',
                    toUnit: _this5.orderLines[idx].uom_code
                  }
                }).then(function (response) {
              ...
              case 22:
                ...
                _this5.orderLines[idx].rma_quantity = parseFloat(totalCgk);
                console.log('itemIdx => ' + idx);
                console.log('rma_quantity_cbb => ' + _this5.orderLines[idx].rma_quantity_cbb);
                console.log('rma_quantity_carton => ' + _this5.orderLines[idx].rma_quantity_carton);
                console.log('rma_quantity_pack => ' + _this5.orderLines[idx].rma_quantity_pack);
                console.log('rma_quantity => ' + _this5.orderLines[idx].rma_quantity);
...
/***/ "./resources/js/components/om/rma_export/Index.vue":
/*!*********************************************************!*\
  !*** ./resources/js/components/om/rma_export/Index.vue ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => __WEBPACK_DEFAULT_EXPORT__
/* harmony export */ });
/* harmony import */ var _Index_vue_vue_type_template_id_40520374_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Index.vue?vue&type=template&id=40520374&scoped=true& */ "./resources/js/components/om/rma_export/Index.vue?vue&type=template&id=40520374&scoped=true&");
/* harmony import */ var _Index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Index.vue?vue&type=script&lang=js& */ "./resources/js/components/om/rma_export/Index.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  ...
  _Index_vue_vue_type_template_id_40520374_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
  _Index_vue_vue_type_template_id_40520374_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "40520374",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/om/rma_export/Index.vue"
...
/***/ "./resources/js/components/om/rma_export/Index.vue?vue&type=script&lang=js&":
/*!**********************************************************************************!*\
  !*** ./resources/js/components/om/rma_export/Index.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => __WEBPACK_DEFAULT_EXPORT__
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Index.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/om/rma_export/Index.vue?vue&type=script&lang=js&");
...
/***/ "./resources/js/components/om/rma_export/Index.vue?vue&type=template&id=40520374&scoped=true&":
/*!****************************************************************************************************!*\
  !*** ./resources/js/components/om/rma_export/Index.vue?vue&type=template&id=40520374&scoped=true& ***!
  \****************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Index_vue_vue_type_template_id_40520374_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
/* harmony export */   "staticRenderFns": () => /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Index_vue_vue_type_template_id_40520374_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Index_vue_vue_type_template_id_40520374_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Index.vue?vue&type=template&id=40520374&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/om/rma_export/Index.vue?vue&type=template&id=40520374&scoped=true&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/om/rma_export/Index.vue?vue&type=template&id=40520374&scoped=true&":
/*!*******************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/om/rma_export/Index.vue?vue&type=template&id=40520374&scoped=true& ***!
  \*******************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  function() {
    ...
    return _c("thead", [
      _c("tr", { staticClass: "align-middle" }, [
        ...
        _c("th", { attrs: { colspan: "2" } }, [_vm._v("จำนวนที่ซื้อ")]),
        _vm._v(" "),
        _c("th", { attrs: { colspan: "2" } }, [_vm._v("จำนวนที่ขอคืน")])
      ]),
      _vm._v(" "),
      _c("tr", { staticClass: "align-middle" }, [
        _c("th", { staticClass: "w-80" }, [_vm._v("จำนวน")]),
        ...
        _c("th", { staticClass: "w-80" }, [_vm._v("หน่วยนับ")]),
        _vm._v(" "),
        _c("th", { staticClass: "w-80", staticStyle: { width: "140px" } }, [
          _vm._v("จำนวน")
        ]),
        _vm._v(" "),
        _c("th", { staticClass: "w-80", staticStyle: { width: "220px" } }, [
          _vm._v("หน่วยนับ")
        ])
      ])
    ])
