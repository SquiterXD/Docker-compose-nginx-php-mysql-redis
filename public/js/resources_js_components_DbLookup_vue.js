(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_DbLookup_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/DbLookup.vue?vue&type=script&lang=js&":
/*!***************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/DbLookup.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************************************************************************************************/
...
/* harmony export */   "defaultRemoteDataSource": () => /* binding */ defaultRemoteDataSource,
/* harmony export */   "defaultLabelFormatter": () => /* binding */ defaultLabelFormatter,
/* harmony export */   "default": () => __WEBPACK_DEFAULT_EXPORT__
/* harmony export */ });
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _pm_httpClient__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../pm/httpClient */ "./resources/js/pm/httpClient.js");
...
function defaultRemoteDataSource(tableName, searchKeys, query, maxResults, filterBy) {
  return _pm_httpClient__WEBPACK_IMPORTED_MODULE_1__.instance.get((0,_router__WEBPACK_IMPORTED_MODULE_2__.$route)('api.db.lookup'), {
    params: {
      tableName: tableName,
...
function defaultLabelFormatter(item, labels, labelFormat) {
  var delimiterCount = labelFormat.split('{$}').length - 1;
  ...
  var labelValues = labels.map(function (label) {
    if (typeof item[label] === 'undefined') {
      throw "Label field '".concat(label, "' does not exist in the object!");
    }

    return item[label];
  });
  var formattedLabel = labelFormat;

  var _iterator = _createForOfIteratorHelper(labelValues),
      _step;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    isVisible: function isVisible() {
      ...
      return this.model !== null; // if(!this.model){
  ...
  mounted: function mounted() {
    this.validateData(this.remoteDataSource, this.tableName, this.keyField, this.labelField, this.labelFields, this.selectedLabelField, this.selectedLabelFields);

    if (this.initialObject && this.prePopulateText) {
      console.warn('Both initial-object and pre-populate-text are set.' + ' initial-object will take precedent over pre-populate-text.');
    }

    if (this.initialObject) {
      console.debug('initial-object', this.initialObject);
      var key = this.initialObject[this.keyField];
      var label = this.getLabel(this.initialObject, this.labelField, this.labelFields, this.labelPattern);
      this.options = [{
        key: key,
        label: label,
  ...
  methods: {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _this.validateData(_this.remoteDataSource, _this.tableName, _this.keyField, _this.labelField, _this.labelFields, _this.selectedLabelField, _this.selectedLabelFields);
                ...
                console.debug({
                  ...
                  selectedLabelField: _this.selectedLabelField,
                  selectedLabelFields: _this.selectedLabelFields,
                  labelPattern: _this.labelPattern,
                  maxResults: _this.maxResults,
                  prePopulateText: _this.prePopulateText,
                  preFetch: _this.preFetch,
                  remoteDataSource: _this.remoteDataSource,
                  labelFormatter: _this.labelFormatter,
                  selectedLabelFormatter: _this.selectedLabelFormatter,
                  currentValue: _this.currentValue
                });

                if (_this.searchKeys === null || _this.searchKeys.length === 0) {
                  searchKeys = [_this.keyField];
                } else {
                  searchKeys = _this.searchKeys;
                }

                console.debug('processed searchKeys: ', {
                  searchKeys: searchKeys
                });
                filterBy = execOrValue(_this.filterBy); //long run operation here

                _context.next = 10;
                return _this.remoteDataSource(_this.tableName, searchKeys, query, _this.maxResults, filterBy);

              case 10:
                data = _context.sent;

                if (lodash_isNil__WEBPACK_IMPORTED_MODULE_3___default()(data)) {
                  console.warn('Remote data source should return empty array instead of null');
                  data = [];
                }

                console.debug('remote data source finished', data);
                _this.options = data.map(function (item) {
                  if (typeof item[_this.keyField] === 'undefined') {
                    throw 'Key field does not exist in the object!';
                  }

                  var formattedLabel = _this.getLabel(item, _this.labelField, _this.labelFields, _this.labelPattern, _this.labelFormatter);
    ...
    validateData: function validateData(remoteDataSource, tableName, keyField, labelField, labelFields, selectedLabelField, selectedLabelFields) {
    ...
    getLabel: function getLabel(item, labelField, labelFields, labelPattern, labelFormatter) {
      if (!item) {
        return '';
      }
      ...
      var delimiterCount = labelPattern.split('{$}').length - 1;
    ...
    getSelectedLabel: function getSelectedLabel(item) {
      ...
      if (lodash_isEmpty__WEBPACK_IMPORTED_MODULE_4___default()(this.selectedLabelField) && lodash_isEmpty__WEBPACK_IMPORTED_MODULE_4___default()(this.selectedLabelFields)) {
    ...
    getValue: function getValue(item, valueField) {
      var value;
    ...
    dispatchChange: function dispatchChange(item) {
      console.debug('dispatchChange', item); // change the current value to update the 'selected' value on <select> component

      this.currentValue = this.getSelectedLabel(item);
      this.$emit('change', this.getValue(item, this.valueField));
    },
    dispatchInput: function dispatchInput(item) {
      console.debug('dispatchInput', item); // required for update the v-model of derived component
...
/***/ "./resources/js/components/DbLookup.vue":
/*!**********************************************!*\
  !*** ./resources/js/components/DbLookup.vue ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "defaultLabelFormatter": () => /* reexport safe */ _DbLookup_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__.defaultLabelFormatter,
/* harmony export */   "defaultRemoteDataSource": () => /* reexport safe */ _DbLookup_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__.defaultRemoteDataSource,
/* harmony export */   "default": () => __WEBPACK_DEFAULT_EXPORT__
/* harmony export */ });
/* harmony import */ var _DbLookup_vue_vue_type_template_id_411f55fa___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./DbLookup.vue?vue&type=template&id=411f55fa& */ "./resources/js/components/DbLookup.vue?vue&type=template&id=411f55fa&");
/* harmony import */ var _DbLookup_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DbLookup.vue?vue&type=script&lang=js& */ "./resources/js/components/DbLookup.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  _DbLookup_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__.default,
  _DbLookup_vue_vue_type_template_id_411f55fa___WEBPACK_IMPORTED_MODULE_0__.render,
  _DbLookup_vue_vue_type_template_id_411f55fa___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/DbLookup.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/components/DbLookup.vue?vue&type=script&lang=js&":
/*!***********************************************************************!*\
  !*** ./resources/js/components/DbLookup.vue?vue&type=script&lang=js& ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => __WEBPACK_DEFAULT_EXPORT__,
/* harmony export */   "defaultLabelFormatter": () => /* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_DbLookup_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__.defaultLabelFormatter,
/* harmony export */   "defaultRemoteDataSource": () => /* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_DbLookup_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__.defaultRemoteDataSource
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_DbLookup_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./DbLookup.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/DbLookup.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_DbLookup_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__.default); 

/***/ }),

/***/ "./resources/js/components/DbLookup.vue?vue&type=template&id=411f55fa&":
/*!*****************************************************************************!*\
  !*** ./resources/js/components/DbLookup.vue?vue&type=template&id=411f55fa& ***!
  \*****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_DbLookup_vue_vue_type_template_id_411f55fa___WEBPACK_IMPORTED_MODULE_0__.render,
/* harmony export */   "staticRenderFns": () => /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_DbLookup_vue_vue_type_template_id_411f55fa___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_DbLookup_vue_vue_type_template_id_411f55fa___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./DbLookup.vue?vue&type=template&id=411f55fa& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/DbLookup.vue?vue&type=template&id=411f55fa&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/DbLookup.vue?vue&type=template&id=411f55fa&":
/*!********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/DbLookup.vue?vue&type=template&id=411f55fa& ***!
  \********************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  return _c(
    "el-select",
    {
      attrs: {
        ...
        "value-key": _vm.keyField,
        loading: _vm.loading,
        "remote-method": _vm.remoteMethod,
        visible: _vm.isVisible,
        value: _vm.currentValue
      },
      on: { change: _vm.dispatchChange, input: _vm.dispatchInput }
    },
