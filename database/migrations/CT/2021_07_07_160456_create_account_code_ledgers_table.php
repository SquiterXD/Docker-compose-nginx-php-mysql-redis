...
class CreateAccountCodeLedgersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('ct_account_code_ledgers', function (Blueprint $table) {
        ...
        Schema::create('ct_ac_ledger_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('ct_account_code_ledgers');
        Schema::dropIfExists('ct_ac_ledger_details');
    }
}
