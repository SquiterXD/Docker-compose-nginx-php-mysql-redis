...
class CreateCtCostCenterProductionProcessTable extends Migration
{
    ...
    public function up()
    {
        Schema::connection('oracle_oact')->create('ptct_cc_production_processes', function (Blueprint $table) {
    ...
    {
        Schema::connection('oracle_oact')->dropIfExists('ptct_cost_center_production_processes');
    }
}
