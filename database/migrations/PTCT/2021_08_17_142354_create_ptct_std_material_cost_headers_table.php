...
class CreatePtctStdMaterialCostHeadersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('oracle_oact')->create('ptct_std_material_cost_headers', function (Blueprint $table) {
            $table->bigIncrements('std_mch_id');
            ...
            $table->string('period_name', 30)->nullable();
    ...
    {
        Schema::connection('oracle_oact')->dropIfExists('ptct_std_material_cost_headers');
    }
}
