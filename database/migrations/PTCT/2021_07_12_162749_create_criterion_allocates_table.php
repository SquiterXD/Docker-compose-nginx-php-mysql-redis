...
class CreateCriterionAllocatesTable extends Migration
{
    ...
    public function up()
    { 
        Schema::connection('oracle_oact')->create('ptct_criterion_allocates', function (Blueprint $table) {
    ...
    {
        Schema::connection('oracle_oact')->dropIfExists('ptct_criterion_allocates');
    }
}
