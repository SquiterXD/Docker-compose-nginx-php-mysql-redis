...
class CreateProductGroupDetailsTable extends Migration
{
    ...
    public function up()
    {
        Schema::connection('oracle_oact')->create('ptct_product_group_details', function (Blueprint $table) {
    ...
    {
        Schema::connection('oracle_oact')->dropIfExists('ptct_product_group_details');
    }
}
